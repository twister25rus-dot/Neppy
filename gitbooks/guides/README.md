...
description: >-
  ...
  Neppy: set up an assistant, run a local model, protect sensitive data,
...
The rest of the docs explain **how Neppy works**. This section is about **what you want to get done**. Each guide starts from a concrete outcome ("I want a private assistant", "my install is broken", "I'm moving to a new laptop") and walks you to a working result without asking you to first understand the architecture.
...
| Keep model inference on my own machine              | [Use Neppy with a local model](local-model.md)                   |
...
| Move everything to a new computer                   | [Move Neppy to a new PC](move-to-new-pc.md)                      |
| Read and edit memory in Obsidian                    | [Connect Neppy to Obsidian](connect-obsidian.md)                 |
...
- **Privacy implications**: what stays on your machine and what is sent to the Neppy backend or a model provider for this workflow, in plain language.
