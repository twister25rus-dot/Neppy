...
- [Guides](guides/README.md)
  ...
  - [Use Neppy with a local model](guides/local-model.md)
  ...
  - [Move Neppy to a new PC](guides/move-to-new-pc.md)
  - [Connect Neppy to Obsidian](guides/connect-obsidian.md)
...
- [Architecture](developing/architecture/README.md)
  ...
  - [Flows on TinyAgents (src/neppy/flows/)](developing/architecture/flows-on-tinyagents.md)
  - [Memory Tree (src/neppy/memory_tree/)](developing/architecture/memory-tree.md)
  - [MCP Registry (src/neppy/mcp_registry/)](developing/architecture/mcp-registry.md)
  - [Security (src/neppy/security/)](developing/architecture/security.md)
