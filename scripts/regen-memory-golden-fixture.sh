...
if ! git diff --quiet -- src/neppy/memory; then
  echo "[golden-fixture] WARNING: src/neppy/memory has uncommitted changes." >&2
...
| Seeder | \`neppy_core::neppy::memory::store::golden::seed\` |
