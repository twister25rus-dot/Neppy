...
pub(super) const CAPABILITIES: &[Capability] = &[
    ...
    Capability {
        ...
        how_to: "Memory status panel shows the cause + fix; or ask the agent to diagnose memory; or `neppy-core` RPC `memory_tree_doctor`",
        status: CapabilityStatus::Beta,
        privacy: LOCAL_RAW,
    },
    Capability {
    ...
    Capability {
        ...
        how_to: "Run `neppy-core mcp` (stdio) or `neppy-core mcp --transport http --port 9300` for remote clients.",
        status: CapabilityStatus::Beta,
        privacy: LOCAL_RAW,
    },
    Capability {
