...
//!
//! The shape mirrors [`crate::neppy::config::schema::proxy`]'s runtime
...
/// cross-module races: `api::product`, `api::rest`, `neppy::medulla` and
/// `neppy::integrations` tests all touch it from parallel test threads, and
