...
//! `crate::neppy::inference::voice` so all inference concerns share a
//! single domain root.
//!
...
#[cfg(feature = "voice")]
pub use crate::neppy::inference::voice::cloud_transcribe;
#[cfg(feature = "voice")]
pub use crate::neppy::inference::voice::local_speech;
#[cfg(feature = "voice")]
pub use crate::neppy::inference::voice::postprocess;
...
pub use crate::neppy::inference::voice::streaming;
