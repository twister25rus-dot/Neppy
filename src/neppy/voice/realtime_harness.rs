...
use crate::neppy::platform::socket::manager::global_socket_manager;
...
async fn build_voice_agent(
    ...
    let config = crate::neppy::config::ops::load_config_with_timeout().await?;
...
async fn run_single_with_timeout(
    ...
    let scoped_run = crate::neppy::agent::tinyagents::thread_context::with_thread_id(
    ...
    let fut = with_origin(
        ...
        crate::neppy::security::approval::APPROVAL_CHAT_CONTEXT.scope(approval_ctx, scoped_run),
    );
