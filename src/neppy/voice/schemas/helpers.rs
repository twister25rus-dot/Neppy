...
pub(super) fn effective_stt_provider(config: &crate::neppy::config::Config) -> String {
    crate::neppy::voice::effective_stt_provider(config)
}

pub(super) fn effective_tts_provider(config: &crate::neppy::config::Config) -> String {
    crate::neppy::voice::effective_tts_provider(config)
}
...
pub(super) async fn validate_tts_provider_key(
    ...
    let api_key = crate::neppy::inference::provider::factory::lookup_key_for_slug(slug, config)
        .unwrap_or_default();
