...
use crate::neppy::inference::LocalAiStatus;
use crate::neppy::platform::service::{ServiceState, ServiceStatus};
use crate::neppy::security::credentials::session_support::{
...
pub struct StoredAppState {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub keyring_consent: Option<crate::neppy::security::keyring_consent::ConsentPreference>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct AppStateSnapshot {
    pub auth: crate::neppy::security::credentials::responses::AuthStateResponse,
    ...
    pub keyring_status: crate::neppy::security::keyring_consent::KeyringStatus,
    ...
    pub health: crate::neppy::platform::health::HealthSnapshot,
...
pub struct StoredAppStatePatch {
    ...
    #[serde(default)]
    pub keyring_consent: Option<Option<crate::neppy::security::keyring_consent::ConsentPreference>>,
}
...
fn build_client() -> Result<Client, String> {
    // Platform-appropriate TLS backend — see [`crate::neppy::util::tls`].
    crate::neppy::util::tls::tls_client_builder()
        .http1_only()
...
async fn activate_revalidated_user_dir(user_id: &str) -> Result<Config, String> {
    ...
    let previous_active = crate::neppy::config::read_active_user_id(&root_dir);
    let user_dir = crate::neppy::config::user_neppy_dir(&root_dir, user_id);
    ...
    crate::neppy::config::write_active_user_id(&root_dir, user_id).map_err(|error| {
    ...
    if previous_active.is_none() {
        let pre_ws = crate::neppy::config::pre_login_user_dir(&root_dir).join("workspace");
...
async fn finish_revalidated_user_activation(
    ...
    if let Some(source_config) = service_rebind_source {
        crate::neppy::security::credentials::stop_login_gated_services(source_config).await;
        crate::neppy::security::credentials::start_login_gated_services(target_config).await;
    } else {
        debug!(
    ...
    crate::neppy::security::credentials::sentry_scope::bind(user_id);
}
...
async fn clear_deferred_session_after_backend_rejection(
    ...
    *CURRENT_USER_CACHE.lock() = None;
    ...
    match crate::neppy::config::default_root_neppy_dir() {
        Ok(root_dir) => {
            let active_user = crate::neppy::config::read_active_user_id(&root_dir);
            ...
            if should_clear_active_user {
                if let Err(error) = crate::neppy::config::clear_active_user(&root_dir) {
                    warn!(
    ...
    crate::neppy::security::credentials::stop_login_gated_services(config).await;
    crate::neppy::security::credentials::sentry_scope::clear();
...
pub fn peek_cached_current_user_identity() -> Option<crate::neppy::agent::prompts::UserIdentity> {
    let cache = CURRENT_USER_CACHE.lock();
    ...
    let identity = crate::neppy::agent::prompts::UserIdentity { id, name, email };
    ...
    let (local_ai, service) = tokio::join!(
        async {
            ...
            let status = match tokio::time::timeout(
                ...
                crate::neppy::inference::rpc::inference_status(&config_for_local_ai),
            )
            .await
            {
                ...
                Ok(Err(error)) => {
                    ...
                    crate::neppy::inference::LocalAiStatus::disabled(&config_for_local_ai)
                }
                Err(_) => {
                    warn!(
        ...
        async {
            ...
            let status = tokio::task::spawn_blocking(move || {
                crate::neppy::platform::service::status(&config_for_service)
            })
            .await
...
pub async fn snapshot() -> Result<RpcOutcome<AppStateSnapshot>, String> {
    ...
    crate::neppy::security::keyring_consent::policy::initialize(
    ...
    let keyring_status = crate::neppy::security::keyring_consent::policy::current_status();
    let health = crate::neppy::platform::health::snapshot();
...
fn degraded_runtime_snapshot(config: &Config) -> RuntimeSnapshot {
    RuntimeSnapshot {
        local_ai: crate::neppy::inference::LocalAiStatus::disabled(config),
