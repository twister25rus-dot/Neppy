...
struct UpdateLocalStateParams {
    ...
    #[serde(default, deserialize_with = "deserialize_nullable_patch")]
    keyring_consent: Option<Option<crate::neppy::security::keyring_consent::ConsentPreference>>,
}
...
fn handle_snapshot(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        crate::neppy::desktop::app_state::snapshot()
            .await?
...
fn handle_update_local_state(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        crate::neppy::desktop::app_state::update_local_state(StoredAppStatePatch {
