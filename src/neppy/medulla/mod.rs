...
//! |---|---|---|
//! | `neppy::medulla` (here) | Neppy as a Medulla **client** | outbound HTTP/SSE to the backend |
//! | `neppy::platform::socket::medulla` | Neppy as a Medulla **worker** | inbound Socket.IO from a remote operator |
//!
