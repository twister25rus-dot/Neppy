...
fn skill_create_input_def_deserializes_full_row_from_json() {
    let row: crate::neppy::skills::ops_create::WorkflowCreateInputDef =
...
fn skill_create_input_def_round_trips_through_registry_skill_input() {
    ...
    let rows = vec![
        crate::neppy::skills::ops_create::WorkflowCreateInputDef {
            name: "repo".into(),
    ...
    let parsed: crate::neppy::skills::registry::WorkflowDefinition =
