...
///
/// Both [`crate::neppy::channels::start_channels`] (messaging cores) and
...
pub fn ensure_triggered_workflow_subscriber(workspace: &std::path::Path) {
    TRIGGERED_WORKFLOW_HANDLE.get_or_init(|| {
        let workflows = crate::neppy::skills::load_workflow_metadata(workspace);
...
mod tests {
    use super::*;
    use crate::neppy::skills::ops_types::{Workflow, WorkflowFrontmatter};
