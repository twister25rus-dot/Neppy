...
use crate::neppy::skills::WorkflowScope;
...
/// the preflight described in [`crate::neppy::skills::schemas`]'s
...
pub struct WorkflowDefinition {
    ...
    /// boots — see
    /// [`crate::neppy::skills::runtime::spawn_workflow_run_background`].
    #[serde(default)]
...
pub fn load_workflows_with_profile(
    ...
    if let Ok(builtins) = crate::neppy::agent::registry::agents::load_builtins() {
