...
use crate::neppy::platform::socket::global_socket_manager;
use crate::neppy::skills::webhooks::WebhookResponseData;
    ...
    async fn handle(&self, event: &DomainEvent) {
        ...
        let (response, resolved_skill_id, response_error) = match registration {
            Some(ref reg) if reg.target_kind == "echo" => {
                ...
                let resp = crate::neppy::skills::webhooks::ops::build_echo_response(request);
            ...
            Some(ref reg) if reg.target_kind == "agent" => {
                ...
                if let Err(e) = &decoded {
                    ...
                    let envelope = crate::neppy::agent::triage::TriggerEnvelope::from_webhook(
                        &tunnel_uuid,
                        &method,
                        &path,
                        payload,
...
async fn run_agent_trigger(
    envelope: &crate::neppy::agent::triage::TriggerEnvelope,
    ...
    match outcome {
        crate::neppy::agent::triage::TriageOutcome::Decision(run) => {
            ...
            let origin = crate::neppy::agent::triage::remote_trigger_origin(envelope);
