...
pub async fn get_sandbox_settings() -> Result<RpcOutcome<serde_json::Value>, String> {
    ...
    let backend_str = match sandbox.backend {
        crate::neppy::config::SandboxBackend::Auto => "auto",
        crate::neppy::config::SandboxBackend::Landlock => "landlock",
        crate::neppy::config::SandboxBackend::Firejail => "firejail",
        crate::neppy::config::SandboxBackend::Bubblewrap => "bubblewrap",
        crate::neppy::config::SandboxBackend::Docker => "docker",
        crate::neppy::config::SandboxBackend::None => "none",
    };
    ...
    let value = serde_json::json!({
        ...
        "env_passthrough": crate::neppy::sandbox::ops::SANDBOX_ENV_PASSTHROUGH,
    });
...
pub async fn apply_sandbox_settings(
    ...
    if let Some(ref backend) = update.backend {
        config.sandbox.backend = match backend.as_str() {
            "auto" => crate::neppy::config::SandboxBackend::Auto,
            "landlock" => crate::neppy::config::SandboxBackend::Landlock,
            "firejail" => crate::neppy::config::SandboxBackend::Firejail,
            "bubblewrap" => crate::neppy::config::SandboxBackend::Bubblewrap,
            "docker" => crate::neppy::config::SandboxBackend::Docker,
            "none" => crate::neppy::config::SandboxBackend::None,
            other => {
