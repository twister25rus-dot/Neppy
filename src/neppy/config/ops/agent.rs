...
pub struct AutonomySettingsPatch {
    ...
    pub trusted_roots: Option<Vec<crate::neppy::security::TrustedRoot>>,
...
pub async fn apply_autonomy_settings(
    ...
    crate::neppy::security::live_policy::reload_from(&config.autonomy);
...
pub async fn apply_agent_settings(
    ...
    use crate::neppy::tools::timeout::{MAX_TIMEOUT_SECS, MIN_TIMEOUT_SECS};
...
pub async fn get_agent_settings() -> Result<RpcOutcome<serde_json::Value>, String> {
    ...
    let value = serde_json::json!({
        ...
        "effective_timeout_secs": crate::neppy::tools::timeout::tool_execution_timeout_secs(),
        "env_override": crate::neppy::tools::timeout::env_override_active(),
        "min_timeout_secs": crate::neppy::tools::timeout::MIN_TIMEOUT_SECS,
        "max_timeout_secs": crate::neppy::tools::timeout::MAX_TIMEOUT_SECS,
    });
...
pub async fn ensure_agent_dirs(config: &mut Config) {
    ...
    let projects_dir = crate::neppy::config::default_projects_dir();
...
fn action_dir_source(config: &Config) -> &'static str {
    if crate::neppy::config::action_dir_env_override().is_some() {
        "env"
...
pub async fn apply_agent_paths_settings(
    ...
    if let Some(raw) = update.action_dir {
        ...
        config.action_dir = crate::neppy::config::resolve_action_dir(&config.action_dir_override);

        config.save().await.map_err(|e| e.to_string())?;

        crate::neppy::security::live_policy::set_action_dir(config.action_dir.clone());
...
pub async fn apply_activity_level_settings(
    ...
    use crate::neppy::config::schema::activity_level::AgentActivityLevel;
    use crate::neppy::config::SchedulerGateMode;
    ...
    crate::neppy::cron::scheduler_gate::gate::update_config(gate_cfg);
...
fn memory_sync_settings_value(stored: Option<u64>) -> serde_json::Value {
    ...
    let selected_secs = stored.unwrap_or(crate::neppy::config::DEFAULT_MEMORY_SYNC_INTERVAL_SECS);
    json!({
        "sync_interval_secs": stored,
        "selected_secs": selected_secs,
        "is_manual": is_manual,
        "is_default": is_default,
        "default_secs": crate::neppy::config::DEFAULT_MEMORY_SYNC_INTERVAL_SECS,
        "presets": crate::neppy::config::MEMORY_SYNC_INTERVAL_PRESETS_SECS,
    })
}
