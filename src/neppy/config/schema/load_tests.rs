...
use super::*;
use crate::neppy::config::schema::{StreamMode, TelegramConfig};
...
fn searxng_timeout_seconds_alias_deserializes() {
    let cfg: crate::neppy::config::SearxngConfig =
...
fn env_overlay_learning_source_values_and_invalid_ignored() {
    ...
    assert_eq!(
        ...
        crate::neppy::config::ReflectionSource::Local
    );
...
fn env_overlay_context_tool_result_budget_env_suppresses_legacy_migration() {
    ...
    // the default.
    let default_budget = crate::neppy::agent::context::DEFAULT_TOOL_RESULT_BUDGET_BYTES;
    let mut cfg = Config::default();
...
fn env_overlay_auto_update_restart_strategy_accepts_supported_values() {
    ...
    assert_eq!(
        ...
        crate::neppy::config::UpdateRestartStrategy::Supervisor
    );
    ...
    assert_eq!(
        cfg.update.restart_strategy,
        crate::neppy::config::UpdateRestartStrategy::SelfReplace
    );
}
...
fn apply_env_overrides_commits_side_effects_to_runtime_proxy() {
    use crate::neppy::config::schema::proxy::{runtime_proxy_config, set_runtime_proxy_config};
...
async fn load_or_init_falls_back_to_defaults_when_backup_also_corrupted() {
    ...
    assert_eq!(
        config.default_model.as_deref(),
        Some(crate::neppy::config::schema::DEFAULT_MODEL),
...
fn migrate_cloud_provider_slugs_routes_cloud_to_legacy_custom_when_primary_is_openhuman() {
    ...
    cfg.cloud_providers = vec![
        crate::neppy::config::schema::CloudProviderCreds {
            id: "p_oh".into(),
            slug: "openhuman".into(),
            label: "Neppy".into(),
            endpoint: "https://api.openhuman.ai/v1".into(),
            auth_style: crate::neppy::config::schema::AuthStyle::OpenhumanJwt,
            ..Default::default()
        },
        crate::neppy::config::schema::CloudProviderCreds {
            id: "p_custom".into(),
            ...
            auth_style: crate::neppy::config::schema::AuthStyle::Bearer,
...
fn migrate_cloud_provider_slugs_keeps_cloud_on_neppy_without_legacy_custom() {
    ...
    cfg.primary_cloud = Some("p_oh".into());
    cfg.memory_provider = Some("cloud".into());
    cfg.cloud_providers = vec![crate::neppy::config::schema::CloudProviderCreds {
        id: "p_oh".into(),
        slug: "openhuman".into(),
        label: "Neppy".into(),
