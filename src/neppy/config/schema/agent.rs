...
/// `crate::neppy::agent::harness::required_output`), so consumers always get
/// a well-formed block.
...
pub struct AgentConfig {
    ...
    /// [`crate::neppy::tools::agent_policy::engine::ToolPolicyEngine`]):
    ///
    ...
    /// it ON. See
    /// [`crate::neppy::agent::session_import::live::dual_write_enabled`].
    ...
    /// [`crate::neppy::agent::session_import::live::shadow_reads_enabled`].
...
fn default_tool_result_budget_bytes() -> usize {
    crate::neppy::agent::context::DEFAULT_TOOL_RESULT_BUDGET_BYTES
}

fn default_agent_timeout_secs() -> u64 {
    crate::neppy::tools::timeout::DEFAULT_TIMEOUT_SECS
}
