...
pub struct ModelRegistryEntry {
    ...
    /// for known vendor models from [`crate::neppy::platform::cost::catalog`].
    #[serde(default)]
    ...
    /// vendor models from [`crate::neppy::platform::cost::catalog`].
    #[serde(default)]
...
pub struct Config {
    ...
    /// migration under [`crate::neppy::config::migrations`] runs successfully.
    ...
    /// [`crate::neppy::agent::context::ContextManager`].
    #[serde(default)]
    ...
    #[serde(default)]
    pub subconscious: crate::neppy::config::schema::SubconsciousConfig,
    ...
    /// See [`crate::neppy::integrations::task_sources`].
    #[serde(default)]
    ...
    /// compiled in, not configured: see `neppy::modules::registry`.
    #[serde(default)]
    ...
    #[serde(default)]
    pub memory_sources: Vec<crate::neppy::memory::sources::types::MemorySourceEntry>,
    ...
    #[serde(default)]
    pub agent_registry: crate::neppy::agent::registry::types::AgentRegistryConfig,
    ...
    #[serde(default)]
    pub cloud_providers: Vec<crate::neppy::config::schema::cloud_providers::CloudProviderCreds>,
    ...
    #[serde(skip)]
    #[schemars(skip)]
    pub ephemeral_route: Option<crate::neppy::config::schema::ephemeral_route::EphemeralRoute>,
    ...
    /// for LLM inference.
    #[serde(default)]
    pub voice_providers: Vec<crate::neppy::config::schema::voice_providers::VoiceProviderCreds>,
...
impl Default for Config {
    fn default() -> Self {
        let neppy_dir = crate::neppy::config::default_root_neppy_dir().unwrap_or_else(|_| {
            let home =
        ...
        Self {
            ...
            action_dir: crate::neppy::config::default_action_dir(),
            ...
            subconscious: crate::neppy::config::schema::SubconsciousConfig::default(),
