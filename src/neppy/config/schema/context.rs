...
//!
//! Knobs for the global `src/neppy/agent/context/` module — budget
...
use crate::neppy::agent::context::session_memory::SessionMemoryConfig;
...
pub struct ContextConfig {
    /// Master switch. When `false`, [`crate::neppy::agent::context::ContextManager`]
...
fn default_microcompact_keep_recent() -> usize {
    crate::neppy::agent::context::DEFAULT_KEEP_RECENT_TOOL_RESULTS
}
