...
pub fn build_runtime_proxy_client(service_key: &str) -> reqwest::Client {
    ...
    let builder =
        apply_runtime_proxy_to_builder(crate::neppy::util::tls::tls_client_builder(), service_key);
    let client = builder.build().unwrap_or_else(|error| {
        ...
        let fb = crate::neppy::util::tls::tls_client_builder();
...
pub fn build_runtime_proxy_client_with_timeouts(
    ...
    // Platform-appropriate TLS backend — see [`crate::neppy::util::tls`].
    let raw = crate::neppy::util::tls::tls_client_builder()
