...
pub struct CostConfig {
    ...
    ///
    /// When `true`, [`crate::neppy::platform::cost::CostTracker::check_budget`]
    ...
    /// [`crate::neppy::platform::cost::record_provider_usage`] regardless of
    ...
    /// [`crate::neppy::platform::cost::route`]. Bring-your-own-key and local
