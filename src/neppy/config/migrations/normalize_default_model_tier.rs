...
use crate::neppy::config::{Config, MODEL_CHAT_V1, MODEL_REASONING_QUICK_V1, MODEL_REASONING_V1};
...
mod tests {
    use super::*;
    use crate::neppy::config::{Config, MODEL_REASONING_QUICK_V1, MODEL_REASONING_V1};
