...
use crate::neppy::runtime::node::types::{ExecuteToolOutcome, RuntimeToolSummary};
use crate::neppy::security::{CommandClass, SecurityPolicy};
use crate::neppy::tools::{self, PermissionLevel, Tool, ToolCallOptions, ToolScope};
...
mod tests {
    ...
    impl Tool for DummyTool {
        ...
        ) -> anyhow::Result<crate::neppy::skills::types::ToolResult> {
            Ok(crate::neppy::skills::types::ToolResult::success("ok"))
        }
    }
