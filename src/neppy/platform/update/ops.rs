...
use crate::neppy::config::{self, UpdateConfig, UpdateRestartStrategy};
use crate::neppy::platform::update;
use crate::neppy::platform::update::types::{
...
async fn build_run_result_from_staged_update(
    ...
    match restart_strategy {
        UpdateRestartStrategy::SelfReplace => {
            let restart_requested = match crate::neppy::platform::service::rpc::service_restart(
