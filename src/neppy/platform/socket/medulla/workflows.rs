...
pub(in crate::neppy::platform::socket) fn connection_generation() -> CancellationToken {
...
pub(in crate::neppy::platform::socket) fn with_live_connection<R>(
...
/// sent it.
pub(in crate::neppy::platform::socket) fn begin_connection_generation() {
    connection_generation_state().write().begin();
}

/// End the current authenticated-socket lifetime and cancel its work.
pub(in crate::neppy::platform::socket) fn end_connection_generation() {
