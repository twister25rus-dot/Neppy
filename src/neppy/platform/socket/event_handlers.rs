...
use crate::neppy::skills::webhooks::WebhookRequest;
...
pub(super) fn handle_sio_event(
    ...
    match event_name {
        "ready" => {
            ...
            *shared.status.write() = ConnectionStatus::Connected;
            ...
            emit_via_channel(
                emit_tx,
                "orch:register_tools",
                crate::neppy::hosted::orchestration::effect_executor::device_tool_manifest(),
            );
        ...
        "orch:effect:send_dm" => {
            ...
            tokio::spawn(async move {
                if let Some((call_id, ack)) =
                    crate::neppy::hosted::orchestration::effect_executor::handle_send_dm(&data)
                        .await
                {
        ...
        "orch:tool_call" => {
            ...
            tokio::spawn(async move {
                ...
                if let Some((call_id, result)) =
                    crate::neppy::hosted::orchestration::effect_executor::handle_tool_call(&data)
                        .await
                {
                    if emit_result_if_connected(
                        &tx,
        ...
        "orch:effect:evict" => {
            ...
            tokio::spawn(async move {
                if let Some((call_id, ack)) =
                    crate::neppy::hosted::orchestration::effect_executor::handle_evict(&data).await
                {
                    if emit_result_if_connected(
                        &tx,
                        &connection,
        ...
        "webhook:request" => {
            ...
            match serde_json::from_value::<WebhookRequest>(data.clone()) {
                ...
                Err(e) => {
                    ...
                    if let Some(mgr) = crate::neppy::platform::socket::global_socket_manager() {
        ...
        "composio:trigger" => {
            ...
            match serde_json::from_value::<crate::neppy::integrations::composio::ComposioTriggerEvent>(
                data.clone(),
            ) {
                Ok(event) => {
        ...
        "tunnel:peer-status" => {
            ...
            match serde_json::from_value::<
                crate::neppy::security::devices::tunnel_client::TunnelPeerStatus,
            >(data.clone())
            {
                Ok(status) => {
                    if status.online {
        ...
        "tunnel:frame" => {
            ...
            match serde_json::from_value::<
                crate::neppy::security::devices::tunnel_client::TunnelFrame,
            >(data.clone())
            {
                Ok(frame) => {
        ...
        "voice:harness" => {
            ...
            if correlation_id.is_empty() {
                ...
                #[cfg(feature = "voice")]
                tokio::spawn(
                    crate::neppy::voice::realtime_harness::handle_voice_harness_turn(
                        correlation_id,
                        messages,
                    ),
                );
...
mod tests {
    ...
    use crate::neppy::hosted::orchestration::effect_executor::{is_duplicate_call, release_call};
