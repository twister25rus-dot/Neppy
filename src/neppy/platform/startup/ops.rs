...
pub fn run_workspace_migrations(workspace_dir: &Path) {
    match crate::neppy::agent::harness::session::migrate_session_layout_if_needed(workspace_dir) {
    ...
    match crate::neppy::threads::migrate_welcome_agent_artifacts(workspace_dir) {
