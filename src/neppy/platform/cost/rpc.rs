...
//! by [`crate::neppy::platform::cost::init_global`]. When the global is missing —
...
use crate::neppy::config::{Config, CostConfig};
...
mod tests {
    use super::*;
    use crate::neppy::platform::cost::types::TokenUsage;
    use chrono::Utc;
    use std::collections::HashMap;
