...
pub(super) struct InFlightEntry {
    ...
    pub(super) run_queue: std::sync::Arc<crate::neppy::agent::harness::run_queue::RunQueue>,
...
pub(super) struct WebChatTaskResult {
    ...
    pub(super) citations: Vec<crate::neppy::memory::agent::memory_loader::MemoryCitation>,
    ...
    pub(super) usage: Option<crate::neppy::agent::harness::turn_subagent_usage::LastTurnUsage>,
}
