...
use crate::neppy::agent::harness::turn_subagent_usage::LastTurnUsage;
...
pub(crate) async fn deliver_response(
    ...
    full_response: &str,
    user_message: &str,
    citations: &[crate::neppy::memory::agent::memory_loader::MemoryCitation],
...
async fn try_reaction(user_message: &str) -> Option<String> {
    ...
    match crate::neppy::inference::ops::inference_should_react(&config, user_message, "web").await {
        Ok(outcome) => {
