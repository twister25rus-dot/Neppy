...
mod tests {
    ...
    async fn egress_surface_bridges_pending_with_chat_context() {
        ...
        crate::core::bus::BUS.publish(DomainEvent::ExternalTransferPending {
            descriptor: crate::neppy::security::egress::EgressDescriptor::composio(marker),
    ...
    async fn egress_surface_drops_pending_without_chat_context() {
        ...
        crate::core::bus::BUS.publish(DomainEvent::ExternalTransferPending {
            descriptor: crate::neppy::security::egress::EgressDescriptor::composio(dropped_marker),
            thread_id: None,
            client_id: None,
        });
        crate::core::bus::BUS.publish(DomainEvent::ExternalTransferPending {
            descriptor: crate::neppy::security::egress::EgressDescriptor::composio(sentinel_marker),
