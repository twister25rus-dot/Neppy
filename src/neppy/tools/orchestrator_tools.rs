...
//!
//! Called from [`crate::neppy::agent::harness::session::builder`] at
...
//!
//! [`AgentDefinition::when_to_use`]: crate::neppy::agent::harness::definition::AgentDefinition::when_to_use
//! [`SubagentEntry::AgentId`]: crate::neppy::agent::harness::definition::SubagentEntry::AgentId
//! [`SubagentEntry::Skills`]: crate::neppy::agent::harness::definition::SubagentEntry::Skills

use crate::neppy::agent::context::prompt::ConnectedIntegration;
