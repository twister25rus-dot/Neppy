...
use crate::neppy::search::tools::SEARXNG_MAX_RESULTS;
...
fn handle_web_search(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        let client = crate::neppy::integrations::build_client(&config).ok_or_else(|| {
        ...
        let resp = client
            .post::<crate::neppy::search::tools::SearchResponse>(
        ...
        let provider = crate::neppy::search::tools::resolve_managed_provider(&resp);
...
fn handle_seltz_search(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let tool = crate::neppy::search::tools::SeltzSearchTool::new(
...
fn handle_querit_search(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let tool = crate::neppy::search::tools::QueritSearchTool::new(
...
fn handle_searxng_search(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let tool = crate::neppy::search::tools::SearxngSearchTool::new(
        ...
        let response = tool
            .search(crate::neppy::search::tools::SearxngSearchArgs {
                query,
                categories,
                language,
                max_results,
...
fn handle_apify_linkedin_scrape(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let data = crate::neppy::agent::learning::linkedin_enrichment::scrape_linkedin_profile(
            &client,
            &profile_url,
        )
        .await
        ...
        let markdown = crate::neppy::agent::learning::linkedin_enrichment::render_profile_markdown(
            &profile_url,
            &data,
        );
