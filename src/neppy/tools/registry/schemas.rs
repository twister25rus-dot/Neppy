...
fn handle_list(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::neppy::tools::registry::ops::list_tools())
    })
}
...
fn handle_get(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::neppy::tools::registry::ops::get_tool(tool_id)?)
    })
}
...
fn handle_diagnostics(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let result = crate::neppy::tools::registry::ops::diagnostics()
            .await
            .and_then(to_json);
        log::debug!(
