...
use crate::neppy::agent::host_runtime::{NativeRuntime, RuntimeAdapter};
use crate::neppy::config::{Config, DelegateAgentConfig};
use crate::neppy::runtime::javascript::NodeBootstrap;
use crate::neppy::runtime::python::PythonBootstrap;
...
pub fn all_tools(
    ...
    browser_config: &crate::neppy::config::BrowserConfig,
    http_config: &crate::neppy::config::HttpRequestConfig,
    action_dir: &std::path::Path,
    agents: &HashMap<String, DelegateAgentConfig>,
    root_config: &crate::neppy::config::Config,
) -> Vec<Box<dyn Tool>> {
...
pub fn all_tools_with_runtime(
    ...
    agents: &HashMap<String, DelegateAgentConfig>,
    root_config: &crate::neppy::config::Config,
    active_profile: Option<&crate::neppy::agent::profiles::AgentProfile>,
    ...
    let mut tools: Vec<Box<dyn Tool>> = vec![
        ...
        Box::new(crate::neppy::agent::plan_review::RequestPlanReviewTool::new()),
        ...
        Box::new(crate::neppy::inference::tokenjuice::TokenjuiceRetrieveTool::new()),
        ...
        Box::new(crate::neppy::hosted::orchestration::tools::ListSessionsTool::new(config.clone())),
        Box::new(crate::neppy::hosted::orchestration::tools::ReadSessionTool::new(config.clone())),
        // List the agent's tiny.place contacts (browse-loop entry point).
        Box::new(crate::neppy::hosted::orchestration::tools::ListContactsTool),
        ...
        Box::new(crate::neppy::hosted::orchestration::tools::SendToAgentTool::new(config.clone())),
    ...
    tools.push(Box::new(crate::neppy::memory::diff::MemoryDiffTool));
    ...
    // allowlist); also available to the main agent for explicit edits.
    {
        ...
        tools.push(Box::new(
            crate::neppy::memory::tools::goals::GoalsListTool::new(goals_dir.clone()),
        ));
        tools.push(Box::new(
            crate::neppy::memory::tools::goals::GoalsAddTool::new(goals_dir.clone()),
        ));
        tools.push(Box::new(
            crate::neppy::memory::tools::goals::GoalsEditTool::new(goals_dir.clone()),
        ));
        tools.push(Box::new(
            crate::neppy::memory::tools::goals::GoalsDeleteTool::new(goals_dir),
        ));
    }
    ...
    // system-driven and have no model tool.
    {
        ...
        tools.push(Box::new(crate::neppy::threads::goals::GoalGetTool::new(
            goal_dir.clone(),
        )));
        tools.push(Box::new(crate::neppy::threads::goals::GoalSetTool::new(
            goal_dir.clone(),
        )));
        tools.push(Box::new(
            crate::neppy::threads::goals::GoalCompleteTool::new(goal_dir),
        ));
    }
    ...
    #[cfg(feature = "web3")]
    tools.push(Box::new(
        crate::neppy::web3::x402::tools::X402RequestTool::new(),
    ));
    ...
    #[cfg(feature = "mcp")]
    {
        let mcp_registry = {
            ...
            let base = crate::neppy::mcp::host::static_registry(root_config);
    ...
    tools.extend(crate::neppy::search::build_search_tools(root_config));
    ...
    #[cfg(feature = "media")]
    tools.extend(crate::neppy::media::generation::build_media_tools(
        root_config,
        action_dir,
    ));
    ...
    tools.extend(
        crate::neppy::integrations::file_storage::build_file_storage_tools(root_config, action_dir),
    );
    ...
    #[cfg(feature = "hosting")]
    match crate::neppy::hosting::Account::from_config(root_config) {
        Ok(Some(account)) => {
    ...
    tools.extend(crate::neppy::web3::all_web3_agent_tools());
    ...
    if !agents.is_empty() {
        ...
        tools.push(Box::new(DelegateTool::new_with_options(
            delegate_agents,
            security.clone(),
            crate::neppy::inference::provider::ProviderRuntimeOptions {
    ...
    if let Some(client) = crate::neppy::integrations::build_client(root_config) {
        tracing::debug!("[integrations] client built successfully");
        if root_config.integrations.google_places.is_active() {
            tools.push(Box::new(crate::neppy::tools::GooglePlacesSearchTool::new(
                Arc::clone(&client),
            )));
            tools.push(Box::new(crate::neppy::tools::GooglePlacesDetailsTool::new(
                Arc::clone(&client),
            )));
        ...
        if root_config.integrations.stock_prices.is_active() {
            tools.push(Box::new(crate::neppy::tools::StockQuoteTool::new(
                Arc::clone(&client),
            )));
            tools.push(Box::new(crate::neppy::tools::StockExchangeRateTool::new(
                Arc::clone(&client),
            )));
            tools.push(Box::new(crate::neppy::tools::StockOptionsTool::new(
                Arc::clone(&client),
            )));
            tools.push(Box::new(crate::neppy::tools::StockCryptoSeriesTool::new(
                Arc::clone(&client),
            )));
            tools.push(Box::new(crate::neppy::tools::StockCommodityTool::new(
                Arc::clone(&client),
            )));
        ...
        if root_config.integrations.twilio.is_active() {
            tools.push(Box::new(crate::neppy::tools::TwilioCallTool::new(
                Arc::clone(&client),
            )));
        ...
        // `src/neppy/integrations/composio/tools.rs` for per-tool details.
        let composio_tools =
            crate::neppy::integrations::composio::all_composio_agent_tools(root_config);
    ...
    if crate::neppy::tools::implementations::lsp_capability_enabled() {
        tools.push(Box::new(
            crate::neppy::tools::implementations::LspTool::new(),
        ));
    ...
    {
        let groups = crate::neppy::tools::toolpacks::groups::current();
        tools.retain(|t| {
            groups.mode_for_tool(t.name()) != crate::neppy::tools::toolpacks::GroupMode::Off
        });
    }
    ...
    crate::neppy::tools::toolpacks::append_pack_tools(&mut tools);
    tools
}
...
fn tool_group(name: &str) -> crate::core::all::DomainGroup {
    ...
    if crate::neppy::inference::tokenjuice::RECOVERY_TOOL_NAMES.contains(&name) {
