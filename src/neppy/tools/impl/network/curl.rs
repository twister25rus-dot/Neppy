    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        // URL validation / DNS so nothing leaves the device.
        {
            ...
            if let Some(msg) = crate::neppy::security::egress::local_only_tool_block(
                &crate::neppy::security::egress::EgressDescriptor::network_fetch(host.clone()),
            ) {
        ...
        // downloads.
        {
            ...
            crate::neppy::security::egress::emit_external_transfer(desc);
        }
        ...
        let builder = crate::neppy::config::apply_runtime_proxy_to_builder(builder, "tool.curl");
