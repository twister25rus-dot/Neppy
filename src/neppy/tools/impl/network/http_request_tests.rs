...
fn zero_limits_fall_back_to_defaults() {
    ...
    let defaults = crate::neppy::config::HttpRequestConfig::default();
...
fn egress_descriptor_reports_host_and_url_kind_when_bare() {
    ...
    assert_eq!(
        desc.data_kinds,
        vec![crate::neppy::security::egress::DataKind::Url]
    );
}
...
fn egress_descriptor_adds_tool_arguments_for_body() {
    ...
    assert!(desc
        .data_kinds
        .contains(&crate::neppy::security::egress::DataKind::ToolArguments));
    assert!(!desc
        .data_kinds
        .contains(&crate::neppy::security::egress::DataKind::Metadata));
}
...
fn egress_descriptor_reports_both_body_and_headers() {
    ...
    assert!(kinds.contains(&crate::neppy::security::egress::DataKind::ToolArguments));
    assert!(kinds.contains(&crate::neppy::security::egress::DataKind::Metadata));
}
