use crate::neppy::mcp::config_servers::{McpRegistrySource, McpServerRegistry};
...
mod tests {
    use super::*;
    use crate::neppy::config::{Config, McpServerConfig};
    ...
    fn test_registry() -> Arc<McpServerRegistry> {
        ...
        Arc::new(crate::neppy::mcp::host::static_registry(&config))
    }
