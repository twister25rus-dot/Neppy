...
//! restart of the Neppy core binary.
//!
//! Wraps [`crate::neppy::platform::update::rpc::update_run`] so the LLM can
...
impl Tool for UpdateApplyTool {
    ...
    fn description(&self) -> &str {
        "Download, verify, and stage the latest Neppy core binary, then \
