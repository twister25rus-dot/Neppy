...
use crate::neppy::security::{AuditLogger, CommandExecutionLog, GateDecision, SecurityPolicy};
...
impl ShellTool {
    ...
    async fn run_with_security_in_context(
        ...
        for (key, value) in crate::neppy::agent::git_attribution::hook_env() {
            cmd.env(key, value);
        }
        ...
        let scratch_dir = crate::neppy::security::neppy_scratch_dir();
    ...
    async fn run_sandboxed(
        ...
        let config = crate::neppy::config::RuntimeConfig::default();
        ...
        extra_env.extend(crate::neppy::agent::git_attribution::hook_env());
...
mod tests {
    ...
    use crate::neppy::security::{AutonomyLevel, CommandClass, SecurityPolicy};
    ...
    fn audit_with_tempdir() -> (Arc<AuditLogger>, tempfile::TempDir) {
        use crate::neppy::config::AuditConfig;
    ...
    async fn shell_emits_audit_line_on_success() {
        use crate::neppy::security::AuditEvent;
    ...
    async fn shell_uses_workspace_descriptor_root_as_cwd() {
        ...
        let result = tool
            .execute_with_context(
                json!({"command": "pwd"}),
                crate::neppy::tools::traits::ToolCallOptions {
