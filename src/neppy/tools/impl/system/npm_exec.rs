...
//! [`crate::neppy::runtime::javascript::NodeBootstrap`] for binary resolution.
//! Same security posture as
//! [`crate::neppy::tools::impl::system::shell::ShellTool`] and
//! [`crate::neppy::tools::impl::system::node_exec::NodeExecTool`]:
//!
