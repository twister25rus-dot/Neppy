...
use crate::neppy::modules::documents::DocumentCallError;
...
// `spec` is separable.
pub use crate::neppy::tools::implementations::document::format::spec::document::{
...
pub use crate::neppy::tools::implementations::document::format::spec::DocumentSection;

/// Tool output returned via [`crate::neppy::tools::traits::ToolResult`]
...
impl DocumentError {
    ...
    pub(super) fn truncate_stderr(raw: &str) -> String {
        crate::neppy::tools::implementations::document::format::Error::truncate_detail(raw)
    }
}

impl From<crate::neppy::tools::implementations::document::format::Error> for DocumentError {
    ...
    ///
    /// `crate::neppy::tools::implementations::document::format::Error` is `#[non_exhaustive]`, so the catch-all arm is
    ...
    fn from(err: crate::neppy::tools::implementations::document::format::Error) -> Self {
        match err {
            crate::neppy::tools::implementations::document::format::Error::InvalidInput {
                field,
                reason,
            } => Self::InvalidInput { field, reason },
            crate::neppy::tools::implementations::document::format::Error::GenerationFailed {
                detail,
...
/// [`crate::neppy::tools::implementations::document::format::docx::generate`]. The double check is intentional: validating
...
mod tests {
    ...
    fn tinydocs_generation_failure_maps_without_re_truncating() {
        ...
        let detail = crate::neppy::tools::implementations::document::format::Error::truncate_detail(
            &"x".repeat(10_000),
        );
        let mapped = DocumentError::from(
            crate::neppy::tools::implementations::document::format::Error::GenerationFailed {
    ...
    fn truncate_stderr_bounds_the_payload() {
        ...
        assert_eq!(
            out.chars().count(),
            crate::neppy::tools::implementations::document::format::Error::MAX_DETAIL_CHARS
        );
