...
use crate::neppy::web3::wallet::prepared_quotes_for_test;
use crate::neppy::web_chat::in_flight_entries_for_test;
...
pub struct PreparedQuotesResult {
    pub count: usize,
    pub quotes: Vec<crate::neppy::web3::wallet::PreparedTransaction>,
}
