...
//! [`ToolHook`](crate::neppy::agent::hooks::ToolHook) around every tool and
//! [`PostTurnHook`](crate::neppy::agent::hooks::PostTurnHook) after every
...
impl ConfiguredHookBridge {
    ...
    pub fn install() {
        crate::neppy::agent::hooks::replace_embedder_tool_hook(
            BRIDGE_HOOK_NAME,
            Some(std::sync::Arc::new(ConfiguredHookBridge)),
        );
        crate::neppy::agent::hooks::replace_embedder_post_turn_hook(
            BRIDGE_HOOK_NAME,
            Some(std::sync::Arc::new(ConfiguredHookBridge)),
        );
    ...
    pub fn uninstall() {
        crate::neppy::agent::hooks::replace_embedder_tool_hook(BRIDGE_HOOK_NAME, None);
        crate::neppy::agent::hooks::replace_embedder_post_turn_hook(BRIDGE_HOOK_NAME, None);
