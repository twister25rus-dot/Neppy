    ...
    tokio::spawn(async {
        ...
        loop {
            ...
            if !discoverable {
                ...
                match crate::neppy::tinyplace::ensure_signal_keys_published().await {
                    Ok(true) => {
                        discoverable = true;
                        not_discoverable_cycles = 0;
                        log::info!(
            ...
            match crate::neppy::agent::orchestration::pairing::auto_accept_linked_contact_requests(
                &config,
            )
            .await
            {
...
pub(super) fn command_center_needs_input(
    ...
    use crate::neppy::agent::orchestration::command_center::build_view;
...
mod tests {
    use super::*;
    use crate::neppy::hosted::orchestration::types::{OrchestrationMessage, OrchestrationSession};
