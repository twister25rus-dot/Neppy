...
#[cfg(feature = "mcp")]
pub fn start(config: &crate::neppy::config::Config) {
    registry::bus::init();
...
#[cfg(not(feature = "mcp"))]
pub fn start(_config: &crate::neppy::config::Config) {}
...
#[cfg(feature = "mcp")]
pub fn start_boot_jobs(config: &crate::neppy::config::Config) {
    start(config);
...
#[cfg(not(feature = "mcp"))]
pub fn start_boot_jobs(_config: &crate::neppy::config::Config) {}
