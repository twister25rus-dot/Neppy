...
fn handle_registry_search(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::neppy::mcp::registry::ops::mcp_clients_registry_search(
...
fn handle_registry_get(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::neppy::mcp::registry::ops::mcp_clients_registry_get(&config, qualified_name)
                .await?,
        )
    })
}
...
fn handle_installed_list(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let _ = params;
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(crate::neppy::mcp::registry::ops::mcp_clients_installed_list(&config).await?)
    })
}
...
fn handle_install(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::neppy::mcp::registry::ops::mcp_clients_install(
                &config,
                qualified_name,
                env,
                config_value,
...
fn handle_update_env(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let env = read_required::<std::collections::HashMap<String, String>>(&params, "env")?;
        to_json(
            crate::neppy::mcp::registry::ops::mcp_clients_update_env(&config, server_id, env)
                .await?,
        )
    })
}
...
fn handle_uninstall(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
        let server_id = read_required::<String>(&params, "server_id")?;
        to_json(crate::neppy::mcp::registry::ops::mcp_clients_uninstall(&config, server_id).await?)
    })
}
...
fn handle_detect_auth(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let server_id = read_required::<String>(&params, "server_id")?;
        to_json(
            crate::neppy::mcp::registry::ops::mcp_clients_detect_auth(&config, server_id).await?,
        )
    })
}
...
fn handle_oauth_begin(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let server_id = read_required::<String>(&params, "server_id")?;
        to_json(
            crate::neppy::mcp::registry::ops::mcp_clients_oauth_begin(&config, server_id).await?,
        )
    })
}
...
fn handle_connect(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
        let server_id = read_required::<String>(&params, "server_id")?;
        to_json(crate::neppy::mcp::registry::ops::mcp_clients_connect(&config, server_id).await?)
    })
}
...
fn handle_disconnect(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
        let server_id = read_required::<String>(&params, "server_id")?;
        to_json(crate::neppy::mcp::registry::ops::mcp_clients_disconnect(&config, server_id).await?)
    })
}
...
fn handle_set_enabled(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::neppy::mcp::registry::ops::mcp_clients_set_enabled(&config, server_id, enabled)
                .await?,
        )
    })
}
...
fn handle_status(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let _ = params;
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(crate::neppy::mcp::registry::ops::mcp_clients_status(&config).await?)
    })
}
...
fn handle_tool_call(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(
            crate::neppy::mcp::registry::ops::mcp_clients_tool_call(
...
fn handle_config_assist(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let history =
            read_optional::<Vec<crate::neppy::mcp::registry::types::ChatTurn>>(&params, "history")?;
        to_json(
            crate::neppy::mcp::registry::ops::mcp_clients_config_assist(
                &config,
                qualified_name,
                user_message,
                history,
...
fn handle_registry_settings_get(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let _ = params;
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(crate::neppy::mcp::registry::ops::mcp_clients_registry_settings_get(&config).await?)
    })
}
...
fn handle_registry_settings_set(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::neppy::mcp::registry::ops::mcp_clients_registry_settings_set(
                &mut config,
                smithery_api_key,
                mcp_official_base,
                mcp_official_token,
...
fn handle_setup_search(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let page_size = read_optional_u32(&params, "page_size")?;
        to_json(
            crate::neppy::mcp::registry::setup_ops::mcp_setup_search(
...
fn handle_setup_get(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let qualified_name = read_required::<String>(&params, "qualified_name")?;
        to_json(
            crate::neppy::mcp::registry::setup_ops::mcp_setup_get(&config, qualified_name).await?,
        )
    })
}
...
fn handle_setup_request_secret(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(
            crate::neppy::mcp::registry::setup_ops::mcp_setup_request_secret(
...
fn handle_setup_submit_secret(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(
            crate::neppy::mcp::registry::setup_ops::mcp_setup_submit_secret(&config, ref_id, value)
                .await?,
        )
    })
}
...
fn handle_setup_test_connection(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::neppy::mcp::registry::setup_ops::mcp_setup_test_connection(
                &config,
                qualified_name,
                env_refs,
            )
...
fn handle_setup_install_and_connect(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let env_refs =
            read_required::<std::collections::HashMap<String, String>>(&params, "env_refs")?;
        to_json(
            crate::neppy::mcp::registry::setup_ops::mcp_setup_install_and_connect(
                &config,
                qualified_name,
                env_refs,
            )
