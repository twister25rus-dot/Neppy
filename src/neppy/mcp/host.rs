...
fn credentialed_endpoint_transport_allowed(server: &crate::neppy::config::McpServerConfig) -> bool {
    use crate::neppy::config::McpAuthConfig;
...
fn server_config(server: &crate::neppy::config::McpServerConfig) -> McpServerConfig {
    McpServerConfig {
...
fn auth_config(auth: &crate::neppy::config::McpAuthConfig) -> tinymcp::McpAuthConfig {
    use crate::neppy::config::McpAuthConfig as Host;
...
pub fn proxy_for_mcp() -> Option<McpProxyConfig> {
    let proxy = crate::neppy::config::runtime_proxy_config();
