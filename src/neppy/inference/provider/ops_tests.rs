...
async fn configure_openrouter_workspace(tmp: &TempDir, endpoint: String, token: &str) -> Config {
    ...
    auth.store_provider_token(
        &crate::neppy::inference::provider::factory::auth_key_for_slug("openrouter"),
        "default",
        token,
        HashMap::new(),
        true,
...
fn backend_error_code_owned_gates_managed_errors_except_malformed_bad_request() {
    use crate::neppy::inference::provider::neppy_backend_model::PROVIDER_LABEL;
...
fn is_backend_auth_failure_only_matches_neppy_backend_401_403() {
    ...
    let backend = crate::neppy::inference::provider::neppy_backend_model::PROVIDER_LABEL;
