...
fn enforce_local_only_inference_errors_on_external_when_local_only() {
    ...
    crate::neppy::security::live_policy::install(policy, ws.clone(), ws.clone());
    ...
    crate::neppy::security::live_policy::reload_privacy(PrivacyMode::Standard)
...
async fn neppy_jwt_slug_discloses_pinned_model() {
    ...
    use crate::neppy::security::egress::{EgressDescriptor, EgressReason};
...
async fn native_claude_turn_routes_disclose_pinned_models() {
    ...
    use crate::core::events::DomainEvent;
    use crate::neppy::security::egress::EgressDescriptor;
    use std::time::Duration;
...
fn neppy_jwt_slug_without_model_preserves_managed_role_tier() {
    ...
    assert_eq!(model_id, crate::neppy::config::MODEL_SUMMARIZATION_V1);
}
...
async fn from_string_external_provider_emits_egress_realpath() {
    use crate::core::events::DomainEvent;
    use crate::neppy::security::egress::EgressReason;
...
fn cloud_fallback_roles_match_the_roles_provider_for_role_actually_falls_back() {
    ...
    use crate::neppy::inference::provider::fallback_diagnostics::role_falls_back_to_cloud;
    let mut config = Config::default();
    config.chat_provider = Some("ollama:gemma3:1b".to_string());
...
fn routed_config(endpoint: &str, api_key: &str, model: &str) -> Config {
    use crate::neppy::config::schema::ephemeral_route::{apply, EphemeralRoute};
    let mut config = Config {
...
fn a_routed_turn_resolves_its_roles_to_the_callers_endpoint() {
    use crate::neppy::config::schema::EPHEMERAL_ROUTE_SLUG;
