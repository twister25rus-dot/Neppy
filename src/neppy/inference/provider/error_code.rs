...
//!
//! The Neppy **managed backend** (PR #870 / backend `tinyhumansai/backend#870`)
...
///   context stats state's `context_window`, `src/neppy/agent/context/stats.rs`),
...
mod tests {
    ...
    fn managed_envelope_gate_rejects_byo_payload_carrying_error_code() {
        ...
        let managed_stream = r#"Neppy streaming API error (500): {"errorCode":"INTERNAL_ERROR"}"#;
