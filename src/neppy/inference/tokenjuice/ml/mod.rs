...
//! runs inside the shared [`crate::neppy::runtime::python_server`] as the
...
use crate::neppy::inference::tokenjuice::types::CompressOptions;
...
pub async fn compress(text: &str, _opts: &CompressOptions) -> Result<Option<String>> {
    ...
    let resp = crate::neppy::runtime::python_server::request_kompress(&config, text).await?;
