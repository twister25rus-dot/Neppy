...
//! the per-model input price from [`crate::neppy::agent::cost`].
//!
...
use crate::neppy::inference::tokenjuice::types::{CompressorKind, ContentKind};
...
impl Default for State {
    fn default() -> Self {
        Self {
            ...
            attribution_model: crate::neppy::config::DEFAULT_MODEL.to_string(),
            snapshot_path: None,
        }
    }
}
...
tokio::task_local! {
    ...
    /// [`crate::neppy::agent::harness::turn_attachments_context`]. When set,
...
fn cost_saved_usd(model: &str, tokens_saved: u64) -> f64 {
    let pricing = crate::neppy::agent::cost::lookup_pricing(model);
