...
struct InferenceUpdateModelSettingsParams {
    ...
    #[serde(default)]
    model_registry: Option<Vec<crate::neppy::config::schema::ModelRegistryEntry>>,
...
fn handle_inference_resolve_model(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let resolved =
            crate::neppy::inference::provider::factory::resolve_model_for_hint(&p.hint, &config);
        ...
        let vision =
            crate::neppy::inference::model_context::model_supports_vision(&resolved, &config);
...
fn handle_inference_status(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(crate::neppy::inference::rpc::inference_status(&config).await?)
    })
}

fn handle_inference_get_client_config(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(
        async move { to_json(crate::neppy::inference::rpc::inference_get_client_config().await?) },
    )
}
    ...
    Box::pin(async move {
        ...
        let patch = config_rpc::ModelSettingsPatch {
            ...
            model_routes: update.model_routes.map(|routes| {
                routes
                    .into_iter()
                    .map(|route| crate::neppy::config::ModelRouteConfig {
                        hint: route.hint,
                        model: route.model,
                    })
                    .collect()
            ...
            cloud_providers: update
                .cloud_providers
                .map(|entries| {
                    use crate::neppy::config::schema::cloud_providers::{
        ...
        to_json(crate::neppy::inference::rpc::inference_update_model_settings(patch).await?)
    })
}
...
fn handle_inference_update_local_settings(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::neppy::inference::rpc::inference_update_local_settings(patch).await?)
    })
}
...
fn handle_inference_list_models(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::neppy::inference::rpc::inference_list_models(&request.provider_id).await?)
    })
}

fn handle_inference_device_profile(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(
        async move { to_json(crate::neppy::inference::rpc::inference_device_profile().await?) },
    )
}

fn handle_inference_provider_auth_errors(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        to_json(crate::neppy::inference::rpc::inference_provider_auth_errors().await?)
    })
}

fn handle_inference_presets(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move { to_json(crate::neppy::inference::rpc::inference_presets().await?) })
}
...
fn handle_inference_apply_preset(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::neppy::inference::rpc::inference_apply_preset(&request.tier).await?)
    })
}
...
fn handle_inference_openai_oauth_start(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(crate::neppy::inference::rpc::inference_openai_oauth_start(&config).await?)
    })
}
...
fn handle_inference_openai_oauth_complete(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::neppy::inference::rpc::inference_openai_oauth_complete(
                &config,
...
fn handle_inference_openai_oauth_import_codex_cli(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(
            crate::neppy::inference::rpc::inference_openai_oauth_import_codex_cli(&config).await?,
        )
    })
}
...
fn handle_inference_openai_oauth_status(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(crate::neppy::inference::rpc::inference_openai_oauth_status(&config).await?)
    })
}
...
fn handle_inference_openai_oauth_disconnect(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(crate::neppy::inference::rpc::inference_openai_oauth_disconnect(&config).await?)
    })
}
...
fn handle_inference_diagnostics(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(crate::neppy::inference::rpc::inference_diagnostics(&config).await?)
    })
}
...
fn handle_inference_summarize(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(
            crate::neppy::inference::rpc::inference_summarize(&config, &p.text, p.max_tokens)
                .await?,
        )
    })
}
...
fn handle_inference_prompt(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(
            crate::neppy::inference::rpc::inference_prompt(
                &config,
                &p.prompt,
                p.max_tokens,
                p.no_think,
...
fn handle_inference_vision_prompt(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(
            crate::neppy::inference::rpc::inference_vision_prompt(
                &config,
                &p.prompt,
                &p.image_refs,
                p.max_tokens,
...
fn handle_inference_test_provider_model(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(
            crate::neppy::inference::rpc::inference_test_provider_model(
                &config,
                &p.workload,
                &p.provider,
...
fn handle_inference_should_react(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(
            crate::neppy::inference::rpc::inference_should_react(
                &config,
                &p.message,
                &p.channel_type,
            )
...
fn handle_inference_analyze_sentiment(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        to_json(
            crate::neppy::inference::rpc::inference_analyze_sentiment(&config, &p.message).await?,
        )
    })
}
...
fn handle_inference_claude_code_status(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let status = tokio::task::spawn_blocking(
            crate::neppy::inference::provider::claude_code::version_check::probe,
        )
        .await
...
fn handle_inference_claude_code_auth_status(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        let auth = tokio::task::spawn_blocking(
            crate::neppy::inference::provider::claude_code::auth_status::probe,
        )
        .await
...
fn handle_inference_claude_code_settings(_params: Map<String, Value>) -> ControllerFuture {
    use crate::neppy::inference::provider::claude_code::settings;
    Box::pin(async move {
        let config = config_rpc::load_config_with_timeout().await?;
