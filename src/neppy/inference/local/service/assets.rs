...
use crate::neppy::inference::paths::{resolve_tts_voice_path, tts_model_target_path};
use crate::neppy::inference::presets::{self, VisionMode};
use crate::neppy::inference::types::{
...
impl LocalAiService {
    ...
    pub(in crate::neppy::inference::local::service) async fn ensure_tts_asset_available(
        &self,
        config: &Config,
    ) -> Result<(), String> {
