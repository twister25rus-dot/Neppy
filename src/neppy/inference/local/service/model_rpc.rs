...
use crate::neppy::inference::local::ollama::{ollama_base_url_from_config, redact_ollama_base_url};
...
fn throughput(raw: Option<&serde_json::Value>, count: &str, duration: &str) -> Option<f32> {
    ...
    crate::neppy::inference::local::ollama::ns_to_tps(count as f32, duration)
}
...
pub(super) async fn invoke(
    ...
    let model_id = crate::neppy::inference::model_ids::effective_chat_model_id(config);
