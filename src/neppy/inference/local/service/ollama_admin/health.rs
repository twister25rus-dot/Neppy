...
use crate::neppy::inference::local::install::find_system_ollama_binary;
use crate::neppy::inference::local::ollama::{ollama_base_url, ollama_base_url_from_config};
use crate::neppy::inference::paths::{find_workspace_ollama_binary, workspace_ollama_binary};
...
impl LocalAiService {
    ...
    pub(in crate::neppy::inference::local::service) async fn ollama_healthy_at(
        &self,
        base_url: &str,
    ) -> bool {
        tracing::debug!(
    ...
    pub(in crate::neppy::inference::local::service) async fn ollama_healthy(&self) -> bool {
    ...
    pub(in crate::neppy::inference::local::service) fn ollama_binary_present(
        &self,
        config: &Config,
    ) -> bool {
    ...
    pub(in crate::neppy::inference::local::service) async fn ollama_runner_ok_at(
        &self,
        base_url: &str,
    ) -> bool {
        let resp = self
    ...
    /// a desktop app.
    pub(in crate::neppy::inference::local::service) async fn kill_ollama_server(&self) {
    ...
    pub(in crate::neppy::inference::local::service) fn resolve_binary_path(
        &self,
        config: &Config,
    ) -> Option<String> {
        ...
        crate::neppy::inference::local::install::find_system_ollama_binary()
            .map(|p| p.display().to_string())
    }

    pub(in crate::neppy::inference::local::service) async fn has_model(
        &self,
        model: &str,
    ) -> Result<bool, String> {
    ...
    pub(in crate::neppy::inference::local::service) async fn has_model_for_config(
        &self,
        config: &Config,
        model: &str,
    ) -> Result<bool, String> {
    ...
    pub(in crate::neppy::inference::local::service) async fn has_model_at(
        &self,
        base_url: &str,
        model: &str,
    ) -> Result<bool, String> {
        use crate::neppy::inference::local::ollama::OllamaTagsResponse;
