...
use crate::neppy::inference::local::lm_studio::lm_studio_base_url;
use crate::neppy::inference::local::model_requirements::{
    evaluate_context, ContextEligibility, MIN_CONTEXT_TOKENS,
};
use crate::neppy::inference::local::ollama::{
...
impl LocalAiService {
    ...
    pub(in crate::neppy::inference::local::service) async fn list_models_at(
        &self,
        base: &str,
    ...
    pub(in crate::neppy::inference::local::service) async fn fetch_model_show_at(
        &self,
        base_url: &str,
        model: &str,
    ) -> OllamaModelShow {
