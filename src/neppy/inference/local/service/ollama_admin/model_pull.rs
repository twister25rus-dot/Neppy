...
impl LocalAiService {
    pub(in crate::neppy::inference::local::service) async fn ensure_models_available(
        &self,
        config: &Config,
    ) -> Result<(), String> {
    ...
    pub(in crate::neppy::inference::local::service) async fn ensure_ollama_model_available(
        &self,
        config: &Config,
        model_id: &str,
        label: &str,
