...
use crate::neppy::inference::local::ollama::ollama_base_url_from_config;
...
impl LocalAiService {
    pub(in crate::neppy::inference::local::service) async fn ensure_ollama_server(
        &self,
        config: &Config,
    ) -> Result<(), String> {
    ...
    pub(in crate::neppy::inference::local::service) async fn ensure_ollama_server_fresh(
        &self,
        config: &Config,
    ) -> Result<(), String> {
    ...
    pub(in crate::neppy::inference::local::service) async fn reclaim_orphan_if_ours(
        &self,
        config: &Config,
    ) {
    ...
    pub(in crate::neppy::inference::local::service) async fn start_and_wait_for_server(
        &self,
        config: &Config,
        ollama_cmd: &Path,
    ) -> Result<(), String> {
