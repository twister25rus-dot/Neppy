use crate::neppy::agent::multimodal;
...
use crate::neppy::inference::types::LocalAiEmbeddingResult;
...
impl LocalAiService {
    pub async fn vision_prompt(
        ...
        let _gate_permit = crate::neppy::cron::scheduler_gate::wait_for_capacity().await;
        ...
        let payload: crate::neppy::inference::local::ollama::OllamaGenerateResponse = response
            .json()
            .await
