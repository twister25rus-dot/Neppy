...
use crate::neppy::inference::local::lm_studio::{
    apply_lm_studio_auth, lm_studio_base_url, ollama_tags_fallback_url, LmStudioModelsResponse,
};
use crate::neppy::inference::local::ollama::{OllamaModelTag, OllamaTagsResponse};
...
impl LocalAiService {
    pub(in crate::neppy::inference::local::service) async fn ensure_lm_studio_available(
        &self,
        config: &Config,
    ) -> Result<(), String> {
    ...
    pub(in crate::neppy::inference::local::service) async fn list_lm_studio_models(
        &self,
        config: &Config,
    ...
    pub(in crate::neppy::inference::local::service) async fn has_lm_studio_model(
        &self,
        config: &Config,
        model: &str,
    ) -> Result<bool, String> {
