...
async fn chat_completions_handler(
    ...
    let (chat_model, model_id) =
        match crate::neppy::inference::provider::create_chat_model_from_string_with_model_id(
            "agentic",
            &provider_string,
            &config,
    ...
    let temperature = {
        ...
        let suppressed =
            crate::neppy::inference::temperature::temperature_for_model(&model_id, raw, &config);
