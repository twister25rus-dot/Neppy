//! Resolved model / voice IDs from [`crate::neppy::config::Config`].
//!
...
use crate::neppy::inference::vision_models::{self, VISION_MODEL_SUGGESTIONS};
...
/// [`crate::neppy::inference::presets`]: a preset whose model is missing
...
/// [`crate::neppy::inference::presets::vision_mode_for_config`], which
...
mod tests {
    ...
    fn preset_chat_models_are_allowlisted_and_resolve_unchanged() {
        let mut config = test_config();
        for preset in crate::neppy::inference::presets::all_presets() {
