...
use crate::neppy::inference::openai_oauth::store::{
    import_codex_cli_auth_from_path, OPENAI_OAUTH_PROFILE_NAME, OPENAI_PROVIDER_KEY,
};
use crate::neppy::inference::openai_oauth::{
    lookup_openai_bearer_token, lookup_openai_oauth_credentials,
};
use crate::neppy::inference::provider::factory::lookup_key_for_slug;
use crate::neppy::security::credentials::profiles::{
...
async fn inference_import_codex_cli_surfaces_error_when_auth_missing() {
    ...
    let err = crate::neppy::inference::ops::inference_openai_oauth_import_codex_cli(&config)
        .await
        .unwrap_err();
...
fn codex_routing_reaches_backend_for_oauth_only_openai_even_after_token_rotation() {
    ...
    use crate::neppy::inference::provider::factory::openai_bearer_is_oauth;
    use crate::neppy::inference::provider::openai_codex::resolve_openai_codex_routing;
...
fn credits_gate_bypassed_with_oauth_only_credentials() {
    ...
    use crate::neppy::inference::provider::factory::role_bypasses_managed_credits;
