...
//! pipeline ([`crate::neppy::inference::paths::resolve_piper_binary`]),
...
//! [`crate::neppy::inference::local::install_piper`] which downloads the
...
use crate::neppy::inference::paths::{resolve_piper_binary_with_config, resolve_tts_voice_path};
use crate::rpc::RpcOutcome;

use crate::neppy::voice::reply_speech::{ReplySpeechResult, VisemeFrame};
