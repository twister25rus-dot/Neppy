...
pub fn create_embedding_provider(
    ...
    match provider {
        ...
        "ollama" => {
            let base_url = crate::neppy::inference::local::ollama_base_url();
...
/// [`AuthService::from_config`](crate::neppy::security::credentials::AuthService::from_config)
...
/// [`state_dir_from_config`](crate::neppy::security::credentials::state_dir_from_config)
...
fn managed_credential_scope(config: &Config) -> (Option<PathBuf>, bool) {
    use crate::neppy::security::credentials::state_dir_from_config;
