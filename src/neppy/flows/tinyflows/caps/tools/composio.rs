...
use crate::neppy::config::ops as config_rpc;
use crate::neppy::config::Config;
use crate::neppy::integrations::composio::client::{
    create_composio_client, direct_execute, ComposioClientKind,
};
use crate::neppy::security::GateDecision;
...
impl ToolBackend for ComposioToolBackend {
    ...
    async fn invoke(
        ...
        // [`ToolScope`](crate::neppy::memory::sync::composio::providers::ToolScope)
        ...
        let summary = crate::neppy::security::approval::summarize_action(slug, &args);
        let redacted = crate::neppy::security::approval::redact_args(&args);
        let (outcome, audit_id) = if tier_decision == GateDecision::Allow {
            (crate::neppy::security::approval::GateOutcome::Allow, None)
        } else {
