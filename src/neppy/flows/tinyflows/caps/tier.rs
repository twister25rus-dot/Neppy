...
use crate::neppy::security::{CommandClass, GateDecision, SecurityPolicy, POLICY_BLOCKED_MARKER};
...
/// Dispatches to the process-global [`ApprovalGate`](crate::neppy::security::approval::ApprovalGate),
...
/// branches on the scoped [`AgentTurnOrigin`](crate::neppy::agent::turn_origin::AgentTurnOrigin) —
...
pub(crate) fn escalated_origin_for_prompt(
    tier_decision: GateDecision,
    origin: Option<crate::neppy::agent::turn_origin::AgentTurnOrigin>,
) -> Option<crate::neppy::agent::turn_origin::AgentTurnOrigin> {
...
/// [`ApprovalGate`](crate::neppy::security::approval::ApprovalGate)'s pre-declared-
