...
use crate::neppy::inference::provider::{is_raw_passthrough_model, role_for_model_tier};
...
///    harness [`AgentDefinition`](crate::neppy::agent::harness::definition::AgentDefinition),
///    the node builds a real session agent
///    ([`Agent::from_config_for_agent`](crate::neppy::agent::Agent::from_config_for_agent)
///    + `set_agent_definition_name`) and drives one full turn via
///
///    [`Agent::run_single`](crate::neppy::agent::Agent::run_single) — the
...
/// a fresh [`Agent`](crate::neppy::agent::Agent) per call and stamps any
...
/// [`Agent::run_single`](crate::neppy::agent::Agent::run_single) takes: the
...
/// value that routes a freshly-built harness [`Agent`](crate::neppy::agent::Agent)
    ...
    async fn run_agent(
        ...
        match route_for_agent_ref(agent_ref) {
            ...
            AgentRoute::RegistryFallback => {
                ...
                let custom_entry =
                    crate::neppy::agent::registry::find_custom_in_config(&self.config, agent_ref);
...
pub(crate) fn route_custom_entry_lookup(
    entry: Option<&crate::neppy::agent::registry::AgentRegistryEntry>,
) -> AgentRoute {
    match entry {
...
impl NeppyAgentRunner {
    ...
    async fn run_via_harness(
        ...
        // `src/neppy/security/approval/gate.rs` `Workflow { require_approval: false }`
    ...
    async fn run_via_registry_fallback(
        ...
        let entry = crate::neppy::agent::registry::get_agent(agent_ref)
            .await
