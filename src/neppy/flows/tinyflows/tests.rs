//! Seam tests for `src/neppy/flows/tinyflows/`.
//!
...
fn http_adapter(allowed_domains: Vec<String>) -> NeppyHttp {
    ...
    NeppyHttp {
        ...
        http_creds: Arc::new(
            crate::neppy::security::credentials::HttpCredentialsStore::from_config(&config),
        ),
    }
}
...
fn custom_registry_entry(enabled: bool) -> crate::neppy::agent::registry::AgentRegistryEntry {
    use crate::neppy::agent::registry::types::{AgentRegistrySource, AgentSubagentPolicy};
    crate::neppy::agent::registry::AgentRegistryEntry {
