...
//! [`crate::neppy::flows::ops::validate_and_migrate_graph`] path
...
use crate::neppy::flows::ops::{build_builder_proposal, validate_and_migrate_graph};
...
/// it end-to-end. Unlike [`crate::neppy::flows::builder_tools::DryRunWorkflowTool`]
...
impl Tool for RunFlowTool {
    fn name(&self) -> &str {
        ...
        // runner (`crate::neppy::agent::tools::run_workflow`,
    ...
    async fn execute(&self, args: Value) -> anyhow::Result<ToolResult> {
        ...
        match crate::neppy::flows::ops::flows_run_detached(
            &self.config,
            &flow_id,
            input,
            inputs,
            crate::neppy::flows::types::FlowRunTrigger::Rpc,
        )
        .await
        {
            Ok(outcome) => {
...
/// [`crate::neppy::flows::builder_tools::ReviseWorkflowTool`] reuses the
...
///
/// `pub(crate)` so [`crate::neppy::flows::builder_tools::SaveWorkflowTool`]
...
/// `crate::neppy::tools::traits::render_context_value`'s truncation
