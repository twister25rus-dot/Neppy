...
//! `src/neppy/cron/schemas.rs`'s shape exactly: `schemas(function)` builds
...
fn handle_build(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let req: crate::neppy::flows::agents::workflow_builder::builder_prompt::BuilderRequest =
...
fn handle_list_suggestions(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let status = params
            ...
            .map(str::trim)
            .filter(|s| !s.is_empty())
            .map(crate::neppy::flows::SuggestionStatus::from_str_lossy);
...
fn handle_draft_create(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let origin = params
            ...
            .unwrap_or(crate::neppy::flows::DraftOrigin::Canvas);
