...
//! [`crate::neppy::flows::tinyflows::caps::FlowStateStore`]); the RPC/CLI
...
//! `pub mod flows;` in `src/neppy/mod.rs` on `#[cfg(feature = "flows")]`,
...
mod schemas;
mod store;
/// The tinyflows engine seam (formerly `neppy::tinyflows`).
pub mod tinyflows;
pub mod tools;
mod types;
...
// (`src/neppy/flows/tinyflows/caps.rs`) lives in a sibling domain and needs
