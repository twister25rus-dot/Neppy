...
use crate::neppy::flows::ops;
use crate::neppy::flows::ops::validate_and_migrate_graph;
use crate::neppy::flows::tools;
            ...
            (None, Some(id), _) => match ops::flows_get(&self.config, id).await {
                Ok(outcome) => {
                    ...
                    match ops::flows_draft_create(
                        ...
                        flow.name.clone(),
                        graph_json,
                        crate::neppy::flows::DraftOrigin::Chat,
                    ) {
                        Ok(created) => {
...
/// Render one [`crate::neppy::flows::types::FlowConnection`] as the
...
fn flow_connection_to_json(c: &crate::neppy::flows::types::FlowConnection) -> Value {
    json!({
...
/// slug that fails the save-time [`crate::neppy::flows::ops::validate_tool_contracts`]
/// gate).
///
...
/// [`crate::neppy::flows::tinyflows::caps::fetch_live_toolkit_catalog`]) for
...
/// Shape one live-catalog [`ToolContract`](crate::neppy::flows::tinyflows::caps::ToolContract)
...
fn shape_catalog_row(
    tool: &crate::neppy::flows::tinyflows::caps::ToolContract,
    toolkit: &str,
...
pub(crate) async fn search_catalog(
    ...
    let fetched: Vec<(
        String,
        Option<Vec<crate::neppy::flows::tinyflows::caps::ToolContract>>,
    ...
    let fetched: Vec<(
        String,
        Vec<crate::neppy::flows::tinyflows::caps::ToolContract>,
    )> = fetched
        .into_iter()
...
/// `get_tool_contract`: fetch the FULL live [`ToolContract`](crate::neppy::flows::tinyflows::caps::ToolContract)
...
impl Tool for GetToolContractTool {
    ...
    async fn execute(&self, args: Value) -> anyhow::Result<ToolResult> {
        ...
        let Some(catalog) = crate::neppy::flows::tinyflows::caps::fetch_live_toolkit_catalog(
            &self.config,
            &toolkit,
        )
        .await
            ...
            Some(contract) => {
                ...
                if !contract.is_curated && ops::toolkit_has_curated_catalog(&toolkit) {
                    ...
                    struct ContractWithRuntimeGate {
                        ...
                        #[serde(flatten)]
                        contract: crate::neppy::flows::tinyflows::caps::ToolContract,
                    }
...
/// [`crate::neppy::flows::tinyflows::caps::apply_probe_override`]).
///
...
/// [`crate::neppy::flows::tinyflows::caps::probe_tool_output_sample`]'s scope
...
impl Tool for GetToolOutputSampleTool {
    ...
    async fn execute(&self, args: Value) -> anyhow::Result<ToolResult> {
        ...
        match crate::neppy::flows::tinyflows::caps::probe_tool_output_sample(
            &self.config,
            &slug,
            call_args,
        )
...
impl Tool for ListAgentProfilesTool {
    ...
    async fn execute(&self, _args: Value) -> anyhow::Result<ToolResult> {
        ...
        match crate::neppy::agent::registry::list_agents(false).await {
            Ok(agents) => {
...
impl Tool for ListNodeKindsTool {
    ...
    async fn execute(&self, _args: Value) -> anyhow::Result<ToolResult> {
        ...
        let kinds: Vec<Value> = crate::neppy::flows::all_node_kind_contracts()
            .iter()
            .map(|c| {
...
impl Tool for GetNodeKindContractTool {
            ...
            "properties": {
                "kind": {
                    ...
                    "description": format!(
                        ...
                        crate::neppy::flows::NODE_KINDS.len()
                    ),
                    "enum": crate::neppy::flows::NODE_KINDS,
                }
            },
            "required": ["kind"],
            "additionalProperties": false
    ...
    async fn execute(&self, args: Value) -> anyhow::Result<ToolResult> {
        ...
        match crate::neppy::flows::node_kind_contract(&kind) {
...
/// [`PreflightToolInvoker`](crate::neppy::flows::tinyflows::caps::PreflightToolInvoker),
...
fn build_null_resolution_entry(
    ...
    if let Some(upstream) = crate::neppy::flows::ops::mock_opaque_tool_call_upstream_ref(
        &diag.expression,
        graph,
        node_id,
    ) {
...
impl Tool for DryRunWorkflowTool {
    ...
    async fn execute(&self, args: Value) -> anyhow::Result<ToolResult> {
        ...
        let mut caps = tinyflows::caps::mock::mock_capabilities_with_agent(
            crate::neppy::flows::tinyflows::caps::SchemaAwareMockAgentRunner,
        );
        ...
        caps.llm = std::sync::Arc::new(crate::neppy::flows::tinyflows::caps::SchemaAwareMockLlm);
        ...
        caps.tools =
            std::sync::Arc::new(crate::neppy::flows::tinyflows::caps::PreflightToolInvoker {
        ...
        let permissions_manifest =
            crate::neppy::flows::ops::compute_approval_manifest(&self.config, &graph).await;
...
/// `pub(crate)` (not private) so [`crate::neppy::flows::ops::validate_required_arg_resolvability`]
