...
//!
//! Mirrors `src/neppy/cron/store.rs`'s idiom: a `with_connection` helper
...
//!   `tinyflows::caps::StateStore` (see `src/neppy/flows/tinyflows/caps.rs`).
//!
...
//! `checkpoints.db` (see `src/neppy/flows/tinyflows/mod.rs::open_flow_checkpointer`).
...
///
/// `enabled` is decided by the caller ([`crate::neppy::flows::ops::flows_create`],
...
/// `src/neppy/flows/tinyflows/caps.rs::FlowStateStore`.
...
/// [`crate::neppy::flows::ops::sweep_orphaned_running_runs_on_boot`]
...
/// [`crate::neppy::flows::ops::flows_resume`], guarded by a
