...
impl HasToolkit for crate::neppy::agent::prompts::ConnectedIntegration {
    fn toolkit_name(&self) -> &str {
        &self.toolkit
    }
}
...
mod tests {
    ...
    fn connected_integration(toolkit: &str) -> crate::neppy::agent::prompts::ConnectedIntegration {
        crate::neppy::agent::prompts::ConnectedIntegration {
