...
/// [`AgentDefinitionRegistry`](crate::neppy::agent::harness::AgentDefinitionRegistry)
...
pub async fn upsert(profile: AgentProfile) -> Result<Value, String> {
    ...
    match crate::neppy::agent::harness::AgentDefinitionRegistry::global() {
        Some(registry) => {
...
mod tests {
    use super::*;
    use crate::neppy::agent::profiles::DEFAULT_PROFILE_ID;
