...
//!
//! Three detectors feed [`crate::neppy::agent::learning::candidate::global()`]:
//!
...
//! intended to be called from [`crate::neppy::agent::learning::ReflectionHook`] or a
...
mod heuristics_tests {
    use super::*;
    use crate::neppy::agent::learning::candidate::{Buffer, FacetClass};
