...
use crate::neppy::integrations::composio::providers::profile_md::replace_managed_block;
...
mod tests {
    use super::*;
    use crate::neppy::integrations::composio::providers::profile_md::{block_end, block_start};
    use std::sync::Arc;
    use tempfile::TempDir;
    use tinymemory_api::provider::{FacetState, FacetType, ProfileFacet, UserState};

    fn make_cache() -> Arc<FacetCache> {
        Arc::new(crate::neppy::agent::learning::test_profile::in_memory_cache())
    }
