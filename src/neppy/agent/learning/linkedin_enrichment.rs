...
use crate::neppy::integrations::{build_client, IntegrationClient};
use crate::neppy::memory::api::provider::MemoryProvider;
use crate::neppy::memory::api::types::{MemoryTaint, NamespaceDocumentInput};
use regex::Regex;
use serde_json::json;
...
) -> anyhow::Result<std::sync::Arc<crate::neppy::memory::guard::MemoryGuard>> {
...
async fn put_profile_document(
    memory: &crate::neppy::memory::guard::MemoryGuard,
    title: String,
    content: String,
    source_type: &str,
    priority: &str,
