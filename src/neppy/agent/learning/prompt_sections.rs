...
use crate::neppy::agent::context::prompt::{PromptContext, PromptSection};
use anyhow::Result;
...
impl LearnedContextSection {
    pub fn new(_memory: std::sync::Arc<dyn crate::neppy::memory::Memory>) -> Self {
...
pub async fn load_learned_from_cache(
    cache: &crate::neppy::agent::learning::cache::FacetCache,
) -> Vec<String> {
...
mod tests {
    ...
    async fn load_learned_from_cache_formats_active_facets() {
        ...
        let cache = crate::neppy::agent::learning::test_profile::in_memory_cache();
