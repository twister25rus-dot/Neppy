...
impl SystemPromptBuilder {
    ...
    /// the `omit_*` flags from the [`crate::neppy::agent::harness::definition::AgentDefinition`]:
    ...
    pub fn from_dynamic(builder: crate::neppy::agent::harness::definition::PromptBuilder) -> Self {
        Self {
            sections: vec![
    ...
    /// [`crate::neppy::memory::tool_memory::ToolMemoryStore::rules_for_prompt`]
    ...
    pub fn with_tool_memory_rules(
        mut self,
        rules: Vec<crate::neppy::memory::tool_memory::ToolMemoryRule>,
    ) -> Self {
        if rules.is_empty() {
            return self;
        }
        ...
        let section: Box<dyn PromptSection> =
            Box::new(crate::neppy::memory::tool_memory::prompt::ToolMemoryRulesSection::new(rules));
        let tools_idx = self
            .sections
            .iter()
