...
///
/// Lives in the prompt layer (not `neppy::curated_memory`) so agent
...
pub struct PromptContext<'a> {
    ...
    /// injected by [`crate::neppy::agent::prompts::sections::AgentsInstructionsSection`].
...
/// [`crate::neppy::agent::harness::definition::AgentDefinition`]
