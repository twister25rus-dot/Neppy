...
/// [`crate::neppy::agent::harness::definition::AgentDefinition`]'s
...
/// Section that defers to a [`crate::neppy::agent::harness::definition::PromptBuilder`]
...
pub struct DynamicPromptSection {
    builder: crate::neppy::agent::harness::definition::PromptBuilder,
}

impl DynamicPromptSection {
    pub fn new(builder: crate::neppy::agent::harness::definition::PromptBuilder) -> Self {
        Self { builder }
    }
}
...
impl PromptSection for WorkspaceSection {
    ...
    fn build(&self, _ctx: &PromptContext<'_>) -> Result<String> {
        ...
        let scratch = crate::neppy::security::neppy_scratch_dir();
