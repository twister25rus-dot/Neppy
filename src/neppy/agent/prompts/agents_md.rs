...
//! [`crate::neppy::agent::context::prompt::PromptContext`] and rendered by
...
//! [`crate::neppy::agent::context::prompt::BOOTSTRAP_MAX_CHARS`] with a
//! `[... truncated]` marker.
...
pub fn load_agents_md(dir: &Path) -> Option<String> {
    ...
    if let Err(e) = crate::neppy::security::validate_path_within_root(&path, dir) {
        log::warn!(
