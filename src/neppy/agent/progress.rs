...
pub enum AgentProgress {
    ...
    ToolCallStarted {
        ...
        /// formatter. Set from [`crate::neppy::tools::traits::Tool::display_label`].
    ...
    ToolCallCompleted {
        ...
        /// on legacy snapshots. See `crate::neppy::tools::status`.
        failure: Option<crate::neppy::tools::status::ClassifiedFailure>,
    },
    ...
    /// from inside [`crate::neppy::agent::harness::subagent_runner`]**
    ...
    SubagentIterationStarted {
        ...
        max_iterations: u32,
        /// `true` when the agent uses [`IterationPolicy::Extended`](crate::neppy::agent::harness::definition::IterationPolicy::Extended).
    ...
    /// inside [`crate::neppy::agent::harness::subagent_runner`]** when
    ...
    /// [`crate::neppy::agent::cost::TurnCost::total_usd`].
    TurnCostUpdated {
