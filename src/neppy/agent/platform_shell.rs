...
//! [`crate::neppy::sandbox::ops`] can share one Windows-aware
...
//!   capture path in
//!   [`crate::neppy::sandbox::ops::execute_local_jail`]. PowerShell
...
/// to [`crate::neppy::sandbox::cwd_jail::spawn`], which is built around
...
///
/// Used by [`crate::neppy::sandbox::ops::execute_local_jail`] to
