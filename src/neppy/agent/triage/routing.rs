...
use crate::neppy::inference::provider::{self, INFERENCE_BACKEND_ID};

/// The concrete provider + metadata that [`crate::neppy::agent::triage::evaluator::run_triage`]
...
fn is_local_cli_route(provider_string: &str) -> bool {
    use crate::neppy::inference::provider::claude_code;
