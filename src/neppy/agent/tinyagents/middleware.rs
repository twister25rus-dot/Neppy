...
use crate::neppy::agent::context::CLEARED_PLACEHOLDER;
use crate::neppy::agent::harness::tool_result_artifacts::{
    apply_per_result_persistence, ToolResultArtifactStore, TINYAGENTS_TOOL_RESULT_ARTIFACT_STORE,
};
use crate::neppy::agent::tinyagents::payload_summarizer::{
...
pub(crate) type TranscriptSnapshotSink =
    Arc<std::sync::Mutex<Vec<crate::neppy::agent::messages::ChatMessage>>>;
...
impl Middleware<()> for TranscriptSnapshotMiddleware {
    ...
    async fn before_model(
        ...
        let history = crate::neppy::agent::message_convert::messages_to_history(&request.messages);
...
pub(crate) struct HandoffConfig {
    pub(crate) cache: Arc<crate::neppy::agent::harness::subagent_runner::ResultHandoffCache>,
...
pub(crate) struct HandoffMiddleware {
    cache: Arc<crate::neppy::agent::harness::subagent_runner::ResultHandoffCache>,
    agent_id: String,
    task_id: String,
}
...
impl Middleware<()> for HandoffMiddleware {
    ...
    async fn after_tool(
        ...
        result.content = crate::neppy::agent::harness::subagent_runner::apply_handoff(
            &self.cache,
            &result.name,
            &self.task_id,
            &self.agent_id,
...
impl Middleware<()> for ToolOutputMiddleware {
    ...
    async fn after_tool(
        ...
        if !compaction_exempt {
            ...
            let compacted = crate::neppy::inference::tokenjuice::compact_output_with_policy(
                std::mem::take(&mut result.content),
                &result.name,
                self.tokenjuice_compaction_enabled,
...
/// [`ToolScope::CliRpcOnly`](crate::neppy::tools::ToolScope) inside the
...
impl CliRpcOnlyMiddleware {
    ...
    fn is_cli_rpc_only(&self, name: &str) -> bool {
        self.tool_sets
            ...
            .flat_map(|set| set.iter())
            .find(|t| t.name() == name)
            .map(|t| t.scope() == crate::neppy::tools::ToolScope::CliRpcOnly)
            .unwrap_or(false)
    }
}
...
impl ToolMiddleware<()> for CredentialScrubMiddleware {
    ...
    async fn wrap_tool(
        ...
        let scrubbed_content =
            crate::neppy::agent::harness::credentials::scrub_credentials(&result.content);
        ...
        if let Some(err) = result.error.as_ref() {
            let scrubbed_err = crate::neppy::agent::harness::credentials::scrub_credentials(err);
            if &scrubbed_err != err {
                tracing::warn!(
                    tool = %tool_name,
...
fn scrub_json_credentials(value: serde_json::Value) -> serde_json::Value {
    ...
    match value {
        Value::String(s) => {
            Value::String(crate::neppy::agent::harness::credentials::scrub_credentials(&s))
        }
        Value::Array(items) => {
...
pub(super) struct ToolPolicyMiddleware {
    policy: Arc<dyn crate::neppy::agent::tool_policy::ToolPolicy>,
    ...
    session: crate::neppy::tools::agent_policy::ToolPolicySession,
...
impl ToolPolicyMiddleware {
    ...
    ) -> Option<crate::neppy::agent::tool_policy::GeneratedToolRuntimeContext> {
        self.tool_sets
            .iter()
            .flat_map(|set| set.iter())
            .find(|t| t.name() == name)
...
impl ToolMiddleware<()> for ToolPolicyMiddleware {
    ...
    async fn wrap_tool(
        ...
        use crate::neppy::agent::tool_policy::{
        ...
        if let Some(reason) = decision.blocking_reason() {
            ...
            crate::neppy::tools::registry::denials::record(
                call.name.as_str(),
                self.policy.name(),
                blocked_action,
                reason,
...
pub(crate) struct EmbedderToolHooksMiddleware {
    hooks: Vec<std::sync::Arc<dyn crate::neppy::agent::hooks::ToolHook>>,
...
impl Middleware<()> for EmbedderToolHooksMiddleware {
    ...
    async fn before_tool(
        ...
        let mut context = crate::neppy::agent::hooks::ToolHookContext {
            event: crate::neppy::agent::hooks::ToolHookEvent::PreToolUse,
        ...
        for hook in &self.hooks {
            match hook.before_tool_decision(&context).await {
                crate::neppy::agent::hooks::ToolHookDecision::Proceed => {}
                ...
                crate::neppy::agent::hooks::ToolHookDecision::ProceedWith(arguments) => {
                    tracing::debug!(
                        hook = hook.name(),
                ...
                crate::neppy::agent::hooks::ToolHookDecision::Deny(reason) => {
                ...
                crate::neppy::agent::hooks::ToolHookDecision::Ask(reason) => {
                    tracing::info!(
                        hook = hook.name(),
                        tool = context.tool_name,
    ...
    async fn after_tool(
        ...
        let context = crate::neppy::agent::hooks::ToolHookContext {
            event: crate::neppy::agent::hooks::ToolHookEvent::PostToolUse,
...
impl Middleware<()> for ToolOutcomeCaptureMiddleware {
    ...
    async fn after_tool(
        ...
        let failure = if success {
            ...
            Some(crate::neppy::tools::status::classify(&combined, timed_out))
        };
...
pub struct MemoryProtocolMiddleware {
    tracker: std::sync::Mutex<crate::neppy::agent::harness::memory_protocol::MemoryProtocolTracker>,
    ...
    pending_ops: std::sync::Mutex<
        std::collections::HashMap<String, crate::neppy::agent::harness::memory_protocol::MemoryOp>,
    >,
}
    ...
    pub fn new() -> Self {
        Self {
            tracker: std::sync::Mutex::new(
                crate::neppy::agent::harness::memory_protocol::MemoryProtocolTracker::new(),
            ),
...
impl Middleware<()> for MemoryProtocolMiddleware {
    ...
    async fn before_tool(
        ...
        let op = crate::neppy::agent::harness::memory_protocol::classify_memory_op(
            &call.name,
            &call.arguments,
        );
        if op != crate::neppy::agent::harness::memory_protocol::MemoryOp::Other {
...
/// [`CostTracker`](crate::neppy::platform::cost) and, when cost budgets are configured
...
impl Middleware<()> for CostBudgetMiddleware {
    ...
    async fn before_model(
        ...
        use crate::neppy::platform::cost::types::BudgetCheck;
        let Some(tracker) = crate::neppy::platform::cost::try_global() else {
            return Ok(());
        };
        ...
        if let Some(model) = request.model.as_deref() {
            let route = crate::neppy::platform::cost::route::route_for_model(model);
...
fn user_actionable_escalation(tool: &str, error: &str) -> Option<String> {
    ...
    Some(format!(
        ...
        crate::neppy::util::truncate_with_ellipsis(error, 400),
    ))
}
...
/// (`src/neppy/flows/builder_tools.rs`) rather than `ToolResult::error` — so
...
impl Middleware<()> for RepeatedToolFailureMiddleware {
    ...
    async fn after_tool(
        ...
        let policy_marked = |s: &str| {
            s.contains(crate::neppy::security::POLICY_BLOCKED_MARKER)
                || s.contains(crate::neppy::security::POLICY_DENIED_MARKER)
        };
        let hard_reject =
        ...
        let recoverable = result.error.is_some()
            ...
            && (is_recoverable_tool_failure(&failure_text)
                || matches!(
                    crate::neppy::tools::status::classify(&failure_text, false).class,
                    crate::neppy::tools::status::ToolFailureClass::Timeout
                        | crate::neppy::tools::status::ToolFailureClass::ServiceUnavailable
                        | crate::neppy::tools::status::ToolFailureClass::ModelConnection
                ));
        if recoverable {
...
mod tests {
    ...
    fn summarizer_mw(ps: Arc<dyn PayloadSummarizer>) -> ToolOutputMiddleware {
        ToolOutputMiddleware {
            ...
            tokenjuice_compression:
                crate::neppy::inference::tokenjuice::AgentTokenjuiceCompression::Off,
    ...
    async fn raw_security_policy_block_is_enriched_with_workaround_and_relay() {
        ...
        assert!(result
            .content
            .contains(crate::neppy::security::POLICY_BLOCKED_MARKER));
    ...
    async fn tool_output_tabulates_a_large_graph_for_a_non_exempt_tool() {
        ...
        crate::neppy::inference::tokenjuice::install_from_config(
    ...
    async fn repeated_tool_failure_nudges_change_of_strategy_before_the_halt() {
        use crate::neppy::agent::tinyagents::orchestration::{
    ...
    use crate::neppy::agent::harness::memory_protocol::MEMORY_PROTOCOL_MARKER;
    ...
    #[async_trait]
    impl crate::neppy::agent::hooks::ToolHook for RecordingToolHook {
        fn name(&self) -> &str {
            self.name
        }
        async fn before_tool(
            &self,
            context: &crate::neppy::agent::hooks::ToolHookContext,
        ) -> anyhow::Result<()> {
            self.pre
                .lock()
                .unwrap()
