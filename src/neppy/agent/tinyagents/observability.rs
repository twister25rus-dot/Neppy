...
use crate::neppy::agent::harness::turn_dispatch_guard::TurnDispatchState;
use crate::neppy::agent::progress::AgentProgress;
use crate::neppy::inference::provider::UsageInfo;
use crate::neppy::tools::traits::humanize_tool_name;
...
pub(crate) type ToolFailureMap = Arc<
    Mutex<
        std::collections::HashMap<
            ...
            (
                bool,
                Option<crate::neppy::tools::status::ClassifiedFailure>,
                u64,
                usize,
            ),
        >,
...
pub(crate) type ProviderUsageCarry =
    Arc<Mutex<std::collections::VecDeque<crate::neppy::inference::provider::UsageInfo>>>;
...
pub(crate) struct CapPauser {
    ...
    /// [`crate::neppy::agent::harness::turn_dispatch_guard`] and #5804.
...
pub(crate) struct NeppyEventBridge {
    ...
    /// [`Provider::telemetry_provider_id`](crate::neppy::inference::provider::Provider::telemetry_provider_id).
...
impl NeppyEventBridge {
    ...
    fn record_usage(&self, usage: &Usage) {
        ...
        let context_window = carried
            ...
            .filter(|w| *w > 0)
            .unwrap_or_else(|| {
                crate::neppy::platform::cost::catalog::lookup(&self.model)
        ...
        crate::neppy::platform::cost::record_provider_usage(&self.model, &usage_info);
    ...
    /// [`agent::cost`](crate::neppy::agent::cost) table (managed handles
    ...
    fn estimate_call_cost(model: &str, usage: &Usage) -> f64 {
        crate::neppy::agent::cost::estimate_call_cost_usd(
            model,
            &UsageInfo {
                input_tokens: usage.input_tokens,
                output_tokens: usage.output_tokens,
    ...
    fn on_event(&self, record: &EventRecord) {
        match &record.event {
            ...
            AgentEvent::UnknownToolCall {
                ...
                let iteration = self.iteration();
                let failure = Some(crate::neppy::tools::status::describe(
                    crate::neppy::tools::status::ToolFailureClass::Unknown,
                ));
