...
//! procedural memory in [`crate::neppy::agent_experience`], written today by
//! [`AgentExperienceCaptureHook`](crate::neppy::agent::experience::AgentExperienceCaptureHook)
...
//! confined to
//! [`AGENT_EXPERIENCE_NAMESPACE`](crate::neppy::agent::experience::AGENT_EXPERIENCE_NAMESPACE)
...
//!    [`redact_text`](crate::neppy::agent::experience::redact_text) over the
...
use crate::neppy::agent::experience::types::{
...
mod tests {
    use super::*;
    use crate::neppy::memory::tool_memory::test_helpers::MockMemory;
    ...
    fn writes_stay_inside_the_procedural_namespace() {
        ...
        assert_eq!(
            crate::neppy::agent::experience::AGENT_EXPERIENCE_NAMESPACE,
            "agent_experience"
        );
    }
