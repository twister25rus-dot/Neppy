...
//!
//! * [`crate::neppy::agent::harness::definition::AgentDefinitionRegistry`] —
//!   the harness registry of built-in ([`load_builtins`](crate::neppy::agent::registry::agents::load_builtins)-parsed
//!   `agent.toml`)
//!   and workspace-override agent definitions, plus the config-backed
//!   user-authored fallback
//!   ([`crate::neppy::agent::registry::find_custom_in_config`] →
//!   [`crate::neppy::agent::registry::definition_from_registry_entry`]).
//! * [`crate::neppy::agent::profiles::AgentProfile`] — the active personality,
...
//! [`validate_tier_hierarchy`](crate::neppy::agent::registry::agents::validate_tier_hierarchy) explicitly `continue`s past unknown ids). So
...
//! [`validate_tier_transition`](crate::neppy::agent::harness::definition::validate_tier_transition)
//! — the same single source of truth
//! [`validate_tier_hierarchy`](crate::neppy::agent::registry::agents::validate_tier_hierarchy) walks at boot — per declared pair. A `Worker`
//! parent yields an empty list; a tier-illegal child is dropped. Unknown child
//! ids are **kept**, matching both [`validate_tier_hierarchy`](crate::neppy::agent::registry::agents::validate_tier_hierarchy)'s `continue` and
...
use crate::neppy::agent::profiles::AgentProfile;
use crate::neppy::agent::registry::{definition_from_registry_entry, find_custom_in_config};
...
impl NeppyDefinitionRegistry {
    ...
    ///
    /// Reuses [`crate::neppy::agent::harness::definition::validate_tier_transition`]
    /// — the single source of truth [`validate_tier_hierarchy`](crate::neppy::agent::registry::agents::validate_tier_hierarchy) walks at boot —
    ...
    fn authorized_delegates(&self, def: &HostAgentDefinition) -> Vec<String> {
        ...
        for id in declared_subagent_ids(def) {
            ...
            match crate::neppy::agent::harness::definition::validate_tier_transition(
                def.agent_tier,
                child.agent_tier,
            ) {
                Ok(()) => out.push(id),
...
mod tests {
    use super::*;
    use crate::neppy::agent::registry::types::{
    ...
    async fn authorized_delegates_agree_with_boot_time_validation() {
        ...
        let builtin_defs = crate::neppy::agent::registry::agents::load_builtins()
            .expect("built-in TOML must parse");
        crate::neppy::agent::registry::agents::validate_tier_hierarchy(&builtin_defs)
    ...
    fn skills_wildcard_entries_are_not_agent_ids() {
        use crate::neppy::agent::harness::definition::SkillsWildcard;
    ...
    fn profile_allowing(tools: &[&str]) -> Arc<AgentProfile> {
        let mut profile = crate::neppy::agent::profiles::built_in_profiles()
            .into_iter()
            .next()
