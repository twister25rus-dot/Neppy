...
//!
//! Adapts `crate::neppy::agent::progress` (the `AgentProgress` UI contract)
...
//! [`crate::neppy::web_chat::progress_bridge::spawn_progress_bridge`]: the
        ...
        match ev {
            ...
            ProgressEvent::ToolCall { run, call, tool } => {
                ...
                self.forward_lifecycle(AgentProgress::ToolCallStarted {
                    ...
                    // (`crate::neppy::tools::traits::Tool::display_label`)
            ...
            ProgressEvent::ToolCallFinished {
                ...
                let failure = if success {
                    ...
                    Some(crate::neppy::tools::status::classify(&output, false))
                };
            ...
            ProgressEvent::Finished { run, usage } => {
                ...
                // `crate::neppy::agent::cost::TurnCost`, fed from the
