...
//! [`crate::neppy::cron::scheduler_gate`] or [`crate::neppy::cost`] directly.
...
use crate::neppy::cron::scheduler_gate;
use crate::neppy::inference::provider::types::UsageInfo;
use crate::neppy::inference::tokenjuice::AgentTokenjuiceCompression;
use crate::neppy::platform::cost::{self, BudgetCheck};
...
impl BudgetGate for NeppyBudgetGate {
    ...
    /// `src/neppy/cost/global.rs` infers provenance from
