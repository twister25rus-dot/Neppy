...
//! post-turn learning fan-out: [`crate::neppy::agent::hooks::PostTurnHook`]
...
//! dispatched by [`crate::neppy::agent::hooks::fire_hooks`]. That function
...
//! [`crate::neppy::agent::hooks::ToolCallRecord`] is the opposite: it exists
...
//!
//! - [`crate::neppy::agent::learning::transcript_ingest`] is *transcript-file*
...
use crate::neppy::agent::hooks::{self, PostTurnHook, TurnContext};
use crate::neppy::agent::learning::{ToolTrackerHook, UserProfileHook};
use crate::neppy::config::LearningConfig;
