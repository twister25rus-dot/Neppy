...
//! judgement in [`crate::neppy::tool_status`], whose
//! [`classify`](crate::neppy::tools::status::classify) turns raw tool error
//! text into a [`ClassifiedFailure`](crate::neppy::tools::status::ClassifiedFailure)
...
use crate::neppy::tools::status::{classify, ToolFailureClass};

/// Neppy's [`ToolOutcomeClassifier`], backed by
/// [`crate::neppy::tools::status::classify`].
///
...
// `src/neppy/tinyagents/middleware.rs`. Copying it into this adapter would
...
mod tests {
    use super::*;
    use crate::neppy::security::{POLICY_BLOCKED_MARKER, POLICY_DENIED_MARKER};
    ...
    fn recoverable_flag_is_deliberately_not_the_retry_signal() {
        ...
        let unknown = crate::neppy::tools::status::describe(ToolFailureClass::Unknown);
        assert!(
            unknown.recoverable,
