...
use crate::neppy::inference::embeddings::EmbeddingProvider;
use crate::neppy::memory::{Memory, MemoryEntry, RecallOpts};
...
mod tests {
    ...
    use crate::neppy::memory::{MemoryCategory, MemoryEntry, NamespaceSummary};
