...
pub(crate) fn tool_policy_from_neppy_tool(tool: &dyn crate::neppy::tools::Tool) -> ToolPolicy {
...
pub(crate) async fn execute_neppy_tool(
    tool: &dyn crate::neppy::tools::Tool,
    call: TaToolCall,
    ...
    let options = crate::neppy::tools::ToolCallOptions {
        prefer_markdown: true,
    };
    let (deadline, timeout_secs) =
        crate::neppy::tools::timeout::resolve_tool_deadline(tool.timeout_policy(&call.arguments));
...
pub(crate) struct SharedToolAdapter {
    sets: Vec<Arc<Vec<Box<dyn crate::neppy::tools::Tool>>>>,
    name: String,
    description: String,
    schema: ToolSchema,
    policy: ToolPolicy,
...
mod tests {
    use super::*;
    use crate::neppy::tools::traits::ToolTimeout;
    use crate::neppy::tools::ToolResult as OhToolResult;
    ...
    #[async_trait]
    impl crate::neppy::tools::Tool for HangingTool {
        fn name(&self) -> &str {
            "hang"
        }
        fn description(&self) -> &str {
    ...
    #[async_trait]
    impl crate::neppy::tools::Tool for EchoTool {
        fn name(&self) -> &str {
            "echo"
        }
        fn description(&self) -> &str {
