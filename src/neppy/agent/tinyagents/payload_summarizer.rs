...
//! [`crate::neppy::config::ContextConfig::tool_result_budget_bytes`],
...
//! ([`crate::neppy::agent::harness::session::builder::AgentBuilder`]
...
use crate::neppy::agent::harness::definition::{AgentDefinition, PromptSource};
use crate::neppy::agent::harness::fork_context::{current_parent, ParentExecutionContext};
...
pub struct SubagentPayloadSummarizer {
    ...
    /// [`crate::neppy::config::ContextConfig`] (default 4 000 tokens).
    ...
    /// [`crate::neppy::config::ContextConfig`] (2 000 000 tokens).
...
impl SubagentPayloadSummarizer {
    async fn invoke_tinyagents_summarizer_in_parent(
        ...
        let config_loaded = crate::neppy::config::Config::load_or_init().await;
        ...
        let max_output_tokens = self
            ...
            .unwrap_or(crate::neppy::inference::provider::AGENT_TURN_MAX_OUTPUT_TOKENS);
    ...
    fn build_tinyagents_system_prompt(
        ...
        let connected_identities_md = crate::neppy::agent::prompts::render_connected_identities();
        let prompt_ctx = crate::neppy::agent::context::prompt::PromptContext {
...
/// [`crate::neppy::memory::tree::tree_runtime::estimate_tokens`] but
