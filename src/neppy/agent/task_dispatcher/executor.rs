...
#[cfg(feature = "skills")]
use crate::neppy::agent::harness::definition::PromptSource;
use crate::neppy::agent::harness::session::Agent;
use crate::neppy::agent::harness::subagent_runner::with_autonomous_iter_cap;
use crate::neppy::agent::profiles::PersonalityContext;
use crate::neppy::agent::task_board::TaskCardStatus;
use crate::neppy::agent::task_session;
use crate::neppy::config::Config;
use crate::neppy::threads::todos::ops::{self, BoardLocation, CardPatch};
use crate::neppy::threads::todos::runs::{self, RunOutcome};
...
pub(super) fn resolve_executor(workspace_dir: &Path, assigned: Option<&str>) -> ResolvedExecutor {
    ...
    if let Ok(state) = crate::neppy::agent::profiles::load_profiles(workspace_dir) {
    ...
    #[cfg(feature = "skills")]
    if let Some(skill) = crate::neppy::skills::registry::get_workflow(workspace_dir, handle) {
...
pub(super) async fn run_autonomous(
    ...
    if let Some(thread_id) = session_thread_id.as_deref() {
        ...
        crate::neppy::web_chat::spawn_progress_bridge(
            ...
            thread_id.to_string(),
            run_id.to_string(),
            crate::neppy::threads::turn_state::TurnStateStore::new(workspace_dir.clone()),
