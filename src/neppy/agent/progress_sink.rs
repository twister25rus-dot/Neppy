...
//! [`Agent::set_on_progress`](crate::neppy::agent::Agent::set_on_progress)),
//! but RPC entry points such as
//! [`agent_chat`](crate::neppy::inference::local::ops::agent_chat) build the
//! [`Agent`](crate::neppy::agent::Agent) internally and drop it, so there is
...
//! [`turn_origin`](crate::neppy::agent::turn_origin): the embedder scopes a
...
tokio::task_local! {
    ...
    /// [`Agent`](crate::neppy::agent::Agent) internally.
...
/// the same reason [`turn_origin::with_origin`](crate::neppy::agent::turn_origin::with_origin)
