...
//! [`run_channel_turn_via_graph`](crate::neppy::agent::harness::run_channel_turn_via_graph)
...
//!
//! See [`crate::neppy::channels::runtime::dispatch`] for the primary
//! caller.
...
use crate::neppy::agent::tinyagents::{
    current_resolved_provider_route, with_resolved_provider_route_scope,
};
use crate::neppy::agent::turn_origin::{self, AgentTurnOrigin};
...
pub struct AgentTurnRequest {
    ...
    pub turn_model_source: crate::neppy::agent::tinyagents::TurnModelSource,
    ...
    pub multimodal_files: crate::neppy::config::MultimodalFileConfig,
    ...
    /// [`AGENT_TURN_ORIGIN`](crate::neppy::agent::turn_origin::AGENT_TURN_ORIGIN)
...
///
/// ```ignore
/// use crate::neppy::agent::bus::{mock_agent_run_turn, AgentTurnResponse};
