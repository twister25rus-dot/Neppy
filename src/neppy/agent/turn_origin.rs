...
//! `run_turn` invocation. Read by [`crate::neppy::security::approval::ApprovalGate`]
//! and [`crate::neppy::tools::agent_policy::ToolPolicyEngine`] to make
...
//!
//! Every entry point that drives the agent loop ([`crate::neppy::web_chat`],
//! [`crate::neppy::channels::runtime::dispatch`],
//! [`crate::neppy::cron`], CLI) MUST scope a real [`AgentTurnOrigin`]
...
/// entry point that owns the turn and read by [`crate::neppy::security::approval`]
/// alongside the existing per-turn chat context.
#[derive(Clone, Debug)]
pub enum AgentTurnOrigin {
    /// Live user chat in the desktop / web UI. The existing
    /// [`crate::neppy::security::approval::ApprovalChatContext`] task-local is
...
/// [`crate::neppy::security::approval::APPROVAL_CHAT_CONTEXT`] scope pattern.
///
...
/// [`fork_context::with_parent_context`](crate::neppy::agent::harness::fork_context)
/// and [`thread_context::with_thread_id`](crate::neppy::agent::tinyagents::thread_context)
