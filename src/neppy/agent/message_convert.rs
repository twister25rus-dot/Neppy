...
/// [`crate::neppy::agent::multimodal::prepare_messages_for_provider`]).
...
fn parse_native_assistant_envelope(text: &str) -> Option<(String, Vec<TaToolCall>)> {
    ...
    let oh_calls: Vec<crate::neppy::inference::provider::ToolCall> =
...
mod tests {
    ...
    fn seeded_native_tool_round_recovers_structure_and_round_trips() {
        use crate::neppy::inference::provider::ToolCall as OhToolCall;
