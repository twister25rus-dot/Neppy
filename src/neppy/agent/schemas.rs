...
/// [`crate::neppy::inference::local::schemas`], which backs the
...
fn handle_chat(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::neppy::inference::local::rpc::agent_chat(
                &mut config,
                &p.message,
                p.model_override,
                p.temperature,
...
fn handle_chat_simple(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::neppy::inference::local::rpc::agent_chat_simple(
                &config,
                &p.message,
                p.model_override,
                p.temperature,
...
fn handle_list_definitions(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async {
        let defs = crate::neppy::agent::library::list_definition_metadata().await?;
...
fn handle_get_definition(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let registry = crate::neppy::agent::harness::AgentDefinitionRegistry::global()
...
fn handle_reload_definitions(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async {
        ...
        let already_loaded =
            crate::neppy::agent::harness::AgentDefinitionRegistry::global().is_some();
        Ok(serde_json::json!({
            "status": "noop",
    ...
    Box::pin(async move {
        ...
        let envelope = match p.source.as_str() {
            "composio" => {
                ...
                crate::neppy::agent::triage::TriggerEnvelope::from_composio(
            ...
            "webhook" => {
                ...
                crate::neppy::agent::triage::TriggerEnvelope::from_webhook(
            ...
            "cron" => {
                ...
                let output = p
                    ...
                    .unwrap_or(job_name);
                crate::neppy::agent::triage::TriggerEnvelope::from_cron(job_id, job_name, output)
            }
            "external" => {
                ...
                crate::neppy::agent::triage::TriggerEnvelope::from_external(
        ...
        let outcome = crate::neppy::agent::triage::run_triage(&envelope)
            .await
            .map_err(|e| format!("triage evaluation failed: {e}"))?;

        let dry_run = p.dry_run.unwrap_or(false);
        match outcome {
            crate::neppy::agent::triage::TriageOutcome::Decision(run) => {
                if !dry_run {
                    ...
                    let origin = crate::neppy::agent::triage::local_trigger_origin();
                    crate::neppy::agent::turn_origin::with_origin(
                        origin,
                        crate::neppy::agent::triage::apply_decision(run.clone(), &envelope),
                    )
                    .await
            ...
            crate::neppy::agent::triage::TriageOutcome::Deferred {
                defer_until_ms,
                reason,
            } => {
...
fn handle_graph_topologies(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async {
        let reports = crate::neppy::agent::tinyagents::all_graph_topologies();
        let agents = crate::neppy::agent::registry::agents::load_builtins()
...
fn local_catalog_models_from_config(
...
) -> Vec<crate::neppy::platform::cost::catalog::LocalCatalogModel> {
    ...
    config
        ...
        .filter_map(|entry| {
            ...
            Some(crate::neppy::platform::cost::catalog::LocalCatalogModel {
...
fn handle_registry_snapshot(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async {
        ...
        let catalog = crate::neppy::platform::cost::catalog::unified_model_catalog(&local_models);
        ...
        let security = std::sync::Arc::new(crate::neppy::security::SecurityPolicy::default());
        let baseline_tools = crate::neppy::tools::default_tools(security);
        ...
        let agent_defs = crate::neppy::agent::registry::agents::load_builtins()
