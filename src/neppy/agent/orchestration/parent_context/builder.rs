...
pub(crate) async fn build_root_parent(
    ...
    if crate::neppy::agent::harness::AgentDefinitionRegistry::global().is_none() {
        if let Err(err) = crate::neppy::agent::harness::AgentDefinitionRegistry::init_global(
...
/// [`SubagentRunError::NoParentContext`](crate::neppy::agent::harness::subagent_runner::SubagentRunError::NoParentContext).
