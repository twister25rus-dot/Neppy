...
use crate::neppy::agent::harness::definition::{AgentDefinition, AgentDefinitionRegistry};
...
impl AgentOrchestrationSession {
    ...
    async fn spawn_agent_with_definition(
        ...
        let task = tokio::spawn(crate::neppy::agent::turn_origin::propagate(
    ...
    async fn finish_agent(
        ...
        result: Result<SubagentRunOutcome, crate::neppy::agent::harness::SubagentRunError>,
    ) {
