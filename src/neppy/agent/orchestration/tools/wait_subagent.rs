...
use crate::neppy::agent::orchestration::running_subagents::{
    self, SubagentStatus, WaitError, WaitOutcome,
};
use crate::neppy::tools::traits::{PermissionLevel, Tool, ToolResult, ToolTimeout};
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        .await
        {
            Ok(WaitOutcome::Terminal(SubagentStatus::Completed { output, iterations })) => {
                ...
                crate::neppy::agent::orchestration::background_completions::mark_collected(
                    &resolved_task_id,
                );
