...
use crate::neppy::agent::harness::fork_context::current_parent;
...
/// [`crate::neppy::tools::all_tools_with_runtime`]. The orchestrator
...
impl Tool for SpawnSubagentTool {
    ...
    async fn execute_with_context(
        ...
        if definition.id == "integrations_agent" {
            ...
            let allowlist: Vec<&crate::neppy::agent::context::prompt::ConnectedIntegration> =
        ...
        let has_delivery_thread =
            crate::neppy::agent::tinyagents::thread_context::current_thread_id().is_some();
        ...
        if !blocking && has_delivery_thread {
            ...
            if let Some(obj) = async_args.as_object_mut() {
                ...
                if obj.get("task_title").is_none() {
                    let title =
                        crate::neppy::agent::orchestration::subagent_sessions::task_title_from_prompt(
                            &prompt,
                        );
            ...
            Ok(outcome) => {
                match &outcome.status {
                    SubagentRunStatus::AwaitingUser {
                        ...
                        crate::neppy::agent::orchestration::subagent_events::publish_subagent_awaiting_user(
                            parent_session,
                    ...
                    SubagentRunStatus::Completed => {
                        ...
                        crate::neppy::agent::harness::artifact_offload::note_artifact_handoff(
                            crate::neppy::agent::harness::artifact_offload::HANDOFF_STAGE_CONSUMED,
                            &outcome.agent_id,
                            &outcome.task_id,
...
mod tests {
    use super::*;
    use crate::neppy::agent::harness::subagent_runner::SubagentMode;
