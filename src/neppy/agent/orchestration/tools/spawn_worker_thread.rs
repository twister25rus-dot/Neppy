...
use crate::neppy::agent::harness::subagent_runner::{run_subagent, SubagentRunOptions};
...
mod tests {
    ...
    use crate::neppy::agent::harness::ParentExecutionContext;
    ...
    struct MockMemory;
    #[async_trait]
    impl crate::neppy::memory::Memory for MockMemory {
        async fn store(
            &self,
            _: &str,
            _: &str,
            _: &str,
            _: crate::neppy::memory::MemoryCategory,
            _: Option<&str>,
        ) -> anyhow::Result<()> {
            Ok(())
        }
        async fn recall(
            ...
            _: &str,
            _: usize,
            _: crate::neppy::memory::RecallOpts<'_>,
        ...
        async fn list(
            &self,
            _: Option<&str>,
            _: Option<&crate::neppy::memory::MemoryCategory>,
            _: Option<&str>,
        ) -> anyhow::Result<Vec<crate::neppy::memory::MemoryEntry>> {
            Ok(vec![])
        }
    ...
    fn test_parent_ctx(workspace_dir: PathBuf) -> ParentExecutionContext {
        ...
        ParentExecutionContext {
            ...
            temperature: 0.4,
            workspace_dir,
            turn_model_source: crate::neppy::agent::tinyagents::TurnModelSource::from_model(model),
            ...
            tool_call_format: crate::neppy::agent::context::prompt::ToolCallFormat::Native,
        }
    }
