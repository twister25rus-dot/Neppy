...
use crate::neppy::agent::experience::ops::{
...
fn handle_capture(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::neppy::agent::experience::ops::capture(params).await?)
    })
}
...
fn handle_retrieve(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::neppy::agent::experience::ops::retrieve(params).await?)
    })
}
...
fn handle_list(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::neppy::agent::experience::ops::list(params).await?)
    })
}
...
fn handle_dismiss(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::neppy::agent::experience::ops::dismiss(params).await?)
    })
}
