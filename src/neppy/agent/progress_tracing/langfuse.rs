...
use crate::neppy::security::credentials::session_support::require_live_session_token;
...
mod tests {
    ...
    use crate::neppy::agent::progress_tracing::SpanKind;
    ...
    fn trace_config_from_context_matches_span_trace_attribution() {
        let ctx = TraceContext::new("trace:req-1", Some("user-1".to_string()))
            ...
            .with_run_type(crate::neppy::agent::progress_tracing::RunType::InteractiveChat);
