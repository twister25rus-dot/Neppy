...
//! - **[`crate::neppy::agent::registry::agents`]**: Definitions for built-in
...
/// and [`crate::neppy::sandbox::ops`] so all three shell-spawning sites
...
/// `neppy::agent::context::prompt` so prompt rendering lives next to the
/// agents that consume it. `neppy::agent::context::prompt` is retained as
