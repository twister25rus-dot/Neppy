...
//! [`Config::action_dir`](crate::neppy::config::Config). Everything the
//! core already had for this was **process-global**: `action_dir` comes from
//! config, and [`SecurityPolicy`](crate::neppy::security::SecurityPolicy)
...
//!
//! * the session builder
//!   ([`Agent::from_config`](crate::neppy::agent::Agent::from_config)),
...
//! * [`SecurityPolicy::is_within_trusted_root`](crate::neppy::security::SecurityPolicy::is_within_trusted_root),
...
//! [`TrustedRoot`](crate::neppy::security::TrustedRoot) with
...
//! ([`SecurityPolicy::is_always_forbidden`](crate::neppy::security::SecurityPolicy::is_always_forbidden))
