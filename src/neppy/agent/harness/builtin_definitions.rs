...
//! [`crate::neppy::agent::registry::agents`] — each agent is a subfolder
...
/// [`crate::neppy::agent::registry::agents`] verify in CI that every entry in
/// [`crate::neppy::agent::registry::agents::BUILTINS`] still parses cleanly.
///
...
pub fn all() -> Vec<AgentDefinition> {
    #[allow(unused_mut)]
    let mut defs = crate::neppy::agent::registry::agents::load_builtins()
...
mod tests {
    ...
    fn all_definitions_present() {
        ...
        let enabled_builtins = crate::neppy::agent::registry::agents::BUILTINS
            .iter()
            .filter(|_b| {
