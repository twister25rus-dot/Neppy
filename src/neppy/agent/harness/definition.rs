...
//! [`crate::neppy::agent::registry::agents`] — one subfolder per agent, each
...
pub struct AgentDefinition {
    ...
    /// [`crate::neppy::agent::context::prompt::render_subagent_system_prompt`].
    #[serde(default = "defaults::true_")]
    ...
    ///
    /// [`ArchetypeDelegationTool`]: crate::neppy::agent::orchestration::tools::ArchetypeDelegationTool
    /// [`SkillDelegationTool`]: crate::neppy::agent::orchestration::tools::SkillDelegationTool
...
/// pairs at boot (see
/// [`crate::neppy::agent::registry::agents::validate_tier_hierarchy`]). The
...
/// full runtime [`crate::neppy::agent::context::prompt::PromptContext`]
...
/// [`crate::neppy::agent::context::prompt`] in the order the builder
/// wants.
pub type PromptBuilder =
    fn(&crate::neppy::agent::context::prompt::PromptContext<'_>) -> anyhow::Result<String>;
...
pub enum PromptSource {
    ...
    /// `src/neppy/agent/prompts/` for built-ins. Resolved by the runner
    /// at spawn time.
    File { path: String },
...
pub enum DefinitionSource {
    ...
    /// [`crate::neppy::agent::registry::agents`]).
    #[default]
    Builtin,
...
impl AgentDefinitionRegistry {
    ...
    pub fn load(workspace: &Path) -> Result<Self> {
        ...
        // [`crate::neppy::agent::registry::agents::loader::validate_tier_hierarchy`].
        let snapshot: Vec<AgentDefinition> = reg.list().into_iter().cloned().collect();
        crate::neppy::agent::registry::agents::validate_tier_hierarchy(&snapshot).map_err(|e| {
            anyhow::anyhow!(
    ...
    pub async fn load_for_default_workspace() -> Result<Self> {
        let config = crate::neppy::config::Config::load_or_init().await?;
