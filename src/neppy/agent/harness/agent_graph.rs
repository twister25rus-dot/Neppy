...
use crate::neppy::agent::harness::subagent_runner::SubagentRunError;
...
pub struct AgentTurnRequest {
    ...
    pub(crate) handoff_cache:
        Option<Arc<crate::neppy::agent::harness::subagent_runner::ResultHandoffCache>>,
    ...
    pub tokenjuice_compression: crate::neppy::inference::tokenjuice::AgentTokenjuiceCompression,
    ...
    pub config: Option<Arc<crate::neppy::config::Config>>,
}
