...
use crate::neppy::agent::harness::session::types::{Agent, AgentBuilder};
use crate::neppy::agent::harness::TriggerMemoryAgent;
use crate::neppy::config::ContextConfig;
...
impl AgentBuilder {
    ...
    pub fn new() -> Self {
        Self {
            ...
            tokenjuice_compression:
                crate::neppy::inference::tokenjuice::AgentTokenjuiceCompression::Full,
            tool_policy: None,
            archivist_hook: None,
        }
    }
    ...
    pub fn chat_model(mut self, model: Arc<dyn tinyagents::harness::model::ChatModel<()>>) -> Self {
        self.turn_model_source =
            Some(crate::neppy::agent::tinyagents::TurnModelSource::from_model(model));
        self
    }
    ...
    pub fn crate_native_provider(
        ...
        self.turn_model_source =
            Some(crate::neppy::agent::tinyagents::TurnModelSource::new_crate_native(role, config));
        self
    }
    ...
    pub fn prompt_builder(
        mut self,
        prompt_builder: crate::neppy::agent::context::prompt::SystemPromptBuilder,
    ) -> Self {
    ...
    pub fn tool_dispatcher(
        mut self,
        tool_dispatcher: Box<dyn crate::neppy::agent::dispatcher::ToolDispatcher>,
    ) -> Self {
    ...
    pub fn config(mut self, config: crate::neppy::config::AgentConfig) -> Self {
    ...
    /// [`TurnContext`](crate::neppy::agent::hooks::TurnContext) so
    ...
    pub fn workflows(mut self, skills: Vec<crate::neppy::skills::Workflow>) -> Self {
    ...
    pub fn post_turn_hooks(
        mut self,
        hooks: Vec<Arc<dyn crate::neppy::agent::hooks::PostTurnHook>>,
    ) -> Self {
    ...
    /// [`crate::neppy::agent::tinyagents::payload_summarizer::PayloadSummarizer::maybe_summarize_in_parent`]
    ...
    pub fn payload_summarizer(
        mut self,
        summarizer: Arc<dyn crate::neppy::agent::tinyagents::payload_summarizer::PayloadSummarizer>,
    ) -> Self {
    ...
    pub fn archivist_hook(
        mut self,
        hook: Option<Arc<crate::neppy::agent::harness::archivist::ArchivistHook>>,
    ) -> Self {
    ...
    pub fn tokenjuice_compression(
        mut self,
        profile: crate::neppy::inference::tokenjuice::AgentTokenjuiceCompression,
    ) -> Self {
    ...
    pub fn build(self) -> Result<Agent> {
        ...
        let prompt_builder = self.prompt_builder.unwrap_or_else(
            crate::neppy::agent::context::prompt::SystemPromptBuilder::with_defaults,
        );

        let model_name = self
            .model_name
            .unwrap_or_else(|| crate::neppy::config::DEFAULT_MODEL.into());
        ...
        Ok(Agent {
            ...
            tool_policy: self
                .tool_policy
                .unwrap_or_else(|| Arc::new(crate::neppy::agent::tool_policy::AllowAllToolPolicy)),
