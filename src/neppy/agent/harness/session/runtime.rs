...
use crate::neppy::agent::dispatcher::ParsedToolCall;
use crate::neppy::agent::error::AgentError;
use crate::neppy::agent::messages::ConversationMessage;
use crate::neppy::inference::provider::{self, ToolCall};
...
use crate::neppy::tools::{Tool, ToolSpec};
...
impl Agent {
    ...
    pub fn turn_model_source(&self) -> crate::neppy::agent::tinyagents::TurnModelSource {
    ...
    /// The full host [`Config`](crate::neppy::config::Config) this session
    ...
    pub fn runtime_config(&self) -> Option<Arc<crate::neppy::config::Config>> {
    ...
    pub fn host_agent_memory(&self) -> crate::neppy::agent::tinyagents::host::NeppyAgentMemory {
        crate::neppy::agent::tinyagents::host::NeppyAgentMemory::new(self.memory_arc())
    }
    ...
    pub fn host_experience_store(
        &self,
    ) -> crate::neppy::agent::tinyagents::host::NeppyExperienceStore {
        crate::neppy::agent::tinyagents::host::NeppyExperienceStore::with_profile(
            self.memory_arc(),
    ...
    pub fn workflows(&self) -> &[crate::neppy::skills::Workflow] {
        &self.workflows
    }
    ...
    pub fn set_connected_integrations(
        &mut self,
        integrations: Vec<crate::neppy::agent::context::prompt::ConnectedIntegration>,
    ) {
        self.connected_integrations = integrations;
        self.connected_integrations_initialized = true;
        self.last_seen_integrations_hash =
            crate::neppy::integrations::composio::connected_set_hash(&self.connected_integrations);
    }

    /// The agent's runtime config snapshot.
    pub fn agent_config(&self) -> &crate::neppy::config::AgentConfig {
        &self.config
    }
    ...
    pub fn set_on_progress(
        &mut self,
        tx: Option<tokio::sync::mpsc::Sender<crate::neppy::agent::progress::AgentProgress>>,
    ) {
        self.on_progress = tx;
    }
    ...
    /// [`AgentBuilder::workspace_descriptor`](crate::neppy::agent::AgentBuilder::workspace_descriptor),
    /// for callers that construct the agent through
    /// [`Agent::from_config`](crate::neppy::agent::Agent::from_config) and
    /// therefore never see the builder — notably the per-turn `cwd` of
    /// [`agent_chat`](crate::neppy::inference::local::ops::agent_chat).
    ///
    ...
    /// still decided by its [`SecurityPolicy`](crate::neppy::security::SecurityPolicy),
    ...
    pub fn set_run_queue(
        &mut self,
        rq: Option<std::sync::Arc<crate::neppy::agent::harness::run_queue::RunQueue>>,
    ) {
        self.run_queue = rq;
    }
    ...
    pub fn seed_resume_from_messages(
        ...
        let learned = crate::neppy::agent::prompts::LearnedContextData::default();
        let system_prompt = self.build_system_prompt(learned)?;

        let mut cached: Vec<crate::neppy::agent::messages::ChatMessage> =
            Vec::with_capacity(prior.len() + 1);
        cached.push(crate::neppy::agent::messages::ChatMessage::system(
            system_prompt,
        ));
        for (role, content) in prior {
            let chat = match role.as_str() {
                "user" => crate::neppy::agent::messages::ChatMessage::user(content),
                "agent" | "assistant" => {
                    crate::neppy::agent::messages::ChatMessage::assistant(content)
                }
                ...
                _ => crate::neppy::agent::messages::ChatMessage::user(content),
            };
            cached.push(chat);
        }
    ...
    pub async fn take_last_turn_citations(
        &mut self,
    ) -> Vec<crate::neppy::memory::agent::memory_loader::MemoryCitation> {
    ...
    /// totals after [`Agent::turn`](crate::neppy::agent::Agent) returns,
    /// while leaving the value in place for the web-channel drain path.
    pub fn last_turn_usage(
        &self,
    ) -> Option<&crate::neppy::agent::harness::turn_subagent_usage::LastTurnUsage> {
    ...
    pub(super) fn persisted_tool_calls_for_history(
        response: &crate::neppy::inference::provider::ChatResponse,
    ...
    pub async fn run_interactive(&mut self) -> Result<()> {
        ...
        let cli = crate::neppy::channels::CliChannel::new();

        let listen_handle = tokio::spawn(async move {
            let _ = crate::neppy::channels::Channel::listen(&cli, tx).await;
        });
