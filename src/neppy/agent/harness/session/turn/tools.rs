...
impl Agent {
                ...
                .map(|definition| {
                    definition
                        ...
                        .filter_map(|entry| match entry {
                            crate::neppy::agent::harness::definition::SubagentEntry::AgentId(
                                id,
                            ) => Some(id.clone()),
                            crate::neppy::agent::harness::definition::SubagentEntry::Skills(
                                wildcard,
                            ) if wildcard.matches_all() => Some("integrations_agent".to_string()),
                            crate::neppy::agent::harness::definition::SubagentEntry::Skills(_) => {
                                None
                            }
                        })
                        .collect()
    ...
    ///
    /// Delegates to the shared [`crate::neppy::integrations::composio::fetch_connected_integrations`]
    ...
    /// [`crate::neppy::integrations::composio::client::create_composio_client`]
    ...
    pub async fn fetch_connected_integrations(&mut self) {
        let config = match self.runtime_config.clone() {
            Some(config) => config,
            None => match crate::neppy::config::Config::load_or_init().await {
    ...
    pub(super) fn refresh_delegation_tools_from_cached_integrations(
        ...
        let Some(cache_view) =
            crate::neppy::integrations::composio::cached_active_integrations(cfg)
        else {
            return false;
        };

        let new_hash = crate::neppy::integrations::composio::connected_set_hash(&cache_view);
    ...
    pub(in super::super) fn refresh_workflows(&mut self, trigger: &str) -> bool {
        let id_of = |w: &crate::neppy::skills::Workflow| -> String {
        ...
        let profile_skills_root = self.active_profile_id.as_deref().and_then(|id| {
            crate::neppy::agent::profiles::profile_skills_root(&self.workspace_dir, id)
        });
        ...
        let latest = crate::neppy::skills::load_workflow_metadata_for_profile(
            &self.workspace_dir,
    ...
    pub fn refresh_delegation_tools(&mut self) -> bool {
        ...
        use crate::neppy::tools::orchestrator_tools::collect_orchestrator_tools;
        ...
        let synthed_specs: Vec<crate::neppy::tools::ToolSpec> =
