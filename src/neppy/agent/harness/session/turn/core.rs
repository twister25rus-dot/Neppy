...
use crate::neppy::agent::experience::{
    prepend_experience_block, render_experience_hits, retrieve_across_stores, AgentExperienceStore,
    ExperienceQuery,
};
use crate::neppy::agent::harness;
use crate::neppy::agent::harness::definition::TriggerMemoryAgent;
use crate::neppy::agent::harness::fork_context::ParentExecutionContext;
use crate::neppy::agent::hooks::{self, TurnContext};
use crate::neppy::agent::messages::{ChatMessage, ConversationMessage};
use crate::neppy::agent::progress::AgentProgress;
use crate::neppy::memory::agent::memory_loader::collect_recall_citations;
use crate::neppy::memory::MemoryCategory;
use crate::neppy::util::truncate_with_ellipsis;
...
fn tool_records_from_conversation(
    ...
    tool_outcomes: &[crate::neppy::agent::tinyagents::ToolCallOutcome],
...
fn stamp_tool_failures(
    ...
    use crate::neppy::agent::harness::session::transcript;
...
impl Agent {
    ...
    pub async fn turn(&mut self, user_message: &str) -> Result<String> {
        ...
        if self.history.is_empty() {
            ...
            self.last_seen_integrations_hash =
                crate::neppy::integrations::composio::connected_set_hash(
            ...
            self.announced_mcp_servers =
                crate::neppy::mcp::registry::connections::connected_overview()
                    .await
                    .into_iter()
            ...
            // [`crate::neppy::integrations::composio::INTEGRATIONS_CACHE`], kept
            ...
            // [`crate::neppy::integrations::composio::cached_active_integrations`]
        ...
        if self.auto_save {
            ...
            let session_id_for_autosave =
                crate::neppy::agent::tinyagents::thread_context::current_thread_id();
            log::debug!(
            ...
            tokio::spawn(async move {
                match memory
                    .store(
                        crate::neppy::agent::learning::transcript_ingest::CONVERSATION_RAW_NAMESPACE,
                        &autosave_key,
                        &user_msg,
        ...
        {
            let situational = crate::neppy::memory::preferences::recall_situational_preferences_on(
                &self.memory,
                user_message,
            )
            .await;
        ...
        let active_goal = {
            let loaded =
                crate::neppy::threads::goals::runtime::load_for_current_thread(&self.workspace_dir)
                    .await;
            ...
            match loaded {
                Some(goal)
                    if matches!(
                        goal.status,
                        crate::neppy::threads::goals::ThreadGoalStatus::Paused
                    ) =>
                {
                    crate::neppy::threads::goals::runtime::resume_for_current_thread(
                        &self.workspace_dir,
                    )
                    .await
                    .unwrap_or(Some(goal))
        ...
        if let Some(block) =
            crate::neppy::agent::orchestration::running_subagents::active_subagents_context_block(
        ...
        let enriched = format!(
            "{}\n\n{enriched}",
            crate::neppy::agent::prompts::current_datetime_line()
        );
        ...
        let turn_body = async {
            ...
            let artifact_store = Some(
                crate::neppy::agent::harness::tool_result_artifacts::ToolResultArtifactStore::new(
        ...
        let mut turn_stop_hooks = crate::neppy::agent::stop_hooks::current_stop_hooks();
        if let Some(ref goal) = active_goal {
            if let Some(hook) = crate::neppy::threads::goals::runtime::GoalBudgetStopHook::for_goal(
                &goal_workspace_dir,
                goal,
            ) {
        ...
        let image_placeholders =
            crate::neppy::agent::multimodal::extract_image_placeholders_in_text(user_message);
        let result = if turn_stop_hooks.is_empty() {
            ...
            harness::with_parent_context(
                ...
                harness::with_agent_context_prepared_sources(
                    ...
                    harness::turn_attachments_context::with_current_turn_image_placeholders(
                        image_placeholders,
                        crate::neppy::agent::stop_hooks::with_stop_hooks(
                            turn_stop_hooks,
                            turn_body,
                        ),
                    ),
    ...
    async fn run_turn_via_tinyagents_session(
        ...
        artifact_store: Option<
            crate::neppy::agent::harness::tool_result_artifacts::ToolResultArtifactStore,
        >,
    ) -> Result<String> {
        ...
        if (turn_models.supports_vision() || self.model_vision)
            && crate::neppy::agent::multimodal::has_image_placeholders(&messages)
        {
            messages = crate::neppy::agent::multimodal::rehydrate_image_placeholders(&messages);
        }
        let messages = crate::neppy::agent::multimodal::prepare_messages_for_provider(
            &messages,
            &multimodal,
            &multimodal_files,
        )
        ...
        // was deleted in C3.
        let context_mw = crate::neppy::agent::tinyagents::TurnContextMiddleware {
        ...
        let turn_future = Box::pin(
            crate::neppy::agent::harness::turn_subagent_usage::with_turn_collector(
                super::graph::run_chat_turn_graph(super::graph::ChatTurnGraph {
                    ...
                    tool_policy: Some(crate::neppy::agent::tinyagents::ToolPolicyEnforcement {
                    ...
                    sandbox_mode:
                        crate::neppy::agent::harness::definition::AgentDefinitionRegistry::global()
                            ...
                            .unwrap_or(crate::neppy::agent::harness::definition::SandboxMode::None),
                }),
            ),
        );
        let (outcome, subagent_usage_entries) =
            crate::neppy::agent::harness::turn_dispatch_guard::with_dispatch_guard(
                crate::neppy::agent::tinyagents::agent_turn_wall_clock_ms()
        ...
        let reply = if outcome.hit_cap {
            ...
            return Err(anyhow::Error::new(
                crate::neppy::agent::error::AgentError::EmptyProviderResponse {
        ...
        let reply = if let Some(contract) = self
            ...
            .required_output
            .as_ref()
            .map(crate::neppy::agent::tinyagents::config::required_output_from)
        {
            match self
        ...
        self.last_turn_usage_totals = Some(
            crate::neppy::agent::harness::turn_subagent_usage::LastTurnUsage {
                input_tokens,
                output_tokens,
                cached_input_tokens,
        ...
        let turn_usage = crate::neppy::agent::harness::session::transcript::TurnUsage {
            ...
            model: effective_model.to_string(),
            usage: crate::neppy::agent::harness::session::transcript::MessageUsage {
                input: input_tokens,
        ...
        crate::neppy::threads::goals::runtime::account_turn_against_goal(
            &self.workspace_dir,
            input_tokens,
            output_tokens,
