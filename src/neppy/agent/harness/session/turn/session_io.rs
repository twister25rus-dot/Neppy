...
use crate::neppy::agent::context::ARCHIVIST_EXTRACTION_PROMPT;
use crate::neppy::agent::harness;
use crate::neppy::agent::messages::ChatMessage;
use crate::neppy::agent::progress::AgentProgress;
use crate::neppy::inference::provider::{ChatResponse, UsageInfo, AGENT_TURN_MAX_OUTPUT_TOKENS};
...
impl Agent {
    ...
    pub(super) async fn summarize_turn_wrapup(
        ...
        let request = ModelRequest::new(
            messages
                .iter()
                .map(crate::neppy::agent::tinyagents::chat_message_to_message)
                .collect(),
        )
        ...
        let usage = crate::neppy::agent::tinyagents::model::usage_info_from_response(&response);
    ...
    pub(in super::super) fn persist_session_transcript(
        ...
        let request_id = crate::neppy::agent::turn_origin::current_request_id();
    ...
    /// ([`crate::neppy::agent::session_import`]) so live and imported records are
    ...
    fn maybe_dual_write_session_store(
        ...
        use crate::neppy::agent::session_import::live;
    ...
    /// heuristic [`crate::neppy::agent::learning::transcript_ingest`]
    ...
    pub(in super::super) fn spawn_transcript_ingestion(&self) {
        ...
        tokio::spawn(async move {
            match crate::neppy::agent::learning::transcript_ingest::ingest_transcript_path(
                memory.as_ref(),
                &path,
            )
            .await
