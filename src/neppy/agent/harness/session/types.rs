...
use crate::neppy::agent::context::ContextManager;
use crate::neppy::agent::dispatcher::ToolDispatcher;
use crate::neppy::agent::harness::archivist::ArchivistHook;
use crate::neppy::agent::harness::definition::TriggerMemoryAgent;
use crate::neppy::agent::hooks::PostTurnHook;
...
use crate::neppy::agent::tool_policy::ToolPolicy;
...
pub struct Agent {
    ...
    pub(super) config: crate::neppy::config::AgentConfig,
    ...
    pub(super) workflows: Vec<crate::neppy::skills::Workflow>,
    ...
    pub(super) last_turn_citations: Vec<crate::neppy::memory::agent::memory_loader::MemoryCitation>,
    ...
    pub(super) pending_citations: Option<
        tokio::task::JoinHandle<Vec<crate::neppy::memory::agent::memory_loader::MemoryCitation>>,
    >,
    ...
    ///
    /// [`AgentDefinitionRegistry`]: crate::neppy::agent::harness::definition::AgentDefinitionRegistry
    ...
    /// [`crate::neppy::agent::context`] for the full surface.
    ...
    pub(super) run_queue: Option<Arc<crate::neppy::agent::harness::run_queue::RunQueue>>,
    ...
    pub(super) connected_integrations:
        Vec<crate::neppy::agent::context::prompt::ConnectedIntegration>,
    ...
    /// the Composio cache.
    pub(super) runtime_config: Option<Arc<crate::neppy::config::Config>>,
    ...
    pub(super) payload_summarizer:
        Option<Arc<dyn crate::neppy::agent::tinyagents::payload_summarizer::PayloadSummarizer>>,
    ...
    pub(super) tokenjuice_compression:
        crate::neppy::inference::tokenjuice::AgentTokenjuiceCompression,
    ...
    /// [`crate::neppy::integrations::composio::cached_active_integrations`]; on
    ...
    /// produced by [`crate::neppy::tools::orchestrator_tools::collect_orchestrator_tools`]
...
pub struct AgentBuilder {
    ...
    pub(super) config: Option<crate::neppy::config::AgentConfig>,
    /// Optional [`ContextConfig`] override threaded through from
    /// `Agent::from_config`. When unset the builder falls back to
    /// [`crate::neppy::config::ContextConfig::default`].
    pub(super) context_config: Option<crate::neppy::config::ContextConfig>,
    ...
    pub(super) workspace_descriptor: Option<tinyagents::harness::workspace::WorkspaceDescriptor>,
    pub(super) workflows: Option<Vec<crate::neppy::skills::Workflow>>,
