...
use crate::neppy::agent::dispatcher::{NativeToolDispatcher, XmlToolDispatcher};
use crate::neppy::agent::messages::ConversationMessage;
use crate::neppy::inference::provider::ChatResponse;
...
impl ChatModel<()> for MockProvider {
    ...
    async fn invoke(
        ...
        Ok(
            crate::neppy::agent::tinyagents::model::native_model_response_for_request(
                &response, &request,
            ),
        )
    }
...
impl Tool for MockTool {
    ...
    async fn execute(&self, _args: serde_json::Value) -> Result<crate::neppy::tools::ToolResult> {
        Ok(crate::neppy::tools::ToolResult::success("tool-out"))
    }
}
...
fn set_connected_integrations_marks_session_initialized_and_updates_hash() {
    ...
    agent.set_connected_integrations(vec![
        crate::neppy::agent::context::prompt::ConnectedIntegration {
            toolkit: "gmail".into(),
...
fn refresh_delegation_tools_no_duplicate_specs_across_shared_arc_connects() {
    ...
    let conn =
        |slug: &str, desc: &str| crate::neppy::agent::context::prompt::ConnectedIntegration {
            toolkit: slug.into(),
...
fn refresh_workflows_picks_up_skill_installed_on_disk() {
    ...
    // extraction this was a direct call and needed no setup.
    crate::neppy::memory::host_impls::install_for_tests();
    use crate::neppy::skills::ops_types::{SKILL_MD, TRUST_MARKER};
...
async fn turn_without_tools_returns_text() {
    ...
    let provider = Arc::new(MockProvider {
        responses: Mutex::new(vec![crate::neppy::inference::provider::ChatResponse {
...
async fn last_turn_usage_is_public_and_non_draining() {
    ...
    let provider = Arc::new(MockProvider {
        responses: Mutex::new(vec![crate::neppy::inference::provider::ChatResponse {
            text: Some("hello".into()),
            tool_calls: vec![],
            usage: Some(crate::neppy::inference::provider::UsageInfo {
                input_tokens: 123,
                output_tokens: 45,
                context_window: 8000,
    ...
    let peeked: crate::neppy::agent::harness::LastTurnUsage = {
        let usage = agent
            .last_turn_usage()
            .expect("usage should be populated after a turn");
        crate::neppy::agent::harness::LastTurnUsage {
...
async fn turn_with_native_dispatcher_handles_tool_results_variant() {
    ...
    let provider = Arc::new(MockProvider {
        responses: Mutex::new(vec![
            crate::neppy::inference::provider::ChatResponse {
...
async fn turn_dispatches_spawn_subagent_through_full_path_inner() {
    ...
    crate::neppy::memory::host_impls::install_for_tests();
    use crate::neppy::agent::harness::AgentDefinitionRegistry;
    use crate::neppy::tools::SpawnSubagentTool;
...
fn seed_resume_from_messages_is_noop_on_warm_agent() {
    ...
    agent.cached_transcript_messages = Some(vec![
        crate::neppy::agent::messages::ChatMessage::system("warm prefix"),
        crate::neppy::agent::messages::ChatMessage::user("hi"),
    ]);
    agent
...
fn bound_cached_transcript_messages_without_system_prefix_keeps_tail() {
    ...
    let messages = vec![
        crate::neppy::agent::messages::ChatMessage::user("u1"),
        crate::neppy::agent::messages::ChatMessage::assistant("a1"),
        crate::neppy::agent::messages::ChatMessage::user("u2"),
        crate::neppy::agent::messages::ChatMessage::assistant("a2"),
        crate::neppy::agent::messages::ChatMessage::user("u3"),
    ];
...
fn seed_resume_from_thread_transcript_is_noop_on_warm_agent() {
    ...
    agent.cached_transcript_messages =
        Some(vec![crate::neppy::agent::messages::ChatMessage::system(
            "warm prefix",
        )]);
...
struct FakeSessionHistory {
    ...
    canned: Option<crate::neppy::agent::harness::session::transcript::SessionTranscript>,
    appended: Mutex<Vec<Vec<crate::neppy::agent::messages::ChatMessage>>>,
}

impl crate::neppy::agent::harness::session::transcript_history::SessionTranscriptRead
    for FakeSessionHistory
{
    ...
    fn read_session(
        &self,
    ) -> Result<Option<crate::neppy::agent::harness::session::transcript::SessionTranscript>> {
        Ok(self.canned.clone())
    }
}

impl crate::neppy::agent::harness::session::transcript_history::SessionHistory
    for FakeSessionHistory
{
    fn append_turn(
        &self,
        turn: crate::neppy::agent::harness::session::transcript_history::TranscriptTurn<'_>,
    ) -> Result<()> {
...
impl crate::neppy::agent::harness::session::transcript_history::SessionHistoryLocator
    for FakeLocator
{
    fn latest_for_agent(
        &self,
        ...
        Arc<dyn crate::neppy::agent::harness::session::transcript_history::SessionTranscriptRead>,
    > {
    ...
    fn open_stem(
        &self,
        _stem: &str,
        _seed: crate::neppy::agent::harness::session::transcript::TranscriptMeta,
    ) -> Result<Arc<dyn crate::neppy::agent::harness::session::transcript_history::SessionHistory>>
    {
...
fn fake_transcript_meta(
    thread_id: &str,
) -> crate::neppy::agent::harness::session::transcript::TranscriptMeta {
    crate::neppy::agent::harness::session::transcript::TranscriptMeta {
...
async fn fake_locator_substitutes_the_whole_turn_path() {
    let workspace = tempfile::TempDir::new().expect("temp workspace");
    let canned = crate::neppy::agent::harness::session::transcript::SessionTranscript {
        meta: fake_transcript_meta("thr_fake"),
        messages: vec![
            crate::neppy::agent::messages::ChatMessage::system("canned system"),
            crate::neppy::agent::messages::ChatMessage::user("canned question"),
            crate::neppy::agent::messages::ChatMessage::assistant("canned answer"),
        ],
    };
    ...
    // (3) The write.
    let turn = vec![
        crate::neppy::agent::messages::ChatMessage::user("live question"),
        crate::neppy::agent::messages::ChatMessage::assistant("live answer"),
    ];
