...
fn sanitizers_and_tool_call_helpers_cover_fallback_paths() {
    ...
    let calls = vec![
        crate::neppy::agent::dispatcher::ParsedToolCall {
            name: "a".into(),
    ...
    let response = crate::neppy::inference::provider::ChatResponse {
...
fn helper_paths_cover_no_overlap_native_calls_and_truncation() {
    ...
    let native_calls = vec![crate::neppy::inference::provider::ToolCall {
        id: "native-1".into(),
        name: "echo".into(),
        arguments: "{}".into(),
        extra_content: None,
