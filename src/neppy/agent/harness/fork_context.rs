...
//! the [`crate::neppy::tools::Tool`] trait.
//!
//! [`PARENT_CONTEXT`] is set by the parent
//! [`crate::neppy::agent::Agent`] around its `turn` so that any tool
...
/// running inside [`crate::neppy::agent::Agent::turn`] via the
...
pub struct ParentExecutionContext {
    ...
    pub connected_integrations: Vec<crate::neppy::agent::context::prompt::ConnectedIntegration>,
    ...
    pub tool_call_format: crate::neppy::agent::context::prompt::ToolCallFormat,
    ...
    pub run_queue: Option<Arc<crate::neppy::agent::harness::run_queue::RunQueue>>,
}
...
///
/// Returns `None` when called from outside [`crate::neppy::agent::Agent::turn`]
