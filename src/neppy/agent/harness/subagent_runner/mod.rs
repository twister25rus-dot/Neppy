...
//!    set by the parent [`crate::neppy::agent::Agent::turn`].
...
//!    [`crate::neppy::agent::tinyagents::run_turn_via_tinyagents_shared`]) using
//!    the parent's [`crate::neppy::inference::provider::Provider`], then
