...
pub(crate) fn resolve_subagent_source(
    spec: &crate::neppy::agent::harness::definition::ModelSpec,
    agent_id: &str,
    config: Option<&crate::neppy::config::Config>,
    parent_source: crate::neppy::agent::tinyagents::TurnModelSource,
    parent_model: String,
    is_team_lead: bool,
    model_override: Option<&str>,
    temperature: f64,
) -> (crate::neppy::agent::tinyagents::TurnModelSource, String) {
...
pub(crate) fn user_is_signed_in_to_composio(config: &crate::neppy::config::Config) -> bool {
    crate::neppy::integrations::composio::client::create_composio_client(config).is_ok()
}
...
/// [`crate::neppy::integrations::composio::ComposioClient`] so the live
/// `composio.mode` toggle is honoured per execute — see
/// [`crate::neppy::integrations::composio::ComposioActionTool`] and issue #1710.
///
/// ## Tool caching (#5119)
///
...
pub(crate) struct LazyToolkitResolver {
    pub(super) config: std::sync::Arc<crate::neppy::config::Config>,
    pub(super) actions: Vec<crate::neppy::agent::context::prompt::ConnectedIntegrationTool>,
    ...
    pub(super) resolved: std::sync::Mutex<
        std::collections::HashMap<String, std::sync::Arc<dyn crate::neppy::tools::Tool>>,
    >,
}
...
impl LazyToolkitResolver {
    ...
    pub(super) fn resolve(
        &self,
        name: &str,
    ) -> Option<std::sync::Arc<dyn crate::neppy::tools::Tool>> {
        ...
        let tool: std::sync::Arc<dyn crate::neppy::tools::Tool> = std::sync::Arc::new(
    ...
    fn find_action(
        &self,
        name: &str,
    ) -> Option<&crate::neppy::agent::context::prompt::ConnectedIntegrationTool> {
