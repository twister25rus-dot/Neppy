use super::*;
use crate::neppy::agent::harness::definition::{ModelSpec, ToolScope};

#[test]
fn lazy_resolver_tolerates_near_miss_slugs() {
    use crate::neppy::agent::context::prompt::ConnectedIntegrationTool;
    ...
    let resolver = LazyToolkitResolver {
        config: std::sync::Arc::new(crate::neppy::config::Config::default()),
...
fn make_def_named_tools(names: &[&str]) -> AgentDefinition {
    AgentDefinition {
        ...
        timeout_secs: None,
        sandbox_mode: crate::neppy::agent::harness::definition::SandboxMode::None,
        background: false,
        trigger_memory_agent: Default::default(),
        tokenjuice_compression:
            crate::neppy::inference::tokenjuice::AgentTokenjuiceCompression::Auto,
        subagents: vec![],
        delegate_name: None,
        agent_tier: crate::neppy::agent::harness::definition::AgentTier::Worker,
        source: crate::neppy::agent::harness::definition::DefinitionSource::Builtin,
...
use crate::neppy::tools::{PermissionLevel, ToolResult};
...
use crate::neppy::agent::harness::fork_context::with_parent_context;
use crate::neppy::agent::harness::run_queue::{QueueMode, QueuedMessage, RunQueue};
...
fn make_parent(
    ...
    let tool_specs: Vec<crate::neppy::tools::ToolSpec> = tools.iter().map(|t| t.spec()).collect();
    ParentExecutionContext {
        ...
        allowed_subagent_ids: ["test".to_string(), "child".to_string(), "inner".to_string()]
            .into_iter()
            .collect(),
        turn_model_source: crate::neppy::agent::tinyagents::TurnModelSource::from_model(provider),
        ...
        memory: noop_memory(),
        agent_config: crate::neppy::config::AgentConfig::default(),
        workflows: Arc::new(vec![]),
        memory_context: Arc::new(None),
        session_id: "test-session".into(),
        channel: "test".into(),
        connected_integrations: vec![],
        tool_call_format: crate::neppy::agent::context::prompt::ToolCallFormat::PFormat,
...
fn noop_memory() -> Arc<dyn crate::neppy::memory::Memory> {
    struct NoopMemory;
    #[async_trait]
    impl crate::neppy::memory::Memory for NoopMemory {
        async fn store(
            &self,
            _namespace: &str,
            _key: &str,
            _content: &str,
            _category: crate::neppy::memory::MemoryCategory,
        ...
        async fn recall(
            ...
            _query: &str,
            _limit: usize,
            _opts: crate::neppy::memory::RecallOpts<'_>,
        ) -> anyhow::Result<Vec<crate::neppy::memory::MemoryEntry>> {
            Ok(vec![])
        }
        async fn get(
            &self,
            _namespace: &str,
            _key: &str,
        ) -> anyhow::Result<Option<crate::neppy::memory::MemoryEntry>> {
            Ok(None)
        }
        async fn list(
            &self,
            _namespace: Option<&str>,
            _category: Option<&crate::neppy::memory::MemoryCategory>,
            _session_id: Option<&str>,
        ) -> anyhow::Result<Vec<crate::neppy::memory::MemoryEntry>> {
            Ok(vec![])
        }
        ...
        async fn namespace_summaries(
            &self,
        ) -> anyhow::Result<Vec<crate::neppy::memory::NamespaceSummary>> {
            Ok(vec![])
        }
...
async fn capped_no_progress_subagent_returns_incomplete_status() {
    use crate::neppy::agent::harness::subagent_runner::SubagentRunStatus;
...
fn resolve_subagent_source_inherit_uses_parent_source_and_model() {
    ...
    let parent_source =
        crate::neppy::agent::tinyagents::TurnModelSource::from_model(parent.clone());
...
fn resolve_subagent_source_config_model_wins_over_definition_model() {
    use crate::neppy::config::{Config, TeamModelConfig};
...
fn resolve_subagent_source_inline_override_wins_over_config_model() {
    ...
    let (_resolved_source, resolved_model) = super::resolve_subagent_source(
        ...
        "test_agent",
        Some(&config),
        crate::neppy::agent::tinyagents::TurnModelSource::from_model(parent),
        "parent-model-x".to_string(),
        false,
        Some("inline-model"),
        0.0,
...
fn tier_gate_skips_when_parent_unresolved() {
    use crate::neppy::agent::harness::definition::AgentTier;
