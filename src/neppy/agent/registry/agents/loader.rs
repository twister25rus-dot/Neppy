...
pub struct BuiltinAgent {
    ...
    /// with a populated [`crate::neppy::agent::harness::definition::PromptContext`]
...
pub const BUILTINS: &[BuiltinAgent] = &[
    ...
    BuiltinAgent {
        ...
        prompt_fn: crate::neppy::skills::catalog::agent::skill_setup::prompt::build,
        graph_fn: None,
    },
    #[cfg(feature = "skills")]
    BuiltinAgent {
        ...
        prompt_fn: crate::neppy::skills::runtime::agent::skill_executor::prompt::build,
        graph_fn: None,
    },
    BuiltinAgent {
        id: "agent_memory",
        toml: include_str!("../../../memory/agent/agent/agent.toml"),
        prompt_fn: crate::neppy::memory::agent::agent::prompt::build,
        graph_fn: None,
    },
    ...
    BuiltinAgent {
        ...
        prompt_fn: crate::neppy::flows::agents::workflow_builder::prompt::build,
        graph_fn: None,
    },
    ...
    BuiltinAgent {
        ...
        prompt_fn: crate::neppy::flows::agents::flow_discovery::prompt::build,
        graph_fn: None,
    },
];
...
/// [`crate::neppy::agent::harness::definition::AgentDefinitionRegistry::load`]
...
mod tests {
    ...
    fn orchestrator_subagents_include_crypto_agent() {
        use crate::neppy::agent::harness::definition::SubagentEntry;
        let def = find("orchestrator");
    ...
    fn allows_skill_wildcards_on_any_non_worker_tier() {
        ...
        planner.subagents.push(SubagentEntry::Skills(
            crate::neppy::agent::harness::definition::SkillsWildcard { skills: "*".into() },
        ));
