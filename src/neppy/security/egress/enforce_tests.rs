...
use crate::neppy::security::egress::{DataKind, EgressDescriptor, EgressReason};
...
use crate::neppy::security::live_policy::test_privacy_scope;
...
fn local_only_tool_block_marks_message_and_clears_when_allowed() {
...

    {
        ...
        assert!(
            msg.starts_with(crate::neppy::security::POLICY_BLOCKED_MARKER),
