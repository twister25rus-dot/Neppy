...
//! [`crate::neppy::tools::Tool::external_effect`] returns `true`.
//!
//! Flow (issue #1339):
...
//!    [`crate::neppy::security::live_policy`]). Hit → `Allow`
...
/// `Workflow` [`AgentTurnOrigin`](crate::neppy::agent::turn_origin::AgentTurnOrigin),
...
impl ApprovalGate {
    ...
    fn tool_is_auto_approved(&self, tool_name: &str) -> bool {
        if let Some(policy) = crate::neppy::security::live_policy::current() {
...
mod tests {
    ...
    async fn auto_approve_all_allows_a_remote_triage_dispatch_without_an_audit_row() {
        use crate::neppy::agent::triage::{remote_trigger_origin, TriggerEnvelope};
    ...
    async fn a_local_triage_escalation_is_allowed_without_a_prompt() {
        use crate::neppy::agent::triage::local_trigger_origin;
    ...
    async fn flow_origin_park_publishes_flow_approval_request_and_notification() {
        ...
        let mut event_rx = crate::core::bus::BUS
            ...
            .receiver();
        let mut notif_rx =
            crate::neppy::desktop::notifications::bus::subscribe_core_notifications();
    ...
    async fn find_flow_gate_notification(
        rx: &mut tokio::sync::broadcast::Receiver<
            crate::neppy::desktop::notifications::types::CoreNotificationEvent,
        >,
        request_id: &str,
    ) -> crate::neppy::desktop::notifications::types::CoreNotificationEvent {
