...
//! [`peek_cached_current_user_identity`](crate::neppy::desktop::app_state::peek_cached_current_user_identity),
...
/// backend-mode sessions, [`crate::neppy::security::credentials::core::LOCAL_SESSION_USER_ID`]
