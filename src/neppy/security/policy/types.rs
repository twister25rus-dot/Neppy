...
/// ([`crate::neppy::agent::tinyagents::middleware::RepeatedToolFailureMiddleware`])
...
pub struct SecurityPolicy {
    ...
    /// [`create_chat_provider_from_string`](crate::neppy::inference::provider::factory)).
    /// Sourced from `config.privacy.mode` at policy-build time and hot-swapped
    /// via [`live_policy::reload_privacy`](crate::neppy::security::live_policy::reload_privacy).
    ///
