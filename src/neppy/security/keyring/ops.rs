...
//!
//! All public functions delegate to the active backend selected by [`crate::neppy::security::keyring::store`].
...
use crate::neppy::security::keyring::store::backend;
...
pub(crate) fn force_backend_for_test(
    b: Box<dyn crate::neppy::security::keyring::backend::KeyringBackend>,
) {
    use crate::neppy::security::keyring::store::BACKEND;
