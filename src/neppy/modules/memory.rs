...
impl MemoryCodingSessions for ModuleMemoryProvider {
    ...
    async fn ingest_coding_sessions(
        ...
        let deadline = crate::neppy::memory::sources::rpc::ingest_budget(request.max_sessions)
            + INGEST_BUS_GRACE;
...
/// Head-room added to [`ingest_budget`](crate::neppy::memory::sources::rpc::ingest_budget)
