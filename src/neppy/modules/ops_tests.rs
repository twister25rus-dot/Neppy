...
use crate::neppy::modules::ops::{self, install_dir, list};
use crate::neppy::modules::registry;
use crate::neppy::modules::types::ModuleState;
...
fn module_config_hands_the_module_the_hosts_cloud_embedding_defaults() {
    ...
    let sent = ops::module_config(&config, crate::neppy::modules::memory::MODULE_ID);
