...
//! (`crate::neppy::memory::source_scope`), and for a while this host simply used it.
...
//!
//! ```ignore
//! use neppy_core::neppy::memory::source_scope::{with_source_scope, current_source_scope};
//!
