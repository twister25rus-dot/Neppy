...
//! shaped like
//! [`memory::people::store::for_workspace`](crate::neppy::memory::people::store::for_workspace)
//! — a **workspace-keyed map** — and deliberately *not* like
//! [`memory::global`](crate::neppy::memory::global), which is a single slot
...
//!
//! [`crate::neppy::memory::api`] is the host-owned memory contract: `MemoryProvider`,
...
use crate::neppy::memory::api::provider::MemoryProvider;
use crate::neppy::memory::api::CONTRACT_VERSION;
use crate::neppy::memory::guard::{GuardPolicy, MemoryGuard};
...
use crate::neppy::config::schema::MemorySubsystemConfig;
...
/// `endpoint` from [`crate::neppy::config::schema::MemoryDriverConfig`],
...
fn module_provider(
    ...
    (
        Arc::new(
            crate::neppy::modules::memory::ModuleMemoryProvider::from_boot_policy()
...
fn module_provider(
    ...
    let workspace_dir = crate::neppy::memory::ops::shared_memory_test_workspace();
    ...
    if let Some(path) = std::env::var_os("TINYMEMORY_TEST_MODULE") {
        config
            .modules
            .overrides
            .push(crate::neppy::config::schema::ModuleOverride {
    ...
    (
        Arc::new(
            crate::neppy::modules::memory::ModuleMemoryProvider::new(Arc::new(config))
                .in_subdir(memory_subdir),
        ),
        DriverClass::Module,
    )
...
fn bind_provider(
    ...
    let guard = Arc::new(MemoryGuard::new(
        ...
        Arc::new(GuardPolicy::new(
            driver_id.clone(),
            class,
            crate::neppy::config::schema::MemoryHooksConfig::default(),
            "trusted",
        )),
    ));
    MemoryBinding {
...
pub(crate) struct FixedDiagnostics {
    ...
    failure: Option<crate::neppy::memory::api::provider::types::QueueFailure>,
    ...
    flush: crate::neppy::memory::api::provider::types::FlushOutcome,
    /// What [`MemoryMaintenance::reset_derived_index`] answers, likewise.
    reset: crate::neppy::memory::api::provider::types::ResetOutcome,
}
...
mod fixed_diagnostics_impl {
    ...
    use crate::neppy::memory::api::provider::types::{
    ...
    impl FixedDiagnostics {
        ...
        pub(crate) fn flushing(
            mut self,
            outcome: crate::neppy::memory::api::provider::types::FlushOutcome,
        ) -> Self {
            self.flush = outcome;
            self
        }
        ...
        pub(crate) fn resetting(
            mut self,
            outcome: crate::neppy::memory::api::provider::types::ResetOutcome,
        ) -> Self {
            self.reset = outcome;
            self
        }
    ...
    impl MemoryMaintenance for FixedDiagnostics {
        ...
        async fn flush_pending(
            &self,
        ) -> Result<crate::neppy::memory::api::provider::types::FlushOutcome, MemoryError> {
            Ok(self.flush.clone())
        }

        async fn reset_derived_index(
            &self,
        ) -> Result<crate::neppy::memory::api::provider::types::ResetOutcome, MemoryError> {
            Ok(self.reset.clone())
        }
    }
    ...
    impl MemoryProvider for FixedDiagnostics {
        ...
        fn capabilities(&self) -> crate::neppy::memory::api::capabilities::Capabilities {
            crate::neppy::memory::api::capabilities::Capabilities::all()
        }

        async fn health(&self) -> crate::neppy::memory::api::health::MemoryHealth {
            crate::neppy::memory::api::health::MemoryHealth::Ready
        }
...
pub fn for_config(config: &crate::neppy::config::Config) -> Result<Arc<MemoryBinding>, String> {
