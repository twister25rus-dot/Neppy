...
//! typed RPC calls in [`crate::neppy::memory::tree::tree::rpc`] (write
//! side) or [`crate::neppy::memory::read_rpc`] (UI read side).
...
use crate::neppy::memory::tree::tree::rpc;
...
pub(super) fn handle_smart_walk(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        use crate::neppy::memory::tree::retrieval::{fast_retrieve, FastRetrieveOptions};
