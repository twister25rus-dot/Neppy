...
//!
//! Same reasoning as [`crate::neppy::memory::safety`] and
//! [`crate::neppy::util::redact`] before it, and the same route: this is
...
//! ([`crate::neppy::memory::read_rpc::vault`]) is an RPC that reads the
