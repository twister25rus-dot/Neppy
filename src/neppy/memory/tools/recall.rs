use crate::neppy::memory::api::provider::MemoryRecall;
...
impl Tool for MemoryRecallTool {
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        let recall_opts = crate::neppy::memory::api::recall::OwnedRecallOpts {
...
mod tests {
    use super::*;
    use crate::neppy::memory::api::provider::MemoryCore;
