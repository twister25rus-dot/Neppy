...
//! `tool_effectiveness`.
//!
//! [`ToolTrackerHook`]: crate::neppy::agent::learning::ToolTrackerHook
...
use crate::neppy::agent::hooks::{PostTurnHook, ToolCallRecord, TurnContext};
...
mod tests {
    use super::*;
    use crate::neppy::agent::hooks::ToolCallRecord;
    use crate::neppy::memory::tool_memory::test_helpers::MockMemory;
    use crate::neppy::memory::tool_memory::tool_memory_store;
    ...
    async fn safety_case_never_email_sarah_pins_into_prompt_block() {
        ...
        let rendered = crate::neppy::memory::tool_memory::prompt::ToolMemoryRulesSection::new(flat)
            .rendered()
            .to_string();
