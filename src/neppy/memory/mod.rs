...
//! ~550 `crate::neppy::memory::…` paths elsewhere in this crate keep
...
/// [`crate::neppy::modules::memory_host`] instead. What still needs these
...
// reading `crate::neppy::memory::store::chunks::…` never appeared in a
...
pub use crate::neppy::memory::api::types::{
...
pub use crate::neppy::memory::api::types::NamespaceDocumentInput;
