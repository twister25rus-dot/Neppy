...
use crate::neppy::integrations::composio::providers::sync_state::KV_NAMESPACE;
...
async fn flush_now_reports_the_drivers_outcome() {
    use crate::neppy::memory::api::provider::types::FlushOutcome;
    ...
    crate::neppy::memory::binding::install_for_test(
        ...
        ) as std::sync::Arc<dyn crate::neppy::memory::api::provider::MemoryProvider>,
    );
...
async fn vault_health_check_reports_writable_and_obsidian_registered_when_ready() {
    ...
    crate::neppy::memory::binding::install_diagnostics_for_test(
        &cfg.workspace_dir,
        &cfg.subsystems.memory,
        crate::neppy::memory::api::provider::types::StoreStats {
            chunks: 1,
