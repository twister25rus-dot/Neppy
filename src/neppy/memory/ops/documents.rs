...
use crate::neppy::memory::api::types::NamespaceRetrievalContext;
...
pub async fn doc_put(params: PutDocParams) -> Result<RpcOutcome<PutDocResult>, String> {
    ...
    let document_id = documents
        .put_document(NamespaceDocumentInput {
            ...
            taint: crate::neppy::memory::api::types::MemoryTaint::Internal,
        })
        .await
...
mod tests {
    ...
    fn ensure_memory_client() -> WorkspaceEnvGuard {
        let workspace = crate::neppy::memory::ops::ensure_shared_memory_client();
