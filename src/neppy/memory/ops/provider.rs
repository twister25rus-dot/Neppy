...
use crate::neppy::memory::binding::{to_driver_health, MemoryBinding};
...
mod tests {
    ...
    async fn bound_driver_status_reports_id_class_contract_and_capabilities() {
        ...
        let cfg = crate::neppy::config::schema::MemorySubsystemConfig::default();
        let binding = crate::neppy::memory::binding::for_workspace(workspace.path(), &cfg)
        ...
        assert_eq!(status.driver, crate::neppy::memory::binding::MODULE_ID);
    ...
    async fn a_refused_driver_reports_the_fallback_and_its_reason() {
        let workspace = tempfile::tempdir().expect("tempdir");
        let mut cfg = crate::neppy::config::schema::MemorySubsystemConfig {
            driver: "supermemory".into(),
            ..Default::default()
        };
        cfg.drivers.insert(
            "supermemory".into(),
            crate::neppy::config::schema::MemoryDriverConfig {
