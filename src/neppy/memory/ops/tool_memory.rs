...
//! [`crate::neppy::memory::tool_memory`]).
//!
...
//!
//! Every handler reaches the module-backed [`MemoryToolMemory`](crate::neppy::memory::api::provider::MemoryToolMemory)
//! API through [`MemoryGuard`](crate::neppy::memory::guard::MemoryGuard),
...
use crate::neppy::memory::api::tool_memory::{
...
async fn tool_memory_guard() -> Result<Arc<crate::neppy::memory::guard::MemoryGuard>, String> {
...
///
/// Routed through [`MemoryGuard`](crate::neppy::memory::guard::MemoryGuard).
/// The wire type matches by identity, not conversion:
/// `memory::tool_memory::ToolMemoryRule` **is**
/// `crate::neppy::memory::api::tool_memory::ToolMemoryRule`.
...
pub async fn tool_rules_for_prompt(
    ...
    let rendered = crate::neppy::memory::tool_memory::prompt::render_tool_memory_rules(&flat);
...
mod tests {
    use super::*;
    use crate::neppy::memory::api::tool_memory::ToolMemoryPriority;

    fn ensure_memory_client() {
        crate::neppy::memory::ops::ensure_shared_memory_client();
    }
    ...
    async fn tool_rule_put_get_list_and_delete_roundtrip() {
        ...
        assert_eq!(
            stored.source,
            crate::neppy::memory::api::tool_memory::ToolMemorySource::Programmatic
        );
