...
//!   [`memory::sync::composio`](crate::neppy::memory::sync::composio).
//!
...
use crate::neppy::memory::sync::composio;
...
/// replacement is
/// [`MemoryMaintenance::queue_stats`](crate::neppy::memory::api::provider::MemoryMaintenance::queue_stats),
...
mod tests {
    ...
    async fn ingestion_status_reports_the_bound_drivers_queue() {
        let (_tmp, config) = bind_queue(crate::neppy::memory::api::provider::types::QueueStats {
            ready: 3,
            running: 1,
