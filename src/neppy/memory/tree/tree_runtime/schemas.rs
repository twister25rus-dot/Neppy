...
fn handle_ingest(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::neppy::memory::tree::tree_runtime::rpc::tree_summarizer_ingest(
                &config,
                &namespace,
                &content,
                timestamp,
...
fn handle_query(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(
            crate::neppy::memory::tree::tree_runtime::rpc::tree_summarizer_query(
                &config,
                &namespace,
                node_id.as_deref(),
            )
...
fn handle_status(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let namespace = read_required::<String>(&params, "namespace")?;
        to_json(
            crate::neppy::memory::tree::tree_runtime::rpc::tree_summarizer_status(
                &config, &namespace,
            )
            .await?,
        )
...
fn handle_rebuild(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let namespace = read_required::<String>(&params, "namespace")?;
        to_json(
            crate::neppy::memory::tree::tree_runtime::rpc::tree_summarizer_rebuild(
                &config, &namespace,
            )
            .await?,
        )
