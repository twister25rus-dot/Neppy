...
fn run_ingest(args: &[String]) -> Result<()> {
    ...
    rt.block_on(async {
        ...
        let outcome = crate::neppy::memory::tree::tree_runtime::rpc::tree_summarizer_ingest(
...
fn run_summarize(args: &[String]) -> Result<()> {
    ...
    rt.block_on(async {
        let config = load_config().await?;
        let outcome =
            crate::neppy::memory::tree::tree_runtime::rpc::tree_summarizer_run(&config, namespace)
                .await
                .map_err(anyhow::Error::msg)?;
...
fn run_query(args: &[String]) -> Result<()> {
    ...
    rt.block_on(async {
        let config = load_config().await?;
        let outcome = crate::neppy::memory::tree::tree_runtime::rpc::tree_summarizer_query(
...
fn run_status(args: &[String]) -> Result<()> {
    ...
    rt.block_on(async {
        let config = load_config().await?;
        let outcome = crate::neppy::memory::tree::tree_runtime::rpc::tree_summarizer_status(
            &config, namespace,
        )
        .await
        .map_err(anyhow::Error::msg)?;
...
fn run_rebuild(args: &[String]) -> Result<()> {
    ...
    rt.block_on(async {
        let config = load_config().await?;
        let outcome = crate::neppy::memory::tree::tree_runtime::rpc::tree_summarizer_rebuild(
            &config, namespace,
        )
        .await
        .map_err(anyhow::Error::msg)?;
...
async fn load_config() -> Result<crate::neppy::config::Config> {
    let mut config = crate::neppy::config::Config::load_or_init()
        .await
        .unwrap_or_default();
