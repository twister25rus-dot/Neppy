...
use crate::neppy::memory::api::provider::ChunkQuery;
...
async fn store_stats(
    config: &Config,
) -> Result<crate::neppy::memory::api::provider::types::StoreStats, String> {
    let binding = crate::neppy::memory::binding::for_config(config)?;
...
async fn queue_stats(
    config: &Config,
    kind: Option<&str>,
) -> Result<crate::neppy::memory::api::provider::types::QueueStats, String> {
    let binding = crate::neppy::memory::binding::for_config(config)?;
    let Some(maintenance) = binding.provider().as_maintenance() else {
        log::debug!(
...
pub struct PipelineStatusResponse {
    ...
    #[serde(default)]
    pub degraded: crate::neppy::memory::tree::health::DegradedState,
    ...
    #[serde(default)]
    pub first_blocking_cause: Option<crate::neppy::memory::tree::health::PipelineFailure>,
...
pub async fn pipeline_status_rpc(
    ...
    let degraded = crate::neppy::memory::tree::health::current_degraded_state();
...
pub async fn doctor_rpc(
    config: &Config,
) -> Result<RpcOutcome<crate::neppy::memory::tree::health::DoctorReport>, String> {
    // Offload the doctor's blocking SQLite reads off the async runtime thread.
    let report = crate::neppy::memory::tree::health::async_run_doctor(config).await;
...
pub async fn retry_failed_rpc(config: &Config) -> Result<RpcOutcome<RetryFailedResponse>, String> {
    ...
    let requeued = crate::neppy::memory::ops::maintenance::retry_failed(config).await?;
    Ok(RpcOutcome::single_log(
...
async fn latest_failed_job_failure(
    config: &Config,
) -> Result<Option<crate::neppy::memory::tree::health::PipelineFailure>, String> {
...
fn blocking_cause(
    reported: &crate::neppy::memory::api::provider::types::QueueFailure,
) -> Option<crate::neppy::memory::tree::health::PipelineFailure> {
    use crate::neppy::memory::tree::health::{FailureClass, FailureCode, PipelineFailure};
...
fn queue_idle_ms(
    queue: &crate::neppy::memory::api::provider::types::QueueStats,
    now_ms: i64,
) -> Option<i64> {
...
fn derive_pipeline_status(
    ...
    total_chunks: u64,
    degraded: &crate::neppy::memory::tree::health::DegradedState,
...
pub async fn set_enabled_rpc(
    ...
    crate::neppy::cron::scheduler_gate::gate::update_config(config.scheduler_gate.clone());
...
mod tests {
    ...
    fn bind_diagnostics(
        cfg: &Config,
        store: crate::neppy::memory::api::provider::types::StoreStats,
        queue: crate::neppy::memory::api::provider::types::QueueStats,
    ) {
        crate::neppy::memory::binding::install_diagnostics_for_test(
            &cfg.workspace_dir,
    ...
    async fn ingest_document_reports_the_chunks_it_wrote() {
        ...
        crate::neppy::memory::test_support::install_tinycortex_for_test(&cfg);
    ...
    async fn backfill_status_reports_the_drivers_pending_count() {
        use crate::neppy::memory::api::provider::types::QueueStats;
    ...
    async fn backfill_status_reports_the_drivers_flag_when_the_counts_are_empty() {
        ...
        let driver = std::sync::Arc::new(
            crate::neppy::memory::binding::FixedDiagnostics::new(
                Default::default(),
                QueueStats::default(),
            )
            .backfilling(),
        );
        crate::neppy::memory::binding::install_for_test(
            &cfg.workspace_dir,
            &cfg.subsystems.memory,
            driver as std::sync::Arc<dyn crate::neppy::memory::api::provider::MemoryProvider>,
        );
    ...
    fn derive_pipeline_status_precedence_matches_spec() {
        use crate::neppy::memory::tree::health::{DegradedState, FailureCode, PipelineFailure};
        use tinymemory_api::host::SchedulerGateMode;
    ...
    ) -> crate::neppy::memory::api::provider::types::QueueStats {
        crate::neppy::memory::api::provider::types::QueueStats {
            eligible_now,
            last_completed_ms,
            oldest_eligible_ms,
    ...
    ) -> crate::neppy::memory::api::provider::types::QueueFailure {
        crate::neppy::memory::api::provider::types::QueueFailure {
    ...
    fn blocking_cause_surfaces_when_nothing_has_succeeded_since() {
        use crate::neppy::memory::tree::health::{FailureClass, FailureCode};
    ...
    async fn pipeline_status_returns_idle_for_empty_store() {
        ...
        let _g = crate::neppy::memory::tree::health::test_guard();
        let (_tmp, cfg) = test_config();
    ...
    async fn pipeline_status_renders_the_drivers_chunk_aggregates() {
        use crate::neppy::memory::api::provider::types::{QueueStats, StoreStats};
