...
use crate::neppy::memory::api::tool_memory::ToolMemoryRule;
use crate::neppy::memory::api::tree::{
    IngestRequest, QueryResult, SummaryForest, TreeLeaf, TreeStatus,
};
use crate::neppy::memory::api::types::NamespaceMemoryHit;
...
impl MemoryTree for GuardedTree {
    ...
    /// ([`source_scope::current_source_scope`](crate::neppy::memory::source_scope::current_source_scope))
    ...
    /// [`GuardPolicy::narrow_scope`](crate::neppy::memory::guard::GuardPolicy::narrow_scope),
