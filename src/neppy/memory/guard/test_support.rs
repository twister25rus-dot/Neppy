...
use crate::neppy::memory::api::tree::{IngestRequest, QueryResult, TreeStatus};
...
impl MemoryEpisodic for RecordingProvider {
    async fn insert_turn(
        &self,
        turn: &crate::neppy::memory::api::provider::episodic::EpisodicTurn,
    ...
    async fn session_turns(
        &self,
        _session_id: &str,
    ) -> Result<Vec<crate::neppy::memory::api::provider::episodic::EpisodicTurn>, MemoryError> {
    ...
    async fn open_segment(
        ...
        Option<crate::neppy::memory::api::provider::episodic::ConversationSegment>,
        MemoryError,
    > {
