...
use crate::neppy::memory::api::provider::chunks::ChunkQuery;
use crate::neppy::memory::api::provider::retrieval::{CoverWindowQuery, FastRetrieveQuery};
use crate::neppy::memory::api::provider::types::SourceScope;
use crate::neppy::memory::api::provider::{MemoryProvider, MemoryTree};
use crate::neppy::memory::api::tree::IngestRequest;
use crate::neppy::memory::api::types::MemoryTaint;

use crate::neppy::memory::guard::test_support::{
    document, embedded_policy, external_policy, guarded,
};
use crate::neppy::memory::source_scope::with_source_scope;
use crate::neppy::security::live_policy;
...
fn episodic_turn(content: &str) -> crate::neppy::memory::api::provider::EpisodicTurn {
    crate::neppy::memory::api::provider::EpisodicTurn {
        id: None,
...
fn episodic_event(content: &str) -> crate::neppy::memory::api::provider::EpisodicEvent {
    crate::neppy::memory::api::provider::EpisodicEvent {
        event_id: "event-1".into(),
        segment_id: "segment-1".into(),
        session_id: "session-1".into(),
        namespace: "ns".into(),
        kind: crate::neppy::memory::api::provider::EventKind::Fact,
        content: content.into(),
        subject: None,
        timestamp_ref: None,
        confidence: 1.0,
