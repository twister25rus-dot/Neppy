...
//!
//! The registration probe itself is [`crate::neppy::memory::obsidian_registry`],
...
use crate::neppy::memory::obsidian_registry;
...
pub async fn obsidian_vault_status_rpc(
    ...
    let log = format!(
        ...
        resp.registered,
        resp.config_found,
        crate::neppy::util::redact::redact(&resp.content_root_abs),
    );
...
pub async fn vault_health_check_rpc(
    ...
    let pipeline = crate::neppy::memory::tree::tree::rpc::pipeline_status_rpc(config)
        .await
