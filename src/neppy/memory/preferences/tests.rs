...
use crate::neppy::memory::api::provider::retrieval::MemoryRetrieval;
...
use crate::neppy::memory::guard::in_memory::{guarded_in_memory, InMemoryProvider};
...
impl MemoryRetrieval for ScriptedRetrieval {
    ...
    async fn fast_retrieve(
        &self,
        _query: &str,
        _options: crate::neppy::memory::api::provider::retrieval::FastRetrieveQuery,
        _scope: Option<&crate::neppy::memory::api::provider::types::SourceScope>,
    ) -> Result<crate::neppy::memory::api::provider::retrieval::RetrievalResponse, MemoryError>
    {
    ...
    async fn cover_window(
        &self,
        _window: &crate::neppy::memory::api::provider::retrieval::CoverWindowQuery,
        _scope: Option<&crate::neppy::memory::api::provider::types::SourceScope>,
    ) -> Result<crate::neppy::memory::api::provider::retrieval::RetrievalResponse, MemoryError>
    {
        unimplemented!("ScriptedRetrieval only serves recall_namespace_scored")
    ...
    async fn retrieve_source(
        &self,
        _query: &crate::neppy::memory::api::provider::retrieval::SourceRetrievalQuery,
        _scope: Option<&crate::neppy::memory::api::provider::types::SourceScope>,
    ) -> Result<crate::neppy::memory::api::provider::retrieval::RetrievalResponse, MemoryError>
    {
        unimplemented!("ScriptedRetrieval only serves recall_namespace_scored")
    ...
    async fn retrieve_children(
        ...
        _query: Option<&str>,
        _limit: Option<usize>,
        _scope: Option<&crate::neppy::memory::api::provider::SourceScope>,
    ) -> Result<Vec<crate::neppy::memory::api::provider::retrieval::RetrievalHit>, MemoryError>
    {
        unimplemented!("ScriptedRetrieval only serves recall_namespace_scored")
    }
    ...
    async fn search_entities(
        ...
        _limit: usize,
    ) -> Result<Vec<crate::neppy::memory::api::provider::retrieval::EntityMatch>, MemoryError> {
        unimplemented!("ScriptedRetrieval only serves recall_namespace_scored")
    }
}
...
impl MemoryCore for RetrievalProvider {
    ...
    async fn get(
        ...
        namespace: &str,
        key: &str,
    ) -> Result<Option<crate::neppy::memory::api::types::MemoryEntry>, MemoryError> {
    ...
    async fn list(
        ...
        session_id: Option<&str>,
    ) -> Result<Vec<crate::neppy::memory::api::types::MemoryEntry>, MemoryError> {
        self.base.list(namespace, category, session_id).await
    }

    async fn namespaces(
        &self,
    ) -> Result<Vec<crate::neppy::memory::api::types::NamespaceSummary>, MemoryError> {
...
impl MemoryRecall for RetrievalProvider {
    async fn recall(
        ...
        query: &str,
        limit: usize,
        opts: &crate::neppy::memory::api::recall::OwnedRecallOpts,
        scope: Option<&crate::neppy::memory::api::provider::types::SourceScope>,
    ) -> Result<Vec<crate::neppy::memory::api::types::MemoryEntry>, MemoryError> {
...
impl MemoryPortability for RetrievalProvider {
    async fn export_page(
        ...
        cursor: Option<&str>,
        limit: usize,
    ) -> Result<crate::neppy::memory::api::provider::types::ExportPage, MemoryError> {
        self.base.export_page(cursor, limit).await
    }

    async fn import_records(
        &self,
        records: Vec<crate::neppy::memory::api::provider::types::ExportRecord>,
    ) -> Result<crate::neppy::memory::api::provider::types::ImportOutcome, MemoryError> {
...
impl MemoryProvider for RetrievalProvider {
    ...
    fn capabilities(&self) -> Capabilities {
        Capabilities::mandatory()
            .with(crate::neppy::memory::api::capabilities::Capability::Retrieval)
    }
...
fn scripted(hits: Vec<(&str, &str, f64)>) -> Arc<MemoryGuard> {
    ...
    crate::neppy::memory::guard::in_memory::guard_over(provider)
}
