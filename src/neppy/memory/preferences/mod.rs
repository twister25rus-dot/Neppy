...
//! [`Capability::Retrieval`](crate::neppy::memory::api::capabilities::Capability::Retrieval).
...
use crate::neppy::memory::api::provider::{MemoryCore as _, MemoryProvider as _};
use crate::neppy::memory::guard::MemoryGuard;
...
pub async fn load_general_preferences_on(
    memory: &std::sync::Arc<dyn crate::neppy::memory::Memory>,
    limit: usize,
) -> Vec<String> {
    let entries = memory
        .list(Some(USER_PREF_GENERAL_NAMESPACE), None, None)
