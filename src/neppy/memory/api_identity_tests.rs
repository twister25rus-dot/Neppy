...
//!
//! `crate::neppy::memory::api` is the vocabulary three parties speak:
//! the host call sites, [`crate::neppy::modules::memory::ModuleMemoryProvider`]
...
//! crate into `src/neppy/memory/api/` as 10,894 lines of verbatim copy.
...
//! 'neppy_core::neppy::memory::api::chunks::SourceKind'`. That is the point
...
fn chunk_types_are_the_contract_crates() {
    fn source_kind(
        k: crate::neppy::memory::api::chunks::SourceKind,
    ) -> tinymemory_api::chunks::SourceKind {
        k
    }
    fn chunk(c: crate::neppy::memory::api::chunks::Chunk) -> tinymemory_api::chunks::Chunk {
        c
    }
...
fn error_and_wire_table_are_the_contract_crates() {
    fn error(
        e: crate::neppy::memory::api::error::MemoryError,
    ...
    let host = crate::neppy::memory::api::wire::wire_name(
        &crate::neppy::memory::api::error::MemoryError::PathEscape("/etc/passwd".to_string()),
    );
...
fn provider_contract_is_the_contract_crates() {
    fn provider(
        p: std::sync::Arc<dyn crate::neppy::memory::api::provider::MemoryProvider>,
    ...
    fn capabilities(
        c: crate::neppy::memory::api::capabilities::Capabilities,
...
fn host_seam_types_are_the_contract_crates() {
    fn event(e: crate::neppy::memory::api::host::MemoryEvent) -> tinymemory_api::host::MemoryEvent {
        e
    }
    let _ = event as fn(_) -> _;

    fn spacy(
        s: crate::neppy::memory::api::host::SpacyResponse,
    ...
    fn connection(
        c: crate::neppy::memory::api::host::ComposioConnection,
    ...
    fn execute(
        r: crate::neppy::memory::api::host::ComposioExecuteResponse,
    ) -> crate::neppy::integrations::composio::types::ComposioExecuteResponse {
        r
    }
...
fn contract_version_is_the_contract_crates() {
    assert_eq!(
        crate::neppy::memory::api::CONTRACT_VERSION,
...
fn the_fallback_driver_is_the_contract_crates_but_not_contract_surface() {
    ...
    ) -> std::sync::Arc<dyn crate::neppy::memory::api::provider::MemoryProvider> {
        p
    }
    let _ = provider as fn(_) -> _;
}
