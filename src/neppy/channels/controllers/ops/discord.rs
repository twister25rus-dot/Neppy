...
pub async fn discord_link_start(
    ...
    let instructions =
        format!("In Discord, send this message to the Neppy bot: !start {link_token}");
...
pub async fn discord_list_guilds(
    config: &Config,
) -> Result<RpcOutcome<Vec<crate::neppy::channels::providers::discord::api::DiscordGuild>>, String>
{
    use crate::neppy::channels::providers::discord::api;
...
pub async fn discord_list_channels(
    ...
    RpcOutcome<Vec<crate::neppy::channels::providers::discord::api::DiscordTextChannel>>,
    String,
> {
    use crate::neppy::channels::providers::discord::api;
...
pub async fn discord_check_permissions(
    ...
    guild_id: &str,
    channel_id: &str,
) -> Result<RpcOutcome<crate::neppy::channels::providers::discord::api::BotPermissionCheck>, String>
{
    use crate::neppy::channels::providers::discord::api;
