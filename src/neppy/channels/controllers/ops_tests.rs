...
use crate::neppy::config::schema::{DiscordConfig, IMessageConfig};
...
async fn channel_status_reports_managed_dm_credential_as_connected() {
    ...
    crate::neppy::security::credentials::ops::store_provider_credentials(
        &config,
...
async fn channel_status_surfaces_live_listener_error() {
    ...
    crate::neppy::platform::health::mark_component_error(
        "channel:discord",
        "gateway closed (4004)",
    );
    ...
    crate::neppy::platform::health::mark_component_ok("channel:discord");
