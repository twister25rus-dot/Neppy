...
use crate::neppy::agent::bus::{mock_agent_run_turn, AgentTurnRequest, AgentTurnResponse};
    ...
    let build_runtime = || {
        ...
        let runtime_ctx = Arc::new(ChannelRuntimeContext {
            ...
            turn_model_source: Some(
                crate::neppy::agent::tinyagents::TurnModelSource::from_model(Arc::new(SlowModel {
...
async fn process_channel_message_hardens_multimodal_files_against_smuggled_markers() {
    let captured: Arc<Mutex<Option<crate::neppy::config::MultimodalFileConfig>>> =
    ...
    let permissive_operator_default = crate::neppy::config::MultimodalFileConfig {
        max_files: 4,
