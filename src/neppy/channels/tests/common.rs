use crate::neppy::channels::{traits, Channel, SendMessage};
...
// `crate::neppy::agent::bus` as `BUS_HANDLER_LOCK` (re-exported from
...
// `crate::neppy::agent::bus`) or the generic `mock_bus_stub` in
// `crate::core::bus` for arbitrary bus methods.
pub(super) use crate::neppy::agent::bus::use_real_agent_handler;
