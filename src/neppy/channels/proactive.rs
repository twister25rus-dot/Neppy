...
use crate::neppy::channels::{Channel, ChannelSendExt, SendMessage};
use crate::neppy::web_chat::publish_web_channel_event;
...
#[cfg(not(test))]
fn proactive_approval_gate() -> Option<Arc<crate::neppy::security::approval::ApprovalGate>> {
    crate::neppy::security::approval::ApprovalGate::try_global()
}
