...
pub(crate) struct ChannelRuntimeContext {
    ...
    pub(crate) memory: Arc<crate::neppy::memory::guard::MemoryGuard>,
    ...
    pub(crate) reliability: Arc<crate::neppy::config::ReliabilityConfig>,
    pub(crate) provider_runtime_options: crate::neppy::inference::provider::ProviderRuntimeOptions,
    pub(crate) workspace_dir: Arc<PathBuf>,
    pub(crate) message_timeout_secs: u64,
    pub(crate) multimodal: crate::neppy::config::MultimodalConfig,
    pub(crate) multimodal_files: crate::neppy::config::MultimodalFileConfig,
    ...
    pub(crate) config: Option<Arc<crate::neppy::config::Config>>,
}
...
pub(crate) async fn build_memory_context(
    mem: &crate::neppy::memory::guard::MemoryGuard,
    user_msg: &str,
...
mod tests {
    ...
    use crate::neppy::tools::{Tool, ToolResult};
    ...
    fn runtime_context() -> ChannelRuntimeContext {
        ...
        ChannelRuntimeContext {
            ...
            turn_model_source: Some(
                crate::neppy::agent::tinyagents::TurnModelSource::from_model(model),
            ),
            default_provider: Arc::new("default".into()),
            memory: crate::neppy::memory::guard::in_memory::FixedRecallProvider::guarded(Vec::new()),
            ...
            api_url: None,
            inference_url: None,
            reliability: Arc::new(crate::neppy::config::ReliabilityConfig::default()),
            provider_runtime_options:
                crate::neppy::inference::provider::ProviderRuntimeOptions::default(),
            workspace_dir: Arc::new(PathBuf::from("/tmp")),
            message_timeout_secs: CHANNEL_MESSAGE_TIMEOUT_SECS,
            multimodal: crate::neppy::config::MultimodalConfig::default(),
            multimodal_files: crate::neppy::config::MultimodalFileConfig::default(),
            config: None,
        }
    }
    ...
    fn clear_and_compact_sender_history_update_cached_messages() {
        ...
        history.push(crate::neppy::agent::messages::ChatMessage::user("short"));
        history.extend((0..20).map(|idx| {
            crate::neppy::agent::messages::ChatMessage::assistant("x".repeat(700 + idx))
        }));
        ctx.conversation_histories
            .lock()
            .unwrap()
    ...
    async fn build_memory_context_filters_entries_and_truncates_content() {
        let mem = crate::neppy::memory::guard::in_memory::FixedRecallProvider::guarded(vec![
    ...
    async fn build_memory_context_honors_total_budget_and_entry_limit() {
        let entries = (0..10)
            ...
            .collect();
        let mem = crate::neppy::memory::guard::in_memory::FixedRecallProvider::guarded(entries);
