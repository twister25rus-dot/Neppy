...
//
// When enabled, Neppy can execute actions on Gmail, Notion, GitHub, Slack, etc.
...
use crate::neppy::tools::traits::{Tool, ToolCategory, ToolResult};
use anyhow::Context;
...
impl ComposioTool {
    ...
    pub(crate) fn auth_key_fingerprint(&self) -> u64 {
        crate::neppy::integrations::composio::direct_auth::fingerprint_api_key(&self.api_key)
    }
    ...
    fn client(&self) -> Client {
        crate::neppy::config::build_runtime_proxy_client_with_timeouts("tool.composio", 60, 10)
    }
    ...
    /// in [`crate::neppy::integrations::composio::client::ComposioClient::list_tools`];
...
fn sanitize_error_message(message: &str) -> String {
    ...
    crate::neppy::util::truncate_with_ellipsis(&sanitized, 240)
}
