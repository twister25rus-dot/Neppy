...
async fn fetch_connected_integrations_uncached(
    ...
    for slug in &unique_toolkits {
        ...
        let integration_connections: Vec<
            crate::neppy::agent::context::prompt::IntegrationConnection,
        > = if connected {
...
mod connectable_slug_tests {
    ...
    use crate::neppy::integrations::composio::types::ComposioToolkitCatalogEntry;
...
mod catalog_description_tests {
    ...
    fn falls_back_to_hardcoded_table_when_catalog_omits_toolkit() {
        ...
        assert_eq!(
            got,
            crate::neppy::integrations::composio::providers::toolkit_description("gmail")
        );
        assert!(!got.is_empty());
    }
