...
//! [`crate::neppy::json_schema`], owned by neither side.
...
///
/// - **Backend mode** calls [`crate::neppy::integrations::composio::client::ComposioClient::list_tools`]
...
async fn fetch_raw_toolkit_tools(
    config: &Config,
    toolkit: &str,
) -> Option<crate::neppy::integrations::composio::types::ComposioToolsResponse> {
...
// [`crate::neppy::integrations::composio::ComposioToolFunction::output_parameters`]'s
...
/// Top-level [`crate::neppy::integrations::composio::ComposioExecuteResponse`] fields
...
/// vendor-neutral walker in [`crate::neppy::json_schema`]. That walker
...
fn resolve_composio_action_scope(
    slug: &str,
) -> Option<crate::neppy::memory::sync::composio::providers::ToolScope> {
    use crate::neppy::memory::sync::composio::providers::{
...
pub(crate) async fn probe_tool_output_sample(
    ...
    match resolve_composio_action_scope(slug) {
        Some(crate::neppy::memory::sync::composio::providers::ToolScope::Read) => {}
        Some(other) => {
            tracing::warn!(
                target: "flows",
                %slug,
    ...
    let Some(toolkit) = crate::neppy::memory::sync::composio::providers::toolkit_from_slug(slug)
    else {
        return Err(format!(
...
pub(crate) async fn composio_required_args(config: &Config, slug: &str) -> Option<Vec<String>> {
    let toolkit = crate::neppy::memory::sync::composio::providers::toolkit_from_slug(slug)?;
