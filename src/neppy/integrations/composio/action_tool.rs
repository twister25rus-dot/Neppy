...
//! [`crate::neppy::config::ComposioConfig::mode`] toggle — see
...
use crate::neppy::tools::traits::{PermissionLevel, Tool, ToolCategory, ToolResult};
...
pub struct ComposioActionTool {
    ...
    /// the [`crate::neppy::config::ComposioConfig::mode`] toggle is
...
mod tests {
    ...
    async fn contract_gate_surfaces_full_contract_then_proceeds_on_retry() {
        ...
        use crate::neppy::config::TEST_ENV_LOCK;
        use crate::neppy::integrations::composio::catalog::{
    ...
    fn factory_routes_through_backend_when_mode_is_backend() {
        ...
        let msg =
            match crate::neppy::integrations::composio::client::create_composio_client(&config) {
    ...
    fn factory_routes_through_direct_when_mode_is_direct() {
        ...
        assert!(
            matches!(
                kind,
                crate::neppy::integrations::composio::client::ComposioClientKind::Direct(_)
            ),
    ...
    async fn mode_toggle_between_calls_is_observed() {
        ...
        direct_config.composio.mode =
            crate::neppy::config::schema::COMPOSIO_MODE_DIRECT.to_string();
