...
use crate::neppy::sandbox::cwd_jail::{self, Jail, NoopBackend};
...
pub async fn execute_in_sandbox(
    ...
    match policy.backend {
        SandboxBackendKind::None => {
            crate::neppy::config::ensure_usable_cwd(working_dir)?;
        ...
        SandboxBackendKind::Docker => {
            crate::neppy::config::ensure_usable_cwd(&policy.workspace_root)?;
