...
fn handle_status(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let mode = match backend_str {
            "docker" | "local" => crate::neppy::agent::harness::definition::SandboxMode::Sandboxed,
            _ => crate::neppy::agent::harness::definition::SandboxMode::None,
        };
...
fn handle_resolve_policy(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let mode = match mode_str {
            "sandboxed" => crate::neppy::agent::harness::definition::SandboxMode::Sandboxed,
            "read_only" => crate::neppy::agent::harness::definition::SandboxMode::ReadOnly,
            _ => crate::neppy::agent::harness::definition::SandboxMode::None,
        };

        let config = crate::neppy::config::RuntimeConfig::default();
        let action_dir = crate::neppy::config::default_action_dir();
