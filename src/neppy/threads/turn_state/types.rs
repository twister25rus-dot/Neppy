...
use crate::neppy::agent::task_board::TaskBoard;
...
impl From<&crate::neppy::tools::status::ClassifiedFailure> for PersistedToolFailure {
    fn from(f: &crate::neppy::tools::status::ClassifiedFailure) -> Self {
