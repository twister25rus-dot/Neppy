class Neppy < Formula
  ...
  def install
    ...
    system "cargo", "install", "--bin", "neppy-core", *std_cargo_args
    bin.install_symlink bin/"neppy-core" => "openhuman"
  end

  test do
    assert_match "Neppy core CLI", shell_output("#{bin}/openhuman --help")
    assert_match "Neppy core CLI", shell_output("#{bin}/neppy-core --help")
  end
end
