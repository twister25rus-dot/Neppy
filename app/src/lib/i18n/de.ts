...
const messages: TranslationMap = {
  ...
  'share.defaultHeadline': 'Sieh, was mein Neppy-Agent gerade gemacht hat',
  'share.defaultAgentName': 'Mein Agent',
  'share.defaultCaption': 'Sieh, was mein Neppy-Agent gerade gemacht hat.',
  'share.captionWithHeadline': '{headline}. Erstellt mit meinem Neppy-Agenten.',
  ...
  'feedback.welcome.body':
    'Sagen Sie uns, was funktioniert, was fehlt und was Neppy besser machen würde. Posten Sie eine Idee, stimmen Sie über die Vorschläge anderer ab und beobachten Sie, wie die besten an die Spitze unserer Roadmap steigen.',
  ...
  'rewards.welcome.body':
    'Sammeln Sie Punkte, indem Sie Neppy nutzen und andere einladen. Halten Sie Ihre Serie am Leben und lösen Sie Ihre Prämien ein. Alles wird an einem Ort erfasst.',
  ...
  'settings.core.applyRestartNote':
    'Beim Speichern startet Neppy neu, um die Verbindung herzustellen.',
  ...
  'conversations.toolFailure.missingPermission.cause':
    'Neppy hat noch keine Berechtigung, dies zu tun.',
  ...
  'conversations.toolFailure.serviceUnavailable.cause':
    'Ein von Neppy benötigter Dienst ist vorübergehend nicht verfügbar.',
  'conversations.toolFailure.serviceUnavailable.next':
    'Neppy versucht es in Kürze erneut – nichts weiter nötig.',
  ...
  'conversations.toolFailure.timeout.next':
    'Neppy versucht es erneut, oder du kannst es manuell wiederholen.',
  ...
  'conversations.toolFailure.approvalExpired.next':
    'Frag erneut, um sie auszuführen: Neppy versucht es nicht von selbst erneut.',
  ...
  'orchPage.medulla.tagline': 'Das Orchestrierungsmodell von Neppy',
  'orchPage.medulla.body':
    'Medulla ist das eigens entwickelte LLM von Neppy. Es ist darauf ausgelegt, Tausende Agenten gleichzeitig zu orchestrieren, verfügt über ein Kontextfenster von 10 Millionen Tokens und ermöglicht eine radikal kostengünstigere Orchestrierung.',
  ...
  'orchPage.medulla.subscriberTitle': 'Neppy-Abonnenten',
  'orchPage.medulla.subscriberNote':
    'Sobald Medulla live geht, ist es exklusiv für Neppy-Abonnenten.',
  ...
  'orchPage.connections.initDesc':
    'Starte einen neuen Sub-Agenten, der an deiner Seite arbeitet. Öffne den Agent-Chat und beschreibe Rolle, Ziel und Tools: Neppy stellt eine eigene Instanz bereit, die du von hier aus steuerst.',
  ...
  'tinyplaceOrchestration.master.preview': 'Direkte Koordination zwischen dir und Neppy.',
  ...
  'tinyplaceOrchestration.composer.placeholder': 'Nachricht an Neppy…',
  ...
  'welcome.title': 'Willkommen bei Neppy',
  'welcome.subtitle':
  ...
  'welcome.resetErrorFallback':
    'App-Daten konnten nicht gelöscht werden. Bitte Neppy beenden, neu öffnen und es dann erneut versuchen.',
  ...
  'home.statusCoreUnreachable':
    'Der lokale Core-Sidecar reagiert nicht. Der Hintergrundprozess Neppy ist möglicherweise abgestürzt oder konnte nicht gestartet werden.',
  ...
  'skills.explorer.emptyDescription':
    'Installiere ein SKILL.md-Paket oder lege Hermes-artige Ordner unter ~/.neppy/skills ab.',
  ...
  'rewards.localUnavailable':
    'Ein lokaler Login sammelt keine Belohnungen, Gutscheine oder Empfehlungsguthaben. Melde dich ab und anschließend mit einem Neppy-Konto an, wenn Belohnungen zählen sollen.',
  ...
  'onboarding.welcome': 'Hallo. Ich bin Neppy.',
  ...
  'onboarding.finishDesc': 'Du bist bereit! Beginne mit der Verwendung von Neppy.',
  'onboarding.skip': 'Überspringen',
  'onboarding.getStarted': 'Lege los',
  'onboarding.runtimeChoice.title': 'Wie möchtest du Neppy starten?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Lass Neppy alles für dich verwalten.',
  ...
  'onboarding.custom.defaultSubtitle': 'Lass Neppy das für dich erledigen.',
  ...
  'onboarding.custom.inference.defaultDesc':
    'Neppy leitet jede Arbeitslast an ein sinnvolles Standardmodell weiter. Keine Schlüssel, keine Einrichtung.',
  ...
  'onboarding.custom.voice.defaultDesc':
    'Neppy wird mit verwaltetem STT/TTS geliefert, das einfach funktioniert. Nichts zu verkabeln.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'Neppy führt einen verwalteten Composio-Arbeitsbereich aus. Ein Klick, um jeden Dienst später zu verbinden.',
  ...
  'onboarding.custom.search.subtitle': 'Wie Neppy das Web in deinem Namen durchsucht.',
  'onboarding.custom.search.defaultDesc':
    'Neppy verwendet ein verwaltetes Such-Backend. Keine Schlüssel erforderlich.',
  ...
  'onboarding.custom.embeddings.subtitle':
    'Wie Neppy Vektor-Embeddings für die semantische Gedächtnissuche erstellt.',
  'onboarding.custom.embeddings.defaultDesc':
    'Neppy verwendet einen verwalteten Embedding-Dienst. Kein API-Schlüssel erforderlich.',
  ...
  'onboarding.custom.memory.subtitle':
    'Wie Neppy sich deinen Kontext, deine Vorlieben und frühere Gespräche merkt.',
  'onboarding.custom.memory.defaultDesc':
    'Neppy verwaltet die Speicherung und den Abruf des Speichers automatisch. Nichts einzurichten.',
  ...
  'misc.beta':
    'Neppy befindet sich in der frühen Betaphase. Teile uns gerne dein Feedback mit oder melde Fehler, auf die du stößt – jede Meldung hilft uns, schneller zu liefern.',
  ...
  'privacy.shareAnonymizedDataDesc':
    'Hilf mit, Neppy zu verbessern, indem du datensparsame Absturzberichte und Nutzungsereignisse teilst, einschließlich einer stabilen Konto-ID und App-Versionsmetadaten. Nachrichten, Wallet-Schlüssel, API-Schlüssel und Sitzungstokens werden nie erfasst.',
  ...
  'privacy.autoHandoffMeetDesc':
    'Wenn ein Google Meet-Anruf endet, kann der Orchestrator von Neppy das Transkript lesen und Maßnahmen wie das Verfassen von Nachrichten, das Planen von Folgemaßnahmen oder das Veröffentlichen von Zusammenfassungen in deinem verbundenen Slack-Arbeitsbereich ergreifen. Standardmäßig deaktiviert.',
  ...
  'settings.about.starCta.title': 'Gefällt dir Neppy?',
  ...
  'settings.search.menuDesc':
    'Verwenden Sie standardmäßig die von Neppy verwaltete Suche oder verbinden Sie Ihren eigenen Anbieter mit einem API-Schlüssel.',
  'settings.search.description':
    'Wählen Sie die Suchmaschine, die der Agent verwendet, oder deaktivieren Sie Suchwerkzeuge vollständig. „Verwaltet“ nutzt das Backend von Neppy (keine Einrichtung erforderlich). Parallel, Brave, Querit und Exa laufen direkt von Ihrem Gerät aus und verwenden Ihren API-Schlüssel.',
  ...
  'settings.search.engineManagedLabel': 'Neppy Verwaltet',
  'settings.search.engineManagedDesc':
    'Standard. Wird über das Neppy-Backend geleitet, aktuell betrieben von Exa: kein API-Schlüssel erforderlich.',
  'settings.search.localManagedUnavailable':
    'Die von Neppy verwaltete Suche ist für lokale Benutzer nicht verfügbar. Füge deinen eigenen Parallel-, Brave-, Querit- oder Exa-API-Schlüssel hinzu, um die Websuche zu aktivieren.',
  ...
  'settings.embeddings.requiresSignIn': 'Neppy-Anmeldung erforderlich',
  'settings.embeddings.managedLoginRequired':
    'Verwaltete Einbettungen erfordern eine Neppy-Anmeldung. Melde dich an, um das Neppy-Backend zu verwenden.',
  'settings.embeddings.managedBannerIntro':
    'Verwaltete Einbettungen laufen über das Neppy-Backend und erfordern eine Neppy-Kontositzung.',
  ...
  'settings.embeddings.managedBannerRemoteSession':
    'Melde dich erneut an, um deine Neppy-Sitzung zu aktualisieren, oder wechsle zu einem lokalen oder eigenen Einbettungsanbieter.',
  ...
  'devices.betaText':
    'Diese Funktion befindet sich derzeit in der Beta-Phase. Koppele iOS-Geräte mit diesem Neppy, um sie als Remote-Client zu verwenden.',
  ...
  'devices.emptyState':
    'Scanne einen QR-Code auf deinem iPhone, um es mit dieser Neppy-Sitzung zu verbinden.',
  ...
  'mcp.connectAuth.oauthHint':
    'Dieser Server verwendet OAuth. Melden Sie sich über Ihren Browser an, um Neppy zu autorisieren.',
  ...
  'autonomy.maxActionsHelp':
    'Maximale Anzahl von Tool-Aktionen, die ein Agent pro rollierender Stunde ausführen darf. Der neue Wert gilt ab dem nächsten Chat. Cron-Jobs und Kanal-Listener behalten ihr aktuelles Limit, bis Neppy neu gestartet wird.',
  ...
  'settings.tools.chooseCapabilities':
    'Wähle aus, welche Funktionen Neppy in deinem Namen nutzen kann.',
  ...
  'voice.providers.chip.cloud': 'Neppy (Verwaltet)',
  'voice.providers.chip.cloudAria': 'Verwalteter Neppy-Anbieter ist immer aktiv',
  ...
  'pttSettings.description':
    'Halte eine Taste gedrückt, um mit Neppy zu sprechen, während du eine andere App nutzt. Loslassen sendet die Aufnahme; wenn „Antworten vorlesen" aktiviert ist, antwortet Neppy per Sprachausgabe.',
  ...
  'pttSettings.errorAccessibility':
    'macOS benötigt für dieses Tastenkürzel die Bedienungshilfen-Berechtigung. Öffne Systemeinstellungen → Datenschutz & Sicherheit → Bedienungshilfen und aktiviere Neppy.',
  ...
  'pttSettings.errorUnsupportedWayland':
    'Wayland-Sitzungen unterstützen globale Tastenkürzel in Neppy noch nicht: wechsle zu einer X11-Sitzung oder nutze den In-App-Diktierschalter.',
  ...
  'chat.attachment.videoNotSupported':
    'Dieses Modell kann keine Videos lesen. Du kannst die Neppy-Stufe „Denkmodus“ verwenden, um dein Video anzuhängen.',
  ...
  'chat.attachment.imageNotSupported':
    'Dieses Modell kann keine Bilder lesen. Du kannst die Neppy-Stufe „Denkmodus“ verwenden, um dein Bild anzuhängen.',
  ...
  'bootCheck.desktopDescription':
    'Neppy benötigt eine Laufzeit zum Nachdenken. Wähle, wo es leben soll.',
  'bootCheck.webDescription':
    'Im Web stellt Neppy eine Verbindung zu einer von dir gesteuerten Laufzeit her. Gib unten den URL und das Authentifizierungstoken ein oder greife auf die Desktop-App zu, um eine direkt auf deinem Computer auszuführen.',
  ...
  'bootCheck.legacyDescription':
    'Auf diesem Gerät läuft bereits ein separat installierter Neppy-Daemon. Wir müssen es bereinigen, bevor die integrierte Laufzeit übernehmen kann.',
  ...
  'bootCheck.portConflictBody':
    'Ein anderer Prozess nutzt den Netzwerkport, den Neppy benötigt. Wir versuchen, das automatisch zu beheben.',
  ...
  'bootCheck.portConflictOwner':
    '{name} (PID {pid}) verwendet den Netzwerkport, den Neppy benötigt.',
  ...
  'welcome.gatewaySessionErrorFallback':
    'Die Anmeldung konnte gerade nicht abgeschlossen werden. Der Sitzungsspeicher hat nicht rechtzeitig geantwortet (auch nach erneutem Versuch). Bitte starten Sie Neppy neu und versuchen Sie es erneut.',
  ...
  'composio.expiredDescription':
    'Stellen Sie die Verbindung erneut her, um {name}-Tools erneut zu aktivieren. Neppy sorgt dafür, dass diese Integration nicht verfügbar bleibt, bis Sie den OAuth-Zugriff aktualisieren.',
  ...
  'mic.voiceNotCompiled':
    'Sprachtranskription ist in dieser App-Version nicht enthalten. Aktualisiere Neppy, um sie zu aktivieren.',
  ...
  'app.connectionIndicator.connected': 'Verbunden mit Neppy AI 🚀',
  ...
  'app.neppyLink.accounts.continueWith': 'Fahre mit der Anmeldung bei {label} fort',
  'app.neppyLink.accounts.done': 'Fertig',
  'app.neppyLink.accounts.intro': 'Einführung',
  'app.neppyLink.accounts.webviewNote': 'Webview-Hinweis',
  'app.neppyLink.billing.openDashboard': 'Dashboard öffnen',
  'app.neppyLink.billing.stayOnTrial': 'In der Testversion bleiben',
  'app.neppyLink.billing.trialCredit': 'Registrierungs-Credits',
  ...
  'app.neppyLink.discord.intro': 'Einführung',
  'app.neppyLink.discord.openInvite': 'Einladung öffnen',
  'app.neppyLink.discord.perk1': 'Vorteil1',
  'app.neppyLink.discord.perk2': 'Vorteil2',
  'app.neppyLink.discord.perk3': 'Vorteil3',
  'app.neppyLink.discord.perk4': 'Vorteil4',
  ...
  'app.neppyLink.discordReport.openDiscord': 'Discord öffnen',
  'app.neppyLink.done': 'Fertig',
  ...
  'app.neppyLink.notifications.permissionOff':
    'Die Benachrichtigungsberechtigung ist deaktiviert. Aktiviere Neppy in den Systemeinstellungen → Benachrichtigungen und versuche es erneut.',
  'app.neppyLink.notifications.triggerFailed':
    'Neppy konnte keine Systembenachrichtigung auslösen. Überprüfe die Benachrichtigungseinstellungen des Betriebssystems und versuche es erneut.',
  'app.neppyLink.notifications.welcomeBody':
    'Du erhältst hier Hinweise, wenn etwas deine Aufmerksamkeit erfordert.',
  'app.neppyLink.notifications.welcomeTitle': 'Neppy ist startklar',
  'app.neppyLink.status.closed': 'Geschlossen',
  'app.neppyLink.status.connected': 'Verbunden',
  'app.neppyLink.status.error': 'Fehler',
  'app.neppyLink.status.loading': 'Wird geladen…',
  'app.neppyLink.status.needsSignIn': 'Anmeldung erforderlich',
  'app.neppyLink.status.timedOut': 'Zeitüberschreitung',
  'app.neppyLink.loadingChannelSetup': 'Kanal-Setup wird geladen',
  'app.neppyLink.maybeLater': 'Vielleicht später',
  'app.neppyLink.notifications.asking': 'Frag dein Betriebssystem ...',
  'app.neppyLink.notifications.blocked': 'Blockiert',
  'app.neppyLink.notifications.blockedStep1': 'Schritt 1 blockiert',
  'app.neppyLink.notifications.blockedStep2': 'Schritt 2 blockiert',
  'app.neppyLink.notifications.blockedStep3': 'Schritt 3 blockiert',
  'app.neppyLink.notifications.intro': 'Einführung',
  'app.neppyLink.notifications.promptHint': 'Prompter Hinweis',
  'app.neppyLink.notifications.retry': 'Benachrichtigung zum erneuten Testversuch',
  'app.neppyLink.notifications.send': 'Testbenachrichtigung senden',
  'app.neppyLink.notifications.sendFailed': 'Konnte nicht gesendet werden: {error}',
  'app.neppyLink.notifications.sent':
    'Testbenachrichtigung gesendet. Wenn du sie nicht erhalten hast, gehe zu Systemeinstellungen → Benachrichtigungen → Neppy, aktiviere „Benachrichtigungen zulassen“ und stelle den Bannerstil auf „Persistent“ ein.',
  'app.neppyLink.skipForNow': 'Erstmal überspringen',
  'app.neppyLink.telegramUnavailable': 'Telegram nicht verfügbar',
  'app.neppyLink.title.accounts': 'Verbinde deine Apps',
  'app.neppyLink.title.billing': 'Abrechnung und Gutschriften',
  'app.neppyLink.title.discord': 'Tritt der Community bei',
  'app.neppyLink.title.discordReport': 'Diesen Fehler melden',
  'app.neppyLink.title.messaging': 'Verbinde einen Chat-Kanal',
  'app.neppyLink.title.notifications': 'Benachrichtigungen zulassen',
  ...
  'app.routeLoading.initializing': 'Neppy wird initialisiert...',
  'app.update.currentlyOn': '{version}',
  'app.update.downloadNow': 'Herunterladen',
  'app.update.downloadNote': 'Es wird nichts heruntergeladen, bis Sie es auswählen.',
  'app.update.errorFallback': 'Beim Update ist ein Fehler aufgetreten.',
  'app.update.header.available': 'Update verfügbar',
  ...
  'app.update.newVersionAvailable': 'Eine neue Version ist verfügbar.',
  ...
  'app.update.versionAvailable': 'Version {newVersion} ist verfügbar.',
  ...
  'channels.authMode.managed_dm': 'Mit Neppy anmelden',
  ...
  'channels.discord.authMode.oauth.description':
    'Installiere den Neppy-Bot über OAuth auf deinem Discord-Server.',
  'channels.discord.authMode.managed_dm.description':
    'Verknüpfe dein persönliches Discord-Konto mit dem Neppy-Bot.',
  ...
  'channels.connectHelp.discord':
    'Wähle unten eine Methode: verknüpfe dein Konto über Neppy, installiere den Bot per OAuth oder füge deinen eigenen Bot-Token aus dem Discord-Entwicklerportal ein.',
  'channels.connectHelp.telegram':
    'Wähle unten eine Methode: schreibe dem verwalteten Neppy-Bot, um ihn zu verknüpfen, oder füge deinen eigenen Bot-Token von @BotFather ein.',
  ...
  'iosPair.error.invalidQr':
    'Ungültiger QR-Code. Sicherstellen, dass ein Neppy-Kopplungscode gescannt wird.',
  ...
  'iosPair.instructions':
    "Öffne Neppy auf dem Desktop, gehe zu Einstellungen > Geräte und tippe auf 'Gerät koppeln', um den QR-Code anzuzeigen.",
  'iosPair.retryScan': 'Scan erneut versuchen',
  'iosPair.scanQrCode': 'Scannen QR code',
  'iosPair.scannerOpening': 'Scanner wird geöffnet...',
  'iosPair.step.openDesktop': 'Neppy auf dem Desktop öffnen',
  ...
  'composio.connect.permissionsNoteSuffix':
    'Die eigenen Agentenberechtigungen von Neppy werden unten als Lese-, Schreib- und Admin-Umschaltung gesteuert.',
  ...
  'composio.triggers.sessionExpired':
    'Deine Neppy-Sitzung ist abgelaufen. Melde dich erneut an, um Trigger zu laden.',
  ...
  'daemon.serviceBlockingGate.title': 'Neppy Kern ist nicht verfügbar',
  ...
  'intelligence.diagram.imageAlt': 'Zuletzt generiertes Neppy-Architekturdiagramm',
  ...
  'flows.nodeSummary.toolCall.pickNative': 'Führt ein Neppy-Tool aus (eines auswählen)',
  ...
  'rewards.community.activityStreakHint':
    'Aufeinanderfolgende Tage, an denen du auf Neppy aktiv warst.',
  ...
  'rewards.community.roleClaimDesc':
    'Du hast Discord-Rollen freigeschaltet, bist dem Neppy-Server aber noch nicht beigetreten. Tritt bei, damit sie automatisch zugewiesen werden.',
  ...
  'settings.ai.providers.managedDetail': 'Neppy wählt für jede Aufgabe ein Modell',
  ...
  'settings.ai.claudeCode.sandboxNoteMac':
    'Unter macOS bleibt ~/.neppy in beiden Modi durch die Sandbox geschützt.',
  ...
  'settings.ai.neppyDefault': 'Neppy (Standard)',
  ...
  'settings.ai.managedSourceLabel': 'Von Neppy verwaltet',
  ...
  'settings.ai.routing.managedDesc':
    'Neppy führt alle Inferenzen in der Cloud aus, wählt das beste Modell für die Aufgabe aus, optimiert die Kosten und behält die sichersten Routing-Standards bei.',
  'settings.ai.routing.managedMsg':
    'Neppy verarbeitet alle Rückschlüsse für jede Arbeitsbelastung und wählt automatisch die beste Route für Kosten, Qualität und Sicherheit.',
  ...
  'settings.composio.confirmWarning':
    'Deine vorhandenen Integrationen (Gmail, Slack, GitHub usw., die über Neppy verknüpft sind) sind nicht sichtbar – sie befinden sich im von Neppy verwalteten Composio-Mandanten.',
  ...
  'settings.composio.modeManaged': 'Verwaltet (Neppy erledigt das für dich)',
  'settings.composio.modeManagedDesc':
    'Neppy leitet Tool-Aufrufe über unser Backend weiter (empfohlen). Auth wird vermittelt; du fügst niemals einen Composio API-Schlüssel ein. Webhooks werden vollständig weitergeleitet.',
  ...
  'settings.developerMenu.tools.desc':
    'Aktiviere oder deaktiviere Funktionen, die Neppy in deinem Namen nutzen kann',
  ...
  'settings.developerMenu.mcpServer.desc':
    'Konfiguriere externe MCP-Clients für die Verbindung mit Neppy',
  ...
  'settings.agentAccess.tinyplaceAutopilot.desc':
    'Lass Neppy eigenständig auf tiny.place handeln: zeitgesteuert sucht es lohnende Arbeit – zuerst offene Bounties –, erledigt Passendes und handelt über deine Identität. Es läuft unbeaufsichtigt und kann Geld ausgeben; nutze beim Testen devnet. Standardmäßig aus.',
  ...
  'settings.mascot.colorAria': 'Neppy Farbe',
  ...
  'settings.mascot.libraryUnavailable': 'Neppy Bibliothek nicht verfügbar',
  'settings.mascot.title': 'Neppy',
  'settings.mascot.loadingLibrary': 'Neppy-Bibliothek wird geladen…',
  ...
  'settings.mascot.localDefault': 'Lokal Neppy (Standard)',
  ...
  'settings.mascot.noCharacters': 'Es sind noch keine Neppy Zeichen verfügbar',
  ...
  'settings.memoryWindow.description':
    'Wie viel gespeicherter Kontext Neppy in jede neue Agentenausführung eingefügt wird. Bei größeren Fenstern ist man sich früherer Gespräche besser bewusst, verbraucht aber bei jedem Durchlauf mehr Token – und kostet mehr.',
  ...
  'skills.create.scopeUserHint':
    'Geschrieben an ~/.neppy/skills/<slug>/SKILL.md – verfügbar in allen Arbeitsbereichen.',
  ...
  'skills.install.errors.writeFailedHint':
    'Das Workspace-Skills-Verzeichnis war nicht beschreibbar. Überprüfen Sie die Dateisystemberechtigungen für „<workspace>/.neppy/skills/“.',
  ...
  'skills.meetingBots.bannerDesc':
    'Lege einen Google Meet-Link ab und Neppy tritt als Gast bei, spricht, hört zu und winkt zurück.',
  'skills.meetingBots.bannerTitle': 'Sende Neppy an eine Besprechung',
  'skills.meetingBots.busyTitle': 'Neppy ist beschäftigt',
  'skills.meetingBots.comingSoon': 'Kommt bald',
  'skills.meetingBots.couldNotLeaveTitle': 'Meeting konnte nicht verlassen werden',
  'skills.meetingBots.couldNotStartTitle': 'Neppy konnte nicht gestartet werden',
  'skills.meetingBots.displayName': 'Anzeigename',
  'skills.meetingBots.failedToStart': 'Neppy konnte nicht gestartet werden.',
  'skills.meetingBots.joiningMessage': 'Es sollte in wenigen Sekunden als Teilnehmer erscheinen.',
  'skills.meetingBots.joiningTitle': 'Neppy nimmt an der Besprechung teil',
  'skills.meetingBots.meetingLink': 'Link zum Treffen',
  'skills.meetingBots.modalAriaLabel': 'Sende Neppy an eine Besprechung',
  'skills.meetingBots.modalDesc':
    'Neppy tritt als anonymer Gast bei, streamt sein Video in den Anruf und antwortet über den Agenten.',
  'skills.meetingBots.modalTitle': 'Sende Neppy an eine Besprechung',
  ...
  'skills.meetingBots.serverOverloaded':
    'Neppy ist gerade stark ausgelastet. Bitte versuche es in ein paar Minuten erneut.',
  ...
  'skills.meetingBots.history.runWithNeppy': 'Mit Neppy ausführen',
  ...
  'skills.meetingBots.defaults.watchCalendarDesc':
    'Lassen Sie Neppy Ihren verbundenen Kalender überwachen, damit er Meetings automatisch beitreten oder Sie gemäß den folgenden Richtlinien dazu auffordern kann. Dies ist von Meeting-Erinnerungsbenachrichtigungen getrennt.',
  ...
  'walkthrough.steps.brainTab.content':
    'Brain ist der Wissensgraph: Hier prüfst du, was Neppy weiß und wie Ideen verbunden sind.',
  ...
  'settings.mascot.noCharactersAvailable': 'Es sind noch keine Neppy Zeichen verfügbar',
  ...
  'harnessInit.subtitle': 'Neppy bereitet beim ersten Start benötigte Komponenten vor.',
  ...
  'harnessInit.failedMessage':
    'Einige Einrichtungsschritte wurden nicht abgeschlossen. Du kannst es erneut versuchen oder fortfahren: Neppy verwendet dann eine integrierte Ausweichlösung.',
  ...
  'harnessInit.backgroundHint':
    'Du kannst Neppy weiter verwenden, während dies abgeschlossen wird.',

  'keyring.consent.title': 'Sicherer Speicher nicht verfügbar',
  'keyring.consent.description':
    'Der Schlüsselbund Ihres Betriebssystems ist nicht erreichbar. Neppy benötigt Ihre Erlaubnis, Geheimnisse stattdessen in einem lokal verschlüsselten Speicher abzulegen.',
  ...
  'memory.health.remediation.auth_missing':
    'Keine Embeddings-Anmeldedaten gefunden. Melde dich bei Neppy an oder richte lokale Ollama-Embeddings unter Verbindungen → API-Schlüssel → Einbettungen ein.',
  ...
  'memory.health.remediation.storage_unavailable':
    'Neppy kann nicht in seinen Speicher schreiben: die Festplatte oder SD-Karte scheint defekt, voll oder schreibgeschützt zu sein. Überprüfe das Laufwerk und gib Speicherplatz frei; die Speicherverarbeitung wird automatisch fortgesetzt, sobald der Speicher wieder beschreibbar ist.',
  ...
  'onboarding.custom.vault.defaultDesc':
    'Von Neppy verwaltete Standardspeichereinstellungen verwenden. Vault-Pfad und Synchronisierungsstatus können später eingesehen werden.',
  ...
  'onboarding.custom.vault.localDisabledReason':
    'Die verwaltete Einrichtung erfordert eine Neppy-Anmeldung und ist im lokalen Modus nicht verfügbar.',
  ...
  'vaultHealth.writableLabel': 'Vault ist durch Neppy beschreibbar',
  'vaultHealth.writableRecovery':
    'Neppy kann noch nicht in diesen Vault schreiben. Schreibberechtigungen erteilen und aktualisieren.',
  ...
  'memoryData.workspaceVaultDesc':
    'Neppy schreibt generierte Speichernotizen nach memory_tree/content.',
  ...
  'memoryData.internalFilesDesc':
    'Indizes, Warteschlangenstatus und Zusammenfassungen werden von Neppy verwaltet, um Erinnerung und Synchronisierung fehlerfrei zu halten.',
  ...
  'settings.gateway.description':
    'Der Kern kann in einem Container laufen, auf einem anderen Rechner über SSH oder in einem Container auf einem anderen Rechner. Neppy startet ihn, verbindet sich und fährt ihn herunter, sobald du wechselst.',
  ...
  'settings.ai.mlx': 'MLX',
  'mlx.description':
    'Neppy startet und überwacht MLX-Server für dich. Jeder Server ist ein [[mlx.server]]-Block in deiner Konfigurationsdatei, in der auch seine Parameter stehen.',
  'mlx.disabledNotice':
  ...
  'mlx.noModelLoaded': 'Kein Modell geladen',
  'mlx.start': 'Starten',
  'mlx.stop': 'Stoppen',
  'mlx.restart': 'Neu starten',
  'mlx.unload': 'Speicher freigeben',
  'mlx.showDetails': 'Details',
  'mlx.hideDetails': 'Details ausblenden',
  'mlx.command': 'Befehl',
  'mlx.logs': 'Letzte Ausgabe',
  'mlx.noLogs': 'Noch keine Ausgabe.',
  'mlx.availableModels': 'Verfügbare Modelle ({count})',
  'mlx.state.stopped': 'Gestoppt',
  'mlx.state.starting': 'Startet',
