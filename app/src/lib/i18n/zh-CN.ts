...
const messages: TranslationMap = {
  ...
  'share.defaultHeadline': '看看我的 Neppy 智能体刚刚做了什么',
  'share.defaultAgentName': '我的智能体',
  'share.defaultCaption': '看看我的 Neppy 智能体刚刚做了什么。',
  'share.captionWithHeadline': '{headline}。由我的 Neppy 智能体制作。',
  ...
  'feedback.welcome.body':
    '告诉我们什么行得通、缺少什么，以及怎样能让 Neppy 变得更好。发布一个想法，为他人的建议投票，看着最棒的那些一路升到我们路线图的顶端。',
  ...
  'rewards.welcome.body':
    '在使用 Neppy 和邀请他人的过程中赚取积分，保持你的连续记录不断，并兑换你所赚取的一切：全部在一处追踪。',
  ...
  'settings.core.applyRestartNote': '保存后 Neppy 将重启以重新连接。',
  ...
  'conversations.toolFailure.serviceUnavailable.cause': 'Neppy 需要的某项服务暂时不可用。',
  'conversations.toolFailure.serviceUnavailable.next': 'Neppy 稍后会重试：无需任何操作。',
  ...
  'conversations.toolFailure.modelConnection.cause': 'Neppy 无法连接到 AI 模型。',
  'conversations.toolFailure.modelConnection.next':
    '请检查你的网络连接或模型设置；Neppy 将会重试。',
  'conversations.toolFailure.timeout.cause': '操作耗时过长，已被停止。',
  'conversations.toolFailure.timeout.next': 'Neppy 会重试，你也可以手动重试。',
  ...
  'conversations.toolFailure.approvalExpired.next': '再次提出以执行它：Neppy 不会自行重试。',
  ...
  'orchPage.medulla.tagline': 'Neppy 的编排模型',
  'orchPage.medulla.body':
    'Medulla 是 Neppy 从零打造的自研大语言模型，专为同时编排数千个智能体而设计：具备 1000 万 token 的上下文窗口和极低成本的编排能力。',
  'orchPage.medulla.featAgents': '数千个智能体',
  'orchPage.medulla.featContext': '10M token 上下文',
  'orchPage.medulla.featCost': '低成本编排',
  'orchPage.medulla.subscriberTitle': 'Neppy 订阅用户',
  'orchPage.medulla.subscriberNote': 'Medulla 上线后将仅面向 Neppy 订阅用户开放。',
  ...
  'orchPage.connections.initDesc':
    '启动一个新的子智能体与你协作。打开智能体聊天，描述它的角色、目标和所需工具：Neppy 会创建一个专属实例，你可以在这里进行操控。',
  ...
  'tinyplaceOrchestration.master.preview': '你和 Neppy 之间的直接协调。',
  ...
  'tinyplaceOrchestration.composer.placeholder': '给 Neppy 发消息…',
  ...
  'welcome.resetErrorFallback': '无法清除应用数据。请退出并重新打开 Neppy，然后重试。',
  ...
  'home.statusCoreUnreachable': '本地核心 sidecar 无响应。Neppy 后台进程可能已崩溃或未能启动。',
  ...
  'skills.explorer.emptyDescription':
    '安装 SKILL.md 包，或将 Hermes 风格的文件夹放到 ~/.neppy/skills 下。',
  ...
  'onboarding.finishDesc': '一切就绪！开始使用 Neppy。',
  'onboarding.skip': '跳过',
  'onboarding.getStarted': '开始使用',
  'onboarding.runtimeChoice.title': '你希望如何运行 Neppy？',
  'onboarding.runtimeChoice.subtitle': '选择最适合你的设置。之后可在设置中更改。',
  'onboarding.runtimeChoice.cloud.title': '简单模式',
  'onboarding.runtimeChoice.cloud.tagline': '让 Neppy 为你管理一切。',
  ...
  'onboarding.custom.defaultSubtitle': '让 Neppy 为你管理。',
  ...
  'onboarding.custom.inference.defaultDesc':
    'Neppy 会为每种工作负载路由到合适的默认模型。无需密钥，无需设置。',
  ...
  'onboarding.custom.voice.defaultDesc': 'Neppy 内置托管的 STT/TTS，开箱即用。无需额外配置。',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'Neppy 使用托管的 Composio 工作区。之后每个服务都可一键连接。',
  'onboarding.custom.oauth.configureDesc':
    '使用你自己的 Composio 账户或 API 密钥。在设置 › 连接中配置。',
  'onboarding.custom.search.title': '网页搜索',
  'onboarding.custom.search.subtitle': 'Neppy 如何代表你搜索网页。',
  'onboarding.custom.search.defaultDesc': 'Neppy 使用托管搜索后端。无需密钥。',
  'onboarding.custom.search.configureDesc':
    '使用你自己的搜索提供商密钥（Tavily、Brave 等）。在设置 › 工具中配置。',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle': 'Neppy 生成向量嵌入以实现语义记忆搜索的方式。',
  'onboarding.custom.embeddings.defaultDesc': 'Neppy 使用托管嵌入服务，无需 API 密钥。',
  'onboarding.custom.embeddings.configureDesc':
    '使用您自己的嵌入服务提供商（OpenAI、Voyage、Ollama 等）。',
  'onboarding.custom.memory.title': '记忆',
  'onboarding.custom.memory.subtitle': 'Neppy 如何记住你的上下文、偏好和历史对话。',
  'onboarding.custom.memory.defaultDesc': 'Neppy 会自动管理记忆存储和检索。无需设置。',
  ...
  'privacy.shareAnonymizedDataDesc':
    '通过分享受隐私限制的崩溃报告和使用事件来帮助改进 Neppy，其中包括稳定的账号 ID 和应用版本元数据。我们绝不会收集消息、钱包密钥、API 密钥或会话令牌。',
  'privacy.meetingFollowUps': '会议跟进',
  'privacy.autoHandoffMeet': '自动将 Google Meet 转录交给编排器',
  'privacy.autoHandoffMeetDesc':
    '当 Google Meet 通话结束时，Neppy 的编排器可以阅读转录内容，并可能执行起草消息、安排跟进、或将摘要发布到已连接的 Slack 工作区等操作。默认关闭。',
  ...
  'settings.about.starCta.title': '喜欢 Neppy 吗？',
  ...
  'settings.search.menuDesc': '默认使用 Neppy 托管搜索，或用 API 密钥接入你自己的提供商。',
  'settings.search.description':
    '选择智能体使用的搜索引擎。托管模式使用 Neppy 后端（无需设置）。Parallel、Brave、Querit 和 Exa 会用你的 API 密钥从本机直接调用。',
  'settings.search.engineAria': '搜索引擎',
  'settings.search.engineDisabledLabel': 'Disabled',
  'settings.search.engineDisabledDesc': '从智能体上下文和可用工具列表中移除搜索工具。',
  'settings.search.engineManagedLabel': 'Neppy 托管',
  'settings.search.engineManagedDesc':
    '默认选项。通过 Neppy 后端路由，当前由 Exa 提供支持，无需 API 密钥。',
  'settings.search.localManagedUnavailable':
    '本地用户无法使用 Neppy 托管搜索。请添加你自己的 Parallel、Brave、Querit 或 Exa API 密钥以启用网页搜索。',
  ...
  'settings.embeddings.managedBannerRemoteSession':
    '重新登录以刷新 Neppy 会话，或切换到本地/自带密钥的嵌入提供商。',
  ...
  'devices.pairModal.instructions': '打开 iPhone 上的 Neppy 应用程序并扫描此代码。',
  ...
  'mcp.connectAuth.oauthHint': '此服务器使用 OAuth。请通过浏览器登录以授权 Neppy。',
  ...
  'autonomy.maxActionsHelp':
    '智能体每滚动小时内可执行的最大工具操作次数。新值将在下次对话时生效。定时任务和频道监听器将保持当前限制，直到重启 Neppy。',
  ...
  'settings.tools.chooseCapabilities': '选择 Neppy 可代表你使用的能力。',
  ...
  'voice.providers.chip.cloud': 'Neppy（托管）',
  'voice.providers.chip.cloudAria': 'Neppy 托管服务商始终启用',
  ...
  'pttSettings.description':
    '在其他应用中时，按住按键即可与 Neppy 对话。松开按键发送录音；若已开启「朗读回复」，Neppy 会用语音读出回复。',
  ...
  'pttSettings.errorAccessibility':
    '此快捷键需要 macOS 的辅助功能权限。请打开系统设置 → 隐私与安全 → 辅助功能，并启用 Neppy。',
  'pttSettings.errorShortcutInUse': '该快捷键已被其他应用占用。请选择其他快捷键。',
  'pttSettings.errorUnsupportedWayland':
    'Wayland 会话尚不支持 Neppy 的全局快捷键：请切换到 X11 会话，或使用应用内的听写开关。',
  ...
  'chat.attachment.imageNotSupported':
    '此模型无法读取图像。您可以使用 Neppy 推理层级来附加您的图像。',
  ...
  'bootCheck.desktopDescription': 'Neppy 需要一个运行中的核心才能工作。请选择连接方式。',
  'bootCheck.webDescription':
    '网页版 Neppy 连接到由你控制的远程核心。请输入其 URL 和认证令牌，或安装桌面版在本地运行核心。',
  ...
  'bootCheck.legacyDescription':
    '此设备上正在运行一个单独安装的 Neppy 守护进程。必须先将其移除，嵌入式核心才能接管。',
  ...
  'welcome.gatewaySessionErrorFallback':
    '目前无法完成登录。会话存储未及时响应（即使重试后也是如此）。请重新启动 Neppy 并重试。',
  ...
  'composio.expiredDescription':
    '重新连接以重新启用 {name} 工具。 Neppy 将保持此集成不可用，直到您刷新 OAuth 访问权限。',
  ...
  'mic.voiceNotCompiled': '此版本的应用未包含语音转文字功能。请更新 Neppy 后再使用。',
  ...
  'app.connectionIndicator.connected': '已连接到 Neppy AI',
  ...
  'app.neppyLink.accounts.continueWith': '使用 {label} 登录继续',
  'app.neppyLink.accounts.done': '完成',
  'app.neppyLink.accounts.intro': '简介',
  'app.neppyLink.accounts.webviewNote': '网页视图说明',
  'app.neppyLink.billing.openDashboard': '打开控制台',
  'app.neppyLink.billing.stayOnTrial': '继续试用',
  'app.neppyLink.billing.trialCredit': '注册额度',
  'app.neppyLink.billing.trialDesc': '额度优惠可能因促销活动和账号资格而异。',
  'app.neppyLink.defaultBody': '弹窗中尚未就绪。完成后打开完整设置页面',
  'app.neppyLink.discord.intro': '简介',
  'app.neppyLink.discord.openInvite': '打开邀请',
  'app.neppyLink.discord.perk1': '福利 1',
  'app.neppyLink.discord.perk2': '福利 2',
  'app.neppyLink.discord.perk3': '福利 3',
  'app.neppyLink.discord.perk4': '福利 4',
  ...
  'app.neppyLink.notifications.triggerFailed':
    'Neppy 无法触发系统通知。请检查操作系统的通知设置，然后重试。',
  'app.neppyLink.notifications.welcomeBody': '当有事情需要您关注时，您将在此处收到提醒。',
  'app.neppyLink.notifications.welcomeTitle': 'Neppy 已准备就绪',
  'app.neppyLink.status.closed': '已关闭',
  'app.neppyLink.status.connected': '已连接',
  'app.neppyLink.status.error': '错误',
  'app.neppyLink.status.loading': '加载中…',
  'app.neppyLink.status.needsSignIn': '需要登录',
  'app.neppyLink.status.timedOut': '已超时',
  'app.neppyLink.loadingChannelSetup': '正在加载渠道设置',
  'app.neppyLink.maybeLater': '稍后再说',
  'app.neppyLink.notifications.asking': '正在请求系统权限…',
  'app.neppyLink.notifications.blocked': '已被阻止',
  'app.neppyLink.notifications.blockedStep1': '打开系统设置',
  'app.neppyLink.notifications.blockedStep2': '找到 Neppy',
  'app.neppyLink.notifications.blockedStep3': '开启通知权限',
  'app.neppyLink.notifications.intro': '简介',
  'app.neppyLink.notifications.promptHint': '提示',
  'app.neppyLink.notifications.retry': '重试测试通知',
  'app.neppyLink.notifications.send': '发送测试通知',
  'app.neppyLink.notifications.sendFailed': '无法发送：{error}',
  'app.neppyLink.notifications.sent':
    '测试通知已发送。如果未收到，请前往「系统设置 → 通知 → Neppy」，开启「允许通知」并将横幅样式设置为「持续」。',
  'app.neppyLink.skipForNow': '暂时跳过',
  'app.neppyLink.telegramUnavailable': 'Telegram 不可用',
  'app.neppyLink.title.accounts': '连接你的应用',
  'app.neppyLink.title.billing': '账单与配额',
  'app.neppyLink.title.discord': '加入社区',
  'app.neppyLink.title.discordReport': '报告此错误',
  'app.neppyLink.title.messaging': '连接聊天渠道',
  'app.neppyLink.title.notifications': '允许通知',
  ...
  'app.routeLoading.initializing': '正在初始化 Neppy...',
  'app.update.currentlyOn': '{version}',
  'app.update.downloadNow': '下载',
  'app.update.downloadNote': '在你选择之前不会下载任何内容。',
  'app.update.errorFallback': '更新时出现问题。',
  'app.update.header.available': '有可用更新',
  ...
  'app.update.versionAvailable': '版本 {newVersion} 可用。',
  ...
  'channels.web.proactiveTitle': '主动消息',
  'channels.web.proactiveAlways': '简报、提醒和定时结果始终先送达这里。网页聊天无法关闭。',
  'channels.web.proactiveMirror': '同时会向 {channel} 发送一份副本。',
  'channels.web.proactiveNoMirror': '没有其他频道接收副本。',
  ...
  'channels.authMode.managed_dm': '使用 Neppy 登录',
  ...
  'channels.discord.authMode.oauth.description':
    '通过 OAuth 将 Neppy 机器人安装到你的 Discord 服务器。',
  'channels.discord.authMode.managed_dm.description':
    '将你的个人 Discord 账户关联到 Neppy 机器人。',
  ...
  'channels.telegram.authMode.managed_dm.description': '直接向 Neppy Telegram 机器人发送消息。',
  ...
  'channels.connectHelp.discord':
    '在下方选择一种方式：通过 Neppy 关联你的账号、用 OAuth 安装机器人，或粘贴你在 Discord 开发者门户中的机器人令牌。',
  'channels.connectHelp.telegram':
    '在下方选择一种方式：给托管的 Neppy 机器人发消息以完成关联，或粘贴你在 @BotFather 获取的机器人令牌。',
  ...
  'iosPair.step.openDesktop': '在桌面上打开 Neppy',
  ...
  'composio.connect.permissionsNoteSuffix':
    'Neppy 自身的智能体权限通过下方的读取、写入和管理员开关控制。',
  ...
  'composio.triggers.sessionExpired': '你的 Neppy 会话已过期。请重新登录以加载触发器。',
  ...
  'daemon.serviceBlockingGate.title': 'Neppy 核心不可用',
  ...
  'intelligence.diagram.imageAlt': '最新生成的 Neppy 架构图',
  ...
  'flows.nodeSummary.toolCall.pickNative': '运行一个 Neppy 工具（请选择一个）',
  ...
  'rewards.community.activityStreakHint': '你在 Neppy 连续活跃的天数。',
  ...
  'rewards.community.roleClaimDesc':
    '你已解锁 Discord 身份组，但尚未加入 Neppy 服务器。加入后将自动为你分配。',
  ...
  'settings.ai.providers.managedDetail': 'Neppy 会为每项任务选择模型',
  ...
  'settings.ai.claudeCode.sandboxNoteMac': '在 macOS 上，两种模式下 ~/.neppy 都受沙盒保护。',
  ...
  'settings.ai.neppyDefault': 'Neppy（默认）',
  ...
  'settings.ai.managedSourceLabel': '由 Neppy 管理',
  ...
  'settings.ai.routing.managedDesc':
    'Neppy 会在云端运行所有推理，为任务选择最佳模型，优化成本，并保持最安全的路由默认值。',
  'settings.ai.routing.managedMsg':
    'Neppy 会处理每个工作负载的全部推理，并自动选择兼顾成本、质量和安全性的最佳路线。',
  ...
  'settings.composio.confirmWarning':
    '你现有的集成（通过 Neppy 关联的 Gmail、Slack、GitHub 等）将不可见：它们存放在 Neppy 托管的 Composio 租户中。',
  ...
  'settings.composio.modeManaged': '托管（由 Neppy 管理）',
  'settings.composio.modeManagedDesc':
    'Neppy 通过我们的后端代理工具调用（推荐）。认证由我们处理，你无需粘贴 Composio API 密钥。Webhook 完全路由。',
  ...
  'settings.developerMenu.tools.desc': '启用或停用 Neppy 可代表你使用的能力',
  ...
  'settings.developerMenu.mcpServer.desc': '配置外部 MCP 客户端以连接到 Neppy',
  ...
  'settings.agentAccess.tinyplaceAutopilot.desc':
    '让 Neppy 自行在 tiny.place 上行动：按计划寻找有价值的工作（优先开放的悬赏），完成符合其技能的任务，并以你的身份行动。它在无人监督下运行且可以花费资金，测试时请使用 devnet。默认关闭。',
  ...
  'settings.mascot.characterDesc': '选择你的 Neppy 角色',
  ...
  'settings.mascot.colorAria': 'Neppy 颜色',
  ...
  'settings.memoryWindow.description':
    'Neppy 在每次新的智能体运行中注入多少记忆上下文。更大的窗口对过往对话更有感知，但每次运行会消耗更多 token，成本也更高。',
  ...
  'skills.create.scopeUserHint': '写入 ~/.neppy/skills/<slug>/SKILL.md：在所有工作空间中可用。',
  ...
  'skills.meetingBots.bannerDesc': '让 Neppy 加入你的会议，自动记录摘要',
  'skills.meetingBots.bannerTitle': '会议机器人',
  'skills.meetingBots.busyTitle': 'Neppy 正忙',
  'skills.meetingBots.comingSoon': '即将推出',
  'skills.meetingBots.couldNotLeaveTitle': '无法离开会议',
  'skills.meetingBots.couldNotStartTitle': '无法启动 Neppy',
  'skills.meetingBots.displayName': '显示名称',
  'skills.meetingBots.failedToStart': '启动 Neppy 失败。',
  'skills.meetingBots.joiningMessage': '它应该在几秒钟内作为参会者出现。',
  'skills.meetingBots.joiningTitle': 'Neppy 正在加入会议',
  'skills.meetingBots.meetingLink': '会议链接',
  'skills.meetingBots.modalAriaLabel': '将 Neppy 发送到会议',
  'skills.meetingBots.modalDesc': '输入会议链接，让 Neppy 作为参会者加入并记录内容。',
  'skills.meetingBots.modalTitle': '将 Neppy 发送到会议',
  ...
  'skills.meetingBots.serverOverloaded': 'Neppy 当前负载过高，请几分钟后重试。',
  ...
  'skills.meetingBots.history.runWithNeppy': '使用 Neppy 运行',
  ...
  'skills.meetingBots.defaults.watchCalendarDesc':
    '让 Neppy 监控您连接的日历，以便根据以下策略自动加入会议或提示参加会议。这与会议提醒通知是分开的。',
  ...
  'walkthrough.steps.brainTab.content':
    'Brain 是记忆图谱，用来查看 Neppy 知道什么，以及想法如何相互连接。',
  ...
  'settings.mascot.noCharactersAvailable': '暂无可用的 Neppy 角色',
  ...
  'devOptions.menuToolsDesc': '启用或禁用 Neppy 可代表你使用的能力',
  ...
  'harnessInit.subtitle': 'Neppy 正在准备首次启动所需的组件。',
  ...
  'harnessInit.backgroundHint': '在此完成期间，你可以继续使用 Neppy。',

  'keyring.consent.title': '安全存储不可用',
  'keyring.consent.description':
    '您的操作系统密钥链不可访问。Neppy 需要您的许可，以便使用本地加密存储来保存密钥。',
  ...
  'memory.health.remediation.auth_missing':
    '未找到嵌入凭据。请登录 Neppy，或在连接 → API 密钥 → 向量嵌入 中设置本地 Ollama 嵌入。',
  ...
  'memory.health.remediation.storage_unavailable':
    'Neppy 无法写入其记忆存储：磁盘或 SD 卡似乎已损坏、已满或为只读。请检查驱动器并释放空间；存储恢复可写后，记忆处理将自动继续。',
  ...
  'onboarding.custom.vault.defaultDesc':
    '使用 Neppy 托管的记忆默认设置。保险库路径和同步健康状态仍可稍后查看。',
  'onboarding.custom.vault.configureDesc': '立即查看保险库所有权、运行健康检查并调整记忆控制。',
  'onboarding.custom.vault.localDisabledReason': '托管设置需要登录 Neppy，在本地模式下不可用。',
  ...
  'vaultHealth.writableLabel': 'Neppy 可写入保险库',
  'vaultHealth.writableRecovery': 'Neppy 暂时无法写入此保险库。请授予写入权限后刷新。',
  ...
  'memoryData.workspaceVaultDesc': 'Neppy 将生成的记忆笔记写入 memory_tree/content。',
  ...
  'settings.gateway.description':
    '内核可以在容器中运行，也可以通过 SSH 在另一台机器上运行，或者在另一台机器的容器中运行。Neppy 会启动它、连接它，并在你切换到别处时把它关闭。',
  ...
  'settings.ai.mlx': 'MLX',
  'mlx.description':
    'Neppy 会替你启动并监控 MLX 服务器。每个服务器对应配置文件中的一个 [[mlx.server]] 配置块，其参数也写在那里。',
  'mlx.disabledNotice':
    'MLX 运行环境已关闭。请在配置文件中把 mlx.enabled 设为 true，Neppy 才能启动这些服务器。',
  'mlx.problemsTitle': '配置问题',
  'mlx.preset.title': '运行预设',
  ...
  'mlx.noModelLoaded': '未加载模型',
  'mlx.start': '启动',
  'mlx.stop': '停止',
  'mlx.restart': '重启',
  'mlx.unload': '释放内存',
  'mlx.showDetails': '详情',
  'mlx.hideDetails': '隐藏详情',
  'mlx.command': '命令',
  'mlx.logs': '最近输出',
  'mlx.noLogs': '暂无输出。',
  'mlx.availableModels': '可用模型（{count}）',
  'mlx.state.stopped': '已停止',
  'mlx.state.starting': '启动中',
  'mlx.state.ready': '就绪',
  ...
  'mlx.modelsLabel': '模型',
  'mlx.modelsHint': '勾选此服务器要加载的模型。一个服务器可同时持有多个，每种用途一个。',
  'mlx.noCachedModels': '尚未下载任何模型。',
  'mlx.slotLabel': '用途',
  'mlx.slot.model': '聊天',
  'mlx.slot.embedding': '向量',
  'mlx.slot.stt': '语音转文字',
  'mlx.slot.tts': '文字转语音',
  'mlx.slot.reranker': '重排序',
  'mlx.slot.image': '图像',
  'mlx.params.generation': '生成',
  'chat.thinking.label': '思考',
  'chat.thinking.auto': '自动',
  'chat.thinking.quick': '快速',
  'chat.thinking.balanced': '平衡',
  'chat.thinking.thorough': '深入',
  'mlx.params.reasoning': '推理',
  'mlx.params.memory': '内存与速度',
  'mlx.params.speculative': '投机解码',
  'mlx.params.process': '进程',
  'mlx.params.zeroIsDefault': '填 0 表示沿用服务器默认值。',
  'mlx.params.negativeIsDefault': '填负数表示沿用服务器默认值。',
  'mlx.params.kvBits': 'KV 缓存位数。0 表示不量化，3.5 选用 TurboQuant。',
  'mlx.params.maxNumSeqs': '同时解码的请求数，其余排队，可限制内存峰值。0 表示不限。',
  'mlx.params.draftModel': '用于为主模型预先起草 token 的小模型。',
  'mlx.params.draftKind': 'dflash、eagle3 或 mtp。留空则自动识别。',
  'mlx.params.port': '填 0 会在启动时分配空闲端口，运行后写回这里。',
  'mlx.params.allowLan': '关闭时服务器仅限本机访问。',
  'mlx.params.trustRemoteCode': '会运行模型附带的代码。除非信任来源，否则请保持关闭。',
  'mlx.embeddingsLabel': '向量',
  'mlx.embeddingsOllama': 'Ollama (bge-m3)',
  'mlx.embeddingsMlx': 'MLX',
  'mlx.embeddingsHint': 'Ollama 会保留记忆中已有的向量。MLX 需要 1024 维的模型。',
};
