...
const messages: TranslationMap = {
  ...
  'share.defaultHeadline': 'Guarda cosa ha appena fatto il mio agente Neppy',
  'share.defaultAgentName': 'Il mio agente',
  'share.defaultCaption': 'Guarda cosa ha appena fatto il mio agente Neppy.',
  'share.captionWithHeadline': '{headline}. Realizzato con il mio agente Neppy.',
  ...
  'feedback.welcome.body':
    'Dicci cosa funziona, cosa manca e cosa renderebbe Neppy migliore. Pubblica un’idea, vota le proposte degli altri e guarda le migliori salire in cima alla nostra roadmap.',
  ...
  'rewards.welcome.body':
    'Guadagna punti usando Neppy e invitando altri, mantieni viva la tua serie e riscatta ciò che hai guadagnato, tutto tracciato in un unico posto.',
  ...
  'settings.core.applyRestartNote': 'Il salvataggio riavvia Neppy per riconnettersi.',
  ...
  'conversations.toolFailure.serviceUnavailable.cause':
    'Un servizio necessario a Neppy è temporaneamente non disponibile.',
  'conversations.toolFailure.serviceUnavailable.next':
    'Neppy riproverà a breve: non serve fare nulla.',
  ...
  'conversations.toolFailure.modelConnection.cause':
    'Neppy non è riuscito a raggiungere il modello di IA.',
  ...
  'conversations.toolFailure.approvalExpired.next':
    'Richiedila di nuovo per eseguirla: Neppy non riproverà da solo.',
  ...
  'orchPage.medulla.tagline': 'Il modello di orchestrazione di Neppy',
  'orchPage.medulla.body':
    "Medulla è l'LLM sviluppato internamente da Neppy, progettato per orchestrare migliaia di agenti in una sola volta, con una finestra di contesto da 10 milioni di token e un'orchestrazione a costi radicalmente ridotti.",
  ...
  'orchPage.medulla.subscriberTitle': 'Abbonati Neppy',
  'orchPage.medulla.subscriberNote':
    'Quando Medulla sarà disponibile, sarà esclusiva per gli abbonati Neppy.',
  ...
  'orchPage.connections.initDesc':
    "Avvia un nuovo sotto-agente che lavori al tuo fianco. Apri la chat dell'agente e descrivi ruolo, obiettivo e strumenti: Neppy fornisce un'istanza dedicata che puoi guidare da qui.",
  ...
  'tinyplaceOrchestration.master.preview': 'Coordinamento diretto tra te e Neppy.',
  ...
  'tinyplaceOrchestration.composer.placeholder': 'Messaggio a Neppy…',
  ...
  'welcome.title': 'Benvenuto in Neppy',
  'welcome.subtitle':
  ...
  'welcome.resetErrorFallback':
    "Impossibile cancellare i dati dell'app. Chiudi e riapri Neppy, poi riprova.",
  ...
  'home.statusCoreUnreachable':
    'Il sidecar core locale non risponde. Il processo in background di Neppy potrebbe essersi bloccato o non essere partito.',
  ...
  'skills.explorer.emptyDescription':
    'Installa un pacchetto SKILL.md o inserisci cartelle in stile Hermes in ~/.neppy/skills.',
  ...
  'rewards.localUnavailable':
    "L'accesso locale non guadagna ricompense, coupon o credito referral. Esci e continua accedendo con un account Neppy se vuoi che le ricompense vengano conteggiate.",
  ...
  'onboarding.welcome': 'Ciao. Sono Neppy.',
  ...
  'onboarding.finishDesc': 'Tutto pronto! Inizia a usare Neppy.',
  'onboarding.skip': 'Salta',
  'onboarding.getStarted': 'Inizia',
  'onboarding.runtimeChoice.title': 'Come vuoi eseguire Neppy?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Lascia che Neppy gestisca tutto per te.',
  ...
  'onboarding.custom.defaultSubtitle': 'Lascia che Neppy lo gestisca per te.',
  ...
  'onboarding.custom.inference.defaultDesc':
    'Neppy instrada ogni carico di lavoro a un modello predefinito sensato. Niente chiavi, niente configurazione.',
  ...
  'onboarding.custom.voice.defaultDesc':
    'Neppy include STT/TTS gestiti che funzionano subito. Niente da configurare.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'Neppy gestisce un workspace Composio gestito. Un clic per connettere ogni servizio in seguito.',
  ...
  'onboarding.custom.search.subtitle': 'Come Neppy cerca sul web per tuo conto.',
  'onboarding.custom.search.defaultDesc':
    'Neppy usa un backend di ricerca gestito. Nessuna chiave necessaria.',
  'onboarding.custom.search.configureDesc':
    'Porta la tua chiave di provider di ricerca (Tavily, Brave, ecc.). Configura in Impostazioni › Strumenti.',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle':
    'Come Neppy genera gli embedding vettoriali per la ricerca nella memoria semantica.',
  'onboarding.custom.embeddings.defaultDesc':
    'Neppy utilizza un servizio di embedding gestito. Nessuna chiave API necessaria.',
  ...
  'onboarding.custom.memory.subtitle':
    'Come Neppy ricorda il tuo contesto, le preferenze e le conversazioni precedenti.',
  'onboarding.custom.memory.defaultDesc':
    "Neppy gestisce automaticamente l'archiviazione e il recupero della memoria. Niente da configurare.",
  ...
  'misc.beta':
    'Neppy è in beta iniziale. Sentiti libero di condividere feedback o segnalare bug che incontri: ogni segnalazione ci aiuta a rilasciare più velocemente.',
  ...
  'privacy.shareAnonymizedDataDesc':
    'Aiuta a migliorare Neppy condividendo report di crash ed eventi di utilizzo limitati per la privacy, inclusi un ID account stabile e i metadati della versione dell’app. Messaggi, chiavi wallet, chiavi API e token di sessione non vengono mai raccolti.',
  ...
  'privacy.autoHandoffMeetDesc':
    "Quando termina una chiamata Google Meet, l'orchestratore di Neppy può leggere la trascrizione e svolgere azioni come redigere messaggi, pianificare follow-up o pubblicare riassunti nel tuo workspace Slack connesso. Disattivato di default.",
  ...
  'settings.about.starCta.title': 'Ti piace Neppy?',
  ...
  'settings.search.menuDesc':
    'Imposta come predefinito la ricerca gestita da Neppy oppure collega il tuo provider con una chiave API.',
  'settings.search.description':
    "Scegli il motore di ricerca utilizzato dall'agente oppure disabilita completamente gli strumenti di ricerca. Gestito utilizza il backend di Neppy (nessuna configurazione). Parallelo, Brave, Querit ed Exa vengono eseguiti direttamente dalla tua macchina usando la tua chiave API.",
  ...
  'settings.search.engineManagedLabel': 'Neppy Gestito',
  'settings.search.engineManagedDesc':
    'Predefinito. Instradato tramite il backend di Neppy, attualmente basato su Exa: nessuna chiave API necessaria.',
  'settings.search.localManagedUnavailable':
    'La ricerca gestita da Neppy non è disponibile per gli utenti locali. Aggiungi la tua chiave API Parallel, Brave, Querit o Exa per abilitare la ricerca web.',
  ...
  'settings.embeddings.requiresSignIn': 'Accesso Neppy richiesto',
  'settings.embeddings.managedLoginRequired':
    'Gli embedding gestiti richiedono l’accesso a Neppy. Accedi per usare il backend Neppy.',
  'settings.embeddings.managedBannerIntro':
    'Gli embedding gestiti passano dal backend Neppy e richiedono una sessione account Neppy.',
  ...
  'settings.embeddings.managedBannerRemoteSession':
    'Accedi di nuovo per aggiornare la sessione Neppy, oppure passa a un provider di embedding locale o con chiave personale.',
  ...
  'devices.betaText':
    'Questa funzionalità è attualmente in beta. Associa i telefoni iOS a questo Neppy per usarli come client remoto.',
  ...
  'devices.emptyState':
    'Scansiona un codice QR sul tuo iPhone per collegarlo a questa sessione Neppy.',
  ...
  'mcp.connectAuth.oauthHint':
    'Questo server usa OAuth. Accedi tramite il tuo browser per autorizzare Neppy.',
  ...
  'autonomy.maxActionsHelp':
    'Numero massimo di azioni dello strumento che un agente può eseguire per ora continuativa. Il nuovo valore si applica alla prossima chat. I cron job e i listener dei canali mantengono il limite attuale fino al riavvio di Neppy.',
  ...
  'settings.tools.chooseCapabilities': 'Scegli quali capacità Neppy può usare per tuo conto.',
  ...
  'voice.providers.chip.cloud': 'Neppy (Gestito)',
  'voice.providers.chip.cloudAria': 'Il provider gestito da Neppy è sempre abilitato',
  ...
  'pttSettings.description':
    'Tieni premuto un tasto per parlare con Neppy mentre sei in un’altra app. Al rilascio l’audio viene inviato; se «Leggi le risposte» è attivo, Neppy risponde a voce.',
  ...
  'pttSettings.errorAccessibility':
    'macOS richiede l’autorizzazione Accessibilità per questa scorciatoia. Apri Impostazioni di sistema → Privacy e sicurezza → Accessibilità e attiva Neppy.',
  ...
  'pttSettings.errorUnsupportedWayland':
    'Le sessioni Wayland non supportano ancora le scorciatoie globali in Neppy: passa a una sessione X11 o usa l’interruttore di dettatura nell’app.',
  ...
  'chat.attachment.videoNotSupported':
    'Questo modello non può leggere i video. Puoi usare il livello Ragionamento di Neppy per allegare il tuo video.',
  ...
  'chat.attachment.imageNotSupported':
    'Questo modello non può leggere le immagini. Puoi usare il livello Ragionamento di Neppy per allegare la tua immagine.',
  ...
  'memorySources.absolutePathRequired':
    'Inserisci il percorso completo della cartella, che inizia con /. Usa Sfoglia per selezionarla.',
  ...
  'backend.cloudDescription':
    "Modelli veloci e potenti instradati attraverso il backend di Neppy. Pronti all'uso immediatamente.",
  'backend.privacyNote':
  ...
  'bootCheck.desktopDescription':
    'Neppy ha bisogno di un runtime per pensare. Scegli dove farlo girare.',
  'bootCheck.webDescription':
    "Sul web, Neppy si connette a un runtime che controlli tu. Inserisci sotto URL e token di autenticazione, oppure scarica l'app desktop per farne girare uno direttamente sulla tua macchina.",
  ...
  'bootCheck.legacyDescription':
    'Un daemon Neppy installato separatamente è già in esecuzione su questo dispositivo. Dobbiamo rimuoverlo prima che il runtime integrato possa subentrare.',
  ...
  'bootCheck.portConflictBody':
    'Un altro processo sta usando la porta di rete necessaria a Neppy. Tenteremo di risolvere il problema automaticamente.',
  ...
  'bootCheck.portConflictOwner':
    '{name} (PID {pid}) sta usando la porta di rete necessaria a Neppy.',
  ...
  'welcome.gatewaySessionErrorFallback':
    'Non è stato possibile completare l’accesso al momento. L’archivio di sessione non ha risposto in tempo (anche dopo un nuovo tentativo). Riavvia Neppy e riprova.',
  ...
  'composio.expiredDescription':
    "Riconnettiti per riattivare gli strumenti {name}. Neppy manterrà questa integrazione non disponibile finché non aggiornerai l'accesso a OAuth.",
  ...
  'mic.voiceNotCompiled':
    "La trascrizione vocale non è inclusa in questa versione dell'app. Aggiorna Neppy per attivarla.",
  ...
  'app.connectionIndicator.connected': 'Connesso a Neppy AI 🚀',
  ...
  'app.neppyLink.accounts.continueWith': 'Continua con accesso {label}',
  'app.neppyLink.accounts.done': 'Fatto',
  'app.neppyLink.accounts.intro': 'Introduzione',
  'app.neppyLink.accounts.webviewNote': 'Nota webview',
  'app.neppyLink.billing.openDashboard': 'Apri dashboard',
  'app.neppyLink.billing.stayOnTrial': 'Rimani in prova',
  'app.neppyLink.billing.trialCredit': 'Crediti di iscrizione',
  ...
  'app.neppyLink.discord.intro': 'Introduzione',
  'app.neppyLink.discord.openInvite': 'Apri invito',
  'app.neppyLink.discord.perk1': 'Vantaggio 1',
  'app.neppyLink.discord.perk2': 'Vantaggio 2',
  'app.neppyLink.discord.perk3': 'Vantaggio 3',
  'app.neppyLink.discord.perk4': 'Vantaggio 4',
  ...
  'app.neppyLink.discordReport.openDiscord': 'Apri Discord',
  'app.neppyLink.done': 'Fatto',
  ...
  'app.neppyLink.notifications.permissionOff':
    "L'autorizzazione alle notifiche è disattivata. Abilita Neppy in Impostazioni di sistema → Notifiche, quindi riprova.",
  'app.neppyLink.notifications.triggerFailed':
    'Neppy non è riuscito ad attivare una notifica di sistema. Controlla le impostazioni di notifica del sistema operativo e riprova.',
  'app.neppyLink.notifications.welcomeBody':
    'Riceverai avvisi qui quando qualcosa richiederà la tua attenzione.',
  'app.neppyLink.notifications.welcomeTitle': "Neppy è pronto all'uso",
  'app.neppyLink.status.closed': 'Chiuso',
  'app.neppyLink.status.connected': 'Connesso',
  'app.neppyLink.status.error': 'Errore',
  'app.neppyLink.status.loading': 'Caricamento…',
  'app.neppyLink.status.needsSignIn': 'Accesso richiesto',
  'app.neppyLink.status.timedOut': 'Tempo scaduto',
  'app.neppyLink.loadingChannelSetup': 'Caricamento configurazione canale',
  'app.neppyLink.maybeLater': 'Forse più tardi',
  'app.neppyLink.notifications.asking': 'Richiesta al tuo OS…',
  'app.neppyLink.notifications.blocked': 'Bloccato',
  'app.neppyLink.notifications.blockedStep1': 'Passo 1 bloccato',
  'app.neppyLink.notifications.blockedStep2': 'Passo 2 bloccato',
  'app.neppyLink.notifications.blockedStep3': 'Passo 3 bloccato',
  'app.neppyLink.notifications.intro': 'Introduzione',
  'app.neppyLink.notifications.promptHint': 'Suggerimento prompt',
  'app.neppyLink.notifications.retry': 'Riprova notifica di test',
  'app.neppyLink.notifications.send': 'Invia notifica di test',
  'app.neppyLink.notifications.sendFailed': 'Impossibile inviare: {error}',
  'app.neppyLink.notifications.sent':
    "Notifica di test inviata. Se non l'hai ricevuta, vai in Impostazioni di Sistema → Notifiche → Neppy, attiva Consenti notifiche e imposta lo Stile banner su Persistente.",
  'app.neppyLink.skipForNow': 'Salta per ora',
  'app.neppyLink.telegramUnavailable': 'Telegram non disponibile',
  'app.neppyLink.title.accounts': 'Connetti le tue app',
  'app.neppyLink.title.billing': 'Fatturazione e crediti',
  'app.neppyLink.title.discord': 'Unisciti alla community',
  'app.neppyLink.title.discordReport': 'Segnala questo errore',
  'app.neppyLink.title.messaging': 'Connetti un canale di chat',
  'app.neppyLink.title.notifications': 'Consenti notifiche',
  ...
  'app.routeLoading.initializing': 'Inizializzazione di Neppy...',
  'app.update.currentlyOn': '{version}',
  'app.update.downloadNow': 'Scarica',
  'app.update.downloadNote': 'Non viene scaricato nulla finché non lo decidi tu.',
  'app.update.errorFallback': "Si è verificato un errore durante l'aggiornamento.",
  'app.update.header.available': 'Aggiornamento disponibile',
  ...
  'app.update.newVersionAvailable': 'È disponibile una nuova versione.',
  ...
  'app.update.versionAvailable': 'La versione {newVersion} è disponibile.',
  ...
  'channels.web.proactiveTitle': 'Messaggi proattivi',
  'channels.web.proactiveAlways':
    'Riepiloghi, promemoria e risultati pianificati arrivano sempre prima qui. La chat web non può essere disattivata.',
  'channels.web.proactiveMirror': 'Una copia viene inviata anche a {channel}.',
  'channels.web.proactiveNoMirror': 'Nessun altro canale riceve una copia.',
  ...
  'channels.authMode.managed_dm': 'Accedi con Neppy',
  ...
  'channels.discord.authMode.oauth.description':
    'Installa il bot Neppy sul tuo server Discord tramite OAuth.',
  'channels.discord.authMode.managed_dm.description':
    'Collega il tuo account personale Discord al bot Neppy.',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'Invia un messaggio direttamente al bot Neppy Telegram.',
  ...
  'channels.connectHelp.discord':
    'Scegli un metodo qui sotto: collega il tuo account tramite Neppy, installa il bot con OAuth oppure incolla il tuo token bot dal portale sviluppatori di Discord.',
  'channels.connectHelp.telegram':
    'Scegli un metodo qui sotto: scrivi al bot gestito di Neppy per collegarlo, oppure incolla il tuo token bot da @BotFather.',
  ...
  'iosPair.error.invalidQr':
    'Codice QR non valido. Assicurati di scansionare un codice di abbinamento Neppy.',
  ...
  'iosPair.instructions':
    'Apri Neppy sul desktop, vai in Impostazioni > Dispositivi e tocca "Associa telefono" per mostrare il codice QR.',
  'iosPair.retryScan': 'Riprova la scansione',
  'iosPair.scanQrCode': 'Scansione QR code',
  'iosPair.scannerOpening': 'Apertura scanner...',
  'iosPair.step.openDesktop': 'Apri Neppy sul desktop',
  ...
  'composio.connect.permissionsNoteSuffix':
    "Le autorizzazioni proprie dell'agente Neppy sono controllate sotto come toggle di lettura, scrittura e admin.",
  ...
  'composio.triggers.sessionExpired':
    'La tua sessione Neppy è scaduta. Accedi di nuovo per caricare i trigger.',
  ...
  'daemon.serviceBlockingGate.title': 'Il core di Neppy non è disponibile',
  ...
  'intelligence.diagram.imageAlt': "Ultimo diagramma dell'architettura Neppy generato",
  ...
  'flows.nodeSummary.toolCall.pickNative': 'Esegue uno strumento Neppy (scegline uno)',
  ...
  'rewards.community.activityStreakHint': 'Giorni consecutivi di attività su Neppy.',
  ...
  'rewards.community.roleClaimDesc':
    'Hai sbloccato i ruoli Discord ma non ti sei ancora unito al server Neppy. Unisciti per assegnarli automaticamente.',
  ...
  'settings.ai.providers.managedDetail': 'Neppy sceglie un modello per ogni attività',
  ...
  'settings.ai.claudeCode.sandboxNoteMac':
    'Su macOS, ~/.neppy rimane protetto dalla sandbox in entrambe le modalità.',
  ...
  'settings.ai.neppyDefault': 'Neppy (predefinito)',
  ...
  'settings.ai.managedSourceLabel': 'Gestito da Neppy',
  ...
  'settings.ai.routing.managedDesc':
    'Neppy eseguirà tutte le inferenze nel cloud, sceglierà il miglior modello per il compito, ottimizzerà i costi e manterrà le impostazioni di routing più sicure.',
  'settings.ai.routing.managedMsg':
    'Neppy gestirà tutte le inferenze per ogni carico di lavoro e sceglierà automaticamente il percorso migliore in termini di costo, qualità e sicurezza.',
  ...
  'settings.composio.confirmWarning':
    'Le tue integrazioni esistenti (Gmail, Slack, GitHub, ecc. collegate tramite Neppy) non saranno visibili: risiedono nel tenant Composio gestito da Neppy.',
  ...
  'settings.composio.modeManaged': 'Gestita (Neppy lo gestisce per te)',
  'settings.composio.modeManagedDesc':
    "Neppy fa da proxy per le chiamate degli strumenti tramite il nostro backend (consigliato). L'autenticazione è mediata; non incolli mai una chiave API Composio. I webhook sono completamente instradati.",
  ...
  'settings.developerMenu.tools.desc':
    'Abilita o disabilita le capacità che Neppy può usare per tuo conto',
  ...
  'settings.mascot.colorAria': 'Neppy colore',
  ...
  'settings.mascot.libraryUnavailable': 'Neppy libreria non disponibile',
  'settings.mascot.title': 'Neppy',
  'settings.mascot.loadingLibrary': 'Caricamento libreria Neppy…',
  ...
  'settings.mascot.localDefault': 'Neppy locale (predefinito)',
  'settings.mascot.menuTitle': 'Mascotte',
  'settings.mascot.menuDesc': "Scegli il colore della mascotte usato in tutta l'app",
  'settings.mascot.noCharacters': 'Nessun personaggio Neppy disponibile',
  ...
  'settings.memoryWindow.description':
    "Quanto contesto ricordato Neppy inietta in ogni nuova esecuzione dell'agente. Finestre più grandi fanno sentire l'agente più consapevole delle conversazioni passate ma usano più token (e costano di più) a ogni esecuzione.",
  ...
  'skills.create.scopeUserHint':
    'Scritto in ~/.neppy/skills/<slug>/SKILL.md: disponibile in tutti i workspace.',
  ...
  'skills.install.errors.writeFailedHint':
    "La directory delle competenze dell'area di lavoro non era scrivibile. Controlla i permessi del filesystem per `<workspace>/.neppy/skills/`.",
  ...
  'skills.meetingBots.busyTitle': 'Neppy è occupato',
  'skills.meetingBots.comingSoon': 'In arrivo',
  'skills.meetingBots.couldNotLeaveTitle': 'Impossibile uscire dalla riunione',
  'skills.meetingBots.couldNotStartTitle': 'Impossibile avviare Neppy',
  'skills.meetingBots.displayName': 'Nome visualizzato',
  'skills.meetingBots.failedToStart': 'Avvio di Neppy fallito.',
  'skills.meetingBots.joiningMessage': 'Apparirà come partecipante tra qualche secondo.',
  'skills.meetingBots.joiningTitle': 'Neppy si sta unendo alla riunione',
  'skills.meetingBots.meetingLink': 'Link della riunione',
  'skills.meetingBots.modalAriaLabel': 'Invia Neppy a una riunione',
  'skills.meetingBots.modalDesc': 'Descrizione modale',
  'skills.meetingBots.modalTitle': 'Invia Neppy a una riunione',
  ...
  'skills.meetingBots.serverOverloaded':
    'Neppy è sottoposto a un carico elevato in questo momento. Riprova tra qualche minuto.',
  ...
  'skills.meetingBots.history.runWithNeppy': 'Esegui con Neppy',
  ...
  'skills.meetingBots.defaults.watchCalendarDesc':
    'Consenti a Neppy di monitorare il tuo calendario connesso per poter partecipare automaticamente o richiedere conferma per le riunioni in base alle politiche seguenti. Questo è separato dalle notifiche di promemoria delle riunioni.',
  ...
  'walkthrough.steps.brainTab.content':
    'Brain è il grafo della memoria: il posto dove vedere cosa sa Neppy e come si collegano le idee.',
  ...
  'settings.mascot.noCharactersAvailable': 'Nessun personaggio Neppy disponibile',
  ...
  'devOptions.menuToolsDesc':
    'Abilita o disabilita le funzionalità che Neppy può utilizzare per tuo conto',
  ...
  'harnessInit.subtitle': 'Neppy sta preparando i componenti necessari al primo avvio.',
  ...
  'harnessInit.failedMessage':
    "Alcuni passaggi di configurazione non sono stati completati. Puoi riprovare o continuare: Neppy userà un'alternativa integrata.",
  ...
  'keyring.consent.description':
    "Il portachiavi del sistema operativo non è accessibile. Neppy necessita del tuo permesso per archiviare i segreti utilizzando l'archiviazione locale crittografata.",
  ...
  'memory.health.remediation.auth_missing':
    'Nessuna credenziale per gli embedding trovata. Accedi a Neppy o configura embedding Ollama locali in Connessioni → Chiavi API → Incorporamenti.',
  ...
  'memory.health.remediation.storage_unavailable':
    "Neppy non riesce a scrivere nella sua memoria: il disco o la scheda SD sembra guasto, pieno o di sola lettura. Controlla l'unità e libera spazio; l'elaborazione della memoria riprenderà automaticamente quando lo spazio di archiviazione tornerà scrivibile.",
  ...
  'onboarding.custom.vault.defaultDesc':
    'Usa le impostazioni di memoria predefinite gestite da Neppy. Il percorso del vault e la salute della sincronizzazione possono essere verificati in seguito.',
  ...
  'onboarding.custom.vault.localDisabledReason':
    'La configurazione gestita richiede il login a Neppy e non è disponibile in modalità locale.',
  ...
  'vaultHealth.writableLabel': 'Il vault è scrivibile da Neppy',
  'vaultHealth.writableRecovery':
    'Neppy non riesce ancora a scrivere in questo vault. Concedi i permessi di scrittura e aggiorna.',
  ...
  'memoryData.workspaceVaultDesc':
    'Neppy scrive le note di memoria generate in memory_tree/content.',
  ...
  'memoryData.internalFilesDesc':
    'Indici, stato della coda e riepiloghi sono gestiti da Neppy per mantenere efficiente il richiamo e la sincronizzazione.',
  ...
  'settings.gateway.description':
    'Il core può girare in un container, su un’altra macchina via SSH o in un container su un’altra macchina. Neppy lo avvia, si collega e lo arresta quando passi ad altro.',
  ...
  'settings.ai.mlx': 'MLX',
  'mlx.description':
    'Neppy avvia e sorveglia i server MLX al posto tuo. Ogni server è un blocco [[mlx.server]] nel tuo file di configurazione, dove si trovano i suoi parametri.',
  'mlx.disabledNotice':
    "L'ambiente MLX è disattivato. Imposta mlx.enabled su true nel file di configurazione per permettere a Neppy di avviare questi server.",
  'mlx.problemsTitle': 'Problemi di configurazione',
  'mlx.preset.title': 'Profilo di esecuzione',
  ...
  'mlx.noModelLoaded': 'Nessun modello caricato',
  'mlx.start': 'Avvia',
  'mlx.stop': 'Arresta',
  'mlx.restart': 'Riavvia',
  'mlx.unload': 'Libera memoria',
  'mlx.showDetails': 'Dettagli',
  'mlx.hideDetails': 'Nascondi dettagli',
  'mlx.command': 'Comando',
  'mlx.logs': 'Output recente',
  'mlx.noLogs': 'Ancora nessun output.',
  'mlx.availableModels': 'Modelli disponibili ({count})',
  'mlx.state.stopped': 'Arrestato',
  'mlx.state.starting': 'Avvio in corso',
  ...
  'mlx.modelsLabel': 'Modelli',
  'mlx.modelsHint':
    'Seleziona i modelli che questo server deve caricare. Un server può tenerne più di uno, uno per ruolo.',
  'mlx.noCachedModels': 'Non è ancora stato scaricato alcun modello.',
  'mlx.slotLabel': 'Ruolo',
  'mlx.slot.model': 'Chat',
  'mlx.slot.embedding': 'Embeddings',
  'mlx.slot.stt': 'Da voce a testo',
  'mlx.slot.tts': 'Da testo a voce',
  'mlx.slot.reranker': 'Riordino',
  'mlx.slot.image': 'Immagini',
  'mlx.params.generation': 'Generazione',
  'chat.thinking.label': 'Ragionamento',
  'chat.thinking.auto': 'Automatico',
  'chat.thinking.quick': 'Rapido',
  'chat.thinking.balanced': 'Bilanciato',
  'chat.thinking.thorough': 'Approfondito',
  'mlx.params.reasoning': 'Ragionamento',
  'mlx.params.memory': 'Memoria e velocità',
  'mlx.params.speculative': 'Decodifica speculativa',
  'mlx.params.process': 'Processo',
  'mlx.params.zeroIsDefault': '0 mantiene il valore predefinito del server.',
  'mlx.params.negativeIsDefault': 'Un valore negativo mantiene il valore predefinito del server.',
  'mlx.params.kvBits': 'Bit della cache KV. 0 la lascia non quantizzata, 3.5 seleziona TurboQuant.',
  'mlx.params.maxNumSeqs':
    'Richieste decodificate insieme. Le altre restano in coda, limitando la memoria di picco. 0 è senza limite.',
  'mlx.params.draftModel': 'Un modello più piccolo che propone token a quello principale.',
  'mlx.params.draftKind': 'dflash, eagle3 o mtp. Lascia vuoto per rilevarlo automaticamente.',
  'mlx.params.port': "0 assegna una porta libera all'avvio e poi la fissa qui.",
  'mlx.params.allowLan': 'Disattivato, il server resta solo su questo computer.',
  'mlx.params.trustRemoteCode':
    'Esegue codice fornito con il modello. Attivalo solo se ti fidi della fonte.',
  'mlx.embeddingsLabel': 'Embeddings',
  'mlx.embeddingsOllama': 'Ollama (bge-m3)',
  'mlx.embeddingsMlx': 'MLX',
  'mlx.embeddingsHint':
    'Ollama conserva i vettori già in memoria. MLX richiede un modello a 1024 dimensioni.',
};
