...
const messages: TranslationMap = {
  ...
  'skills.explorer.emptyDescription':
    'Instala un paquete SKILL.md o coloca carpetas estilo Hermes en ~/.neppy/skills.',
  ...
  'memorySources.absolutePathRequired':
    'Escribe la ruta completa de la carpeta, empezando por /. Usa Examinar para seleccionarla.',
  ...
  'app.neppyLink.accounts.continueWith': 'Continuar con inicio de sesión de {label}',
  'app.neppyLink.accounts.done': 'Listo',
  'app.neppyLink.accounts.intro': 'Introducción',
  'app.neppyLink.accounts.webviewNote': 'Nota de webview',
  'app.neppyLink.billing.openDashboard': 'Abrir panel',
  'app.neppyLink.billing.stayOnTrial': 'Continuar con prueba',
  'app.neppyLink.billing.trialCredit': 'Créditos de registro',
  ...
  'app.neppyLink.discord.intro': 'Introducción',
  'app.neppyLink.discord.openInvite': 'Abrir invitación',
  'app.neppyLink.discord.perk1': 'Ventaja 1',
  'app.neppyLink.discord.perk2': 'Ventaja 2',
  'app.neppyLink.discord.perk3': 'Ventaja 3',
  'app.neppyLink.discord.perk4': 'Ventaja 4',
  ...
  'app.neppyLink.discordReport.openDiscord': 'Abrir Discord',
  'app.neppyLink.done': 'Listo',
  ...
  'app.neppyLink.notifications.welcomeTitle': 'Neppy está listo',
  'app.neppyLink.status.closed': 'Cerrado',
  'app.neppyLink.status.connected': 'Conectado',
  'app.neppyLink.status.error': 'Error',
  'app.neppyLink.status.loading': 'Cargando…',
  'app.neppyLink.status.needsSignIn': 'Requiere iniciar sesión',
  'app.neppyLink.status.timedOut': 'Tiempo agotado',
  'app.neppyLink.loadingChannelSetup': 'Cargando configuración de canal',
  'app.neppyLink.maybeLater': 'Quizás después',
  'app.neppyLink.notifications.asking': 'Consultando tu sistema operativo…',
  'app.neppyLink.notifications.blocked': 'Bloqueado',
  'app.neppyLink.notifications.blockedStep1': 'Paso bloqueado 1',
  'app.neppyLink.notifications.blockedStep2': 'Paso bloqueado 2',
  'app.neppyLink.notifications.blockedStep3': 'Paso bloqueado 3',
  'app.neppyLink.notifications.intro': 'Introducción',
  'app.neppyLink.notifications.promptHint': 'Sugerencia de permiso',
  'app.neppyLink.notifications.retry': 'Reintentar notificación de prueba',
  'app.neppyLink.notifications.send': 'Enviar notificación de prueba',
  'app.neppyLink.notifications.sendFailed': 'No se pudo enviar: {error}',
  ...
  'app.neppyLink.skipForNow': 'Omitir por ahora',
  'app.neppyLink.telegramUnavailable': 'Telegram no disponible',
  'app.neppyLink.title.accounts': 'Conecta tus apps',
  'app.neppyLink.title.billing': 'Facturación y créditos',
  'app.neppyLink.title.discord': 'Únete a la comunidad',
  'app.neppyLink.title.discordReport': 'Reportar este error',
  'app.neppyLink.title.messaging': 'Conecta un canal de chat',
  'app.neppyLink.title.notifications': 'Permitir notificaciones',
  ...
  'app.update.downloadNow': 'Descargar',
  'app.update.downloadNote': 'No se descarga nada hasta que tú lo decidas.',
  'app.update.errorFallback': 'Algo salió mal durante la actualización.',
  'app.update.header.available': 'Actualización disponible',
  ...
  'app.update.newVersionAvailable': 'Hay una nueva versión disponible.',
  ...
  'app.update.versionAvailable': 'La versión {newVersion} está disponible.',
  ...
  'channels.web.proactiveTitle': 'Mensajes proactivos',
  'channels.web.proactiveAlways':
    'Los resúmenes, recordatorios y resultados programados llegan siempre aquí primero. El chat web no se puede desactivar.',
  'channels.web.proactiveMirror': 'También se envía una copia a {channel}.',
  'channels.web.proactiveNoMirror': 'Ningún otro canal recibe una copia.',
  ...
  'settings.ai.claudeCode.sandboxNoteMac':
    'En macOS, ~/.neppy permanece protegido por el sandbox en ambos modos.',
  ...
  'settings.ai.neppyDefault': 'Neppy (predeterminado)',
  ...
  'skills.create.scopeProjectHint': '/.neppy/habilidades/',
  'skills.create.scopeUserHint':
    'Se escribe en ~/.neppy/skills/<slug>/SKILL.md: disponible en todos los espacios de trabajo.',
  ...
  'skills.install.errors.writeFailedHint':
    'No se podía escribir en el directorio de habilidades del espacio de trabajo. Verifique los permisos del sistema de archivos para `<workspace>/.neppy/skills/`.',
  ...
  'settings.ai.mlx': 'MLX',
  'mlx.description':
    'Neppy inicia y supervisa los servidores MLX por ti. Cada servidor es un bloque [[mlx.server]] de tu archivo de configuración, donde están sus parámetros.',
  'mlx.disabledNotice':
    'El entorno MLX está desactivado. Pon mlx.enabled en true en tu archivo de configuración para que Neppy pueda iniciar estos servidores.',
  'mlx.problemsTitle': 'Problemas de configuración',
  'mlx.preset.title': 'Perfil de ejecución',
  ...
  'mlx.noModelLoaded': 'Ningún modelo cargado',
  'mlx.start': 'Iniciar',
  'mlx.stop': 'Detener',
  'mlx.restart': 'Reiniciar',
  'mlx.unload': 'Liberar memoria',
  'mlx.showDetails': 'Detalles',
  'mlx.hideDetails': 'Ocultar detalles',
  'mlx.command': 'Comando',
  'mlx.logs': 'Salida reciente',
  'mlx.noLogs': 'Aún no hay salida.',
  'mlx.availableModels': 'Modelos disponibles ({count})',
  'mlx.state.stopped': 'Detenido',
  'mlx.state.starting': 'Iniciando',
  ...
  'mlx.modelsHint':
    'Marca los modelos que debe cargar este servidor. Un servidor puede tener varios a la vez, uno por función.',
  'mlx.noCachedModels': 'Todavía no hay modelos descargados.',
  'mlx.slotLabel': 'Función',
  'mlx.slot.model': 'Chat',
  'mlx.slot.embedding': 'Embeddings',
  'mlx.slot.stt': 'Voz a texto',
  'mlx.slot.tts': 'Texto a voz',
  'mlx.slot.reranker': 'Reordenación',
  'mlx.slot.image': 'Imágenes',
  'mlx.params.generation': 'Generación',
  'chat.thinking.label': 'Razonamiento',
  'chat.thinking.auto': 'Automático',
  'chat.thinking.quick': 'Rápido',
  'chat.thinking.balanced': 'Equilibrado',
  'chat.thinking.thorough': 'Exhaustivo',
  'mlx.params.reasoning': 'Razonamiento',
  'mlx.params.memory': 'Memoria y velocidad',
  'mlx.params.speculative': 'Decodificación especulativa',
  'mlx.params.process': 'Proceso',
  'mlx.params.zeroIsDefault': '0 mantiene el valor por defecto del servidor.',
  'mlx.params.negativeIsDefault': 'Un valor negativo mantiene el valor por defecto del servidor.',
  'mlx.params.kvBits': 'Bits de la caché KV. 0 la deja sin cuantizar y 3.5 selecciona TurboQuant.',
  'mlx.params.maxNumSeqs':
    'Peticiones decodificadas a la vez. Las demás esperan, lo que limita la memoria máxima. 0 es sin límite.',
  'mlx.params.draftModel': 'Un modelo más pequeño que propone tokens al principal.',
  'mlx.params.draftKind': 'dflash, eagle3 o mtp. Déjalo vacío para detectarlo automáticamente.',
  'mlx.params.port': '0 asigna un puerto libre al iniciar y lo fija aquí cuando ya está en marcha.',
  'mlx.params.allowLan': 'Desactivado mantiene el servidor solo en este equipo.',
  'mlx.params.trustRemoteCode':
    'Ejecuta código incluido con el modelo. Actívalo solo si confías en su origen.',
  'mlx.embeddingsLabel': 'Embeddings',
  'mlx.embeddingsOllama': 'Ollama (bge-m3)',
  'mlx.embeddingsMlx': 'MLX',
  'mlx.embeddingsHint':
    'Ollama conserva los vectores que ya tienes en memoria. MLX necesita un modelo de 1024 dimensiones.',
};
