...
const messages: TranslationMap = {
  ...
  'share.defaultHeadline': 'দেখুন আমার Neppy এজেন্ট এইমাত্র কী করেছে',
  'share.defaultAgentName': 'আমার এজেন্ট',
  'share.defaultCaption': 'দেখুন আমার Neppy এজেন্ট এইমাত্র কী করেছে।',
  'share.captionWithHeadline': '{headline}। আমার Neppy এজেন্ট দিয়ে তৈরি।',
  ...
  'feedback.welcome.body':
    'আমাদের বলুন কী কাজ করছে, কী নেই, এবং কী Neppy-কে আরও ভালো করবে। একটি ধারণা পোস্ট করুন, অন্যরা যা প্রস্তাব করে তাতে ভোট দিন, এবং সেরাগুলোকে আমাদের রোডম্যাপের শীর্ষে উঠতে দেখুন।',
  ...
  'rewards.welcome.body':
    'আপনি Neppy ব্যবহার এবং অন্যদের আমন্ত্রণ জানানোর সময় পয়েন্ট অর্জন করুন, আপনার স্ট্রিক বজায় রাখুন এবং যা অর্জন করেছেন তা রিডিম করুন। সবকিছু এক জায়গায় ট্র্যাক করুন।',
  ...
  'settings.core.applyRestartNote': 'সংরক্ষণ করলে পুনরায় সংযোগের জন্য Neppy পুনরায় চালু হয়।',
  ...
  'conversations.toolFailure.serviceUnavailable.cause':
    'Neppy-এর প্রয়োজনীয় একটি পরিষেবা সাময়িকভাবে অনুপলব্ধ।',
  'conversations.toolFailure.serviceUnavailable.next':
    'Neppy শীঘ্রই আবার চেষ্টা করবে: কোনো পদক্ষেপের প্রয়োজন নেই।',
  ...
  'conversations.toolFailure.modelConnection.cause': 'Neppy AI মডেলে পৌঁছাতে পারেনি।',
  'conversations.toolFailure.modelConnection.next':
    'আপনার সংযোগ বা মডেল সেটিংস পরীক্ষা করুন; Neppy আবার চেষ্টা করবে।',
  ...
  'conversations.toolFailure.timeout.next':
    'Neppy আবার চেষ্টা করবে, অথবা আপনি নিজে আবার চেষ্টা করতে পারেন।',
  ...
  'conversations.toolFailure.approvalExpired.next':
    'এটি চালাতে আবার বলুন: Neppy নিজে থেকে পুনরায় চেষ্টা করবে না।',
  ...
  'orchPage.medulla.tagline': 'Neppy-এর অর্কেস্ট্রেশন মডেল',
  'orchPage.medulla.body':
    'Medulla হলো Neppy-এর নিজস্বভাবে তৈরি LLM, যা একসঙ্গে হাজার হাজার এজেন্ট অর্কেস্ট্রেট করার জন্য প্রকৌশলিত, 10 মিলিয়ন-টোকেন কনটেক্সট উইন্ডো এবং অত্যন্ত কম খরচের অর্কেস্ট্রেশন সহ।',
  ...
  'orchPage.medulla.subscriberTitle': 'Neppy সাবস্ক্রাইবার',
  'orchPage.medulla.subscriberNote':
    'Medulla লাইভ হলে এটি শুধুমাত্র Neppy সাবস্ক্রাইবারদের জন্য এক্সক্লুসিভ হবে।',
  ...
  'orchPage.connections.initDesc':
    'আপনার সাথে কাজ করার জন্য একটি নতুন সাব-এজেন্ট চালু করুন। এজেন্ট চ্যাট খুলুন এবং এর ভূমিকা, লক্ষ্য ও ব্যবহার্য টুল বর্ণনা করুন: Neppy একটি ডেডিকেটেড ইনস্ট্যান্স তৈরি করে যা আপনি এখান থেকে পরিচালনা করতে পারেন।',
  ...
  'tinyplaceOrchestration.master.preview': 'আপনি এবং Neppy-এর মধ্যে সরাসরি সমন্বয়।',
  ...
  'tinyplaceOrchestration.composer.placeholder': 'Neppy-কে বার্তা দিন…',
  ...
  'welcome.resetErrorFallback':
    'অ্যাপ ডেটা মুছতে পারেনি। Neppy বন্ধ করে আবার খুলুন, তারপর আবার চেষ্টা করুন।',
  ...
  'home.statusCoreUnreachable':
    'লোকাল কোর সাইডকার সাড়া দিচ্ছে না। Neppy ব্যাকগ্রাউন্ড প্রসেস ক্র্যাশ হয়েছে বা শুরু হয়নি।',
  ...
  'skills.explorer.emptyDescription':
    'একটি SKILL.md প্যাকেজ ইনস্টল করুন বা Hermes-ধাঁচের ফোল্ডার ~/.neppy/skills-এ রাখুন।',
  ...
  'rewards.localUnavailable':
    'লোকাল লগইনে কোনো রিওয়ার্ড, কুপন বা রেফারেল ক্রেডিট মেলে না। রিওয়ার্ড পেতে লগ আউট করে একটি Neppy অ্যাকাউন্ট দিয়ে সাইন ইন করুন।',
  ...
  'onboarding.welcome': 'হ্যালো। আমি Neppy।',
  ...
  'onboarding.finishDesc': 'সব প্রস্তুত! Neppy ব্যবহার শুরু করুন।',
  'onboarding.skip': 'এড়িয়ে যান',
  'onboarding.getStarted': 'শুরু করুন',
  'onboarding.runtimeChoice.title': 'আপনি কীভাবে Neppy চালাতে চান?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Neppy সব কিছু পরিচালনা করবে।',
  ...
  'onboarding.custom.defaultSubtitle': 'Neppy আপনার হয়ে পরিচালনা করবে।',
  ...
  'onboarding.custom.inference.defaultDesc':
    'Neppy প্রতিটি ওয়ার্কলোড একটি সেন্সিবল ডিফল্ট মডেলে রুট করে। কোনো কী বা সেটআপ নেই।',
  ...
  'onboarding.custom.voice.defaultDesc':
    'Neppy ম্যানেজড STT/TTS সহ আসে যা সরাসরি কাজ করে। কিছু সেটআপ করতে হবে না।',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'Neppy একটি ম্যানেজড Composio ওয়ার্কস্পেস চালায়। পরে প্রতিটি সার্ভিস সংযুক্ত করতে এক ক্লিক।',
  ...
  'onboarding.custom.search.subtitle': 'Neppy আপনার হয়ে কীভাবে ওয়েব সার্চ করে।',
  'onboarding.custom.search.defaultDesc':
    'Neppy ম্যানেজড সার্চ ব্যাকএন্ড ব্যবহার করে। কোনো কী লাগে না।',
  'onboarding.custom.search.configureDesc':
    'নিজের সার্চ প্রোভাইডার কী আনুন (Tavily, Brave ইত্যাদি)। Settings › Tools-এ কনফিগার করুন।',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle':
    'Neppy কীভাবে সিমান্টিক মেমোরি অনুসন্ধানের জন্য ভেক্টর এম্বেডিং তৈরি করে।',
  'onboarding.custom.embeddings.defaultDesc':
    'Neppy একটি পরিচালিত এম্বেডিং সেবা ব্যবহার করে। কোনো API কী প্রয়োজন নেই।',
  ...
  'onboarding.custom.memory.subtitle':
    'Neppy কীভাবে আপনার কন্টেক্সট, পছন্দ ও পূর্ববর্তী কথোপকথন মনে রাখে।',
  'onboarding.custom.memory.defaultDesc':
    'Neppy স্বয়ংক্রিয়ভাবে মেমোরি স্টোরেজ ও রিট্রিভাল পরিচালনা করে। কিছু সেটআপ করতে হবে না।',
  ...
  'misc.beta':
    'Neppy এখন আর্লি বেটায় আছে। যেকোনো মতামত বা বাগ রিপোর্ট করুন: প্রতিটি রিপোর্ট আমাদের দ্রুত এগিয়ে যেতে সাহায্য করে।',
  ...
  'privacy.shareAnonymizedDataDesc':
    'গোপনীয়তা-সীমিত ক্র্যাশ রিপোর্ট ও ব্যবহার ইভেন্ট শেয়ার করে Neppy উন্নত করতে সাহায্য করুন, যার মধ্যে স্থিতিশীল অ্যাকাউন্ট ID ও অ্যাপ সংস্করণ মেটাডেটা থাকে। বার্তা, ওয়ালেট কী, API কী বা সেশন টোকেন কখনো সংগ্রহ করা হয় না।',
  ...
  'privacy.autoHandoffMeetDesc':
    'Google Meet কল শেষ হলে, Neppy-এর অর্কেস্ট্রেটর ট্রান্সক্রিপ্ট পড়তে এবং বার্তা ড্রাফট করা, ফলো-আপ নির্ধারণ করা বা সংযুক্ত Slack ওয়ার্কস্পেসে সারসংক্ষেপ পোস্ট করার মতো কাজ করতে পারে। ডিফল্টে বন্ধ।',
  ...
  'settings.about.starCta.title': 'Neppy ভালো লাগছে?',
  ...
  'settings.search.description':
    'এজেন্ট যে সার্চ ইঞ্জিন ব্যবহার করে তা বেছে নিন, অথবা সার্চ টুলগুলো সম্পূর্ণভাবে নিষ্ক্রিয় করুন। Managed Neppy-এর ব্যাকএন্ড ব্যবহার করে (কোনো সেটআপ নেই)। Parallel, Brave, Querit, এবং Exa আপনার API কী ব্যবহার করে সরাসরি আপনার মেশিন থেকে চলে।',
  ...
  'settings.search.engineManagedLabel': 'Neppy পরিচালিত',
  'settings.search.engineManagedDesc':
    'ডিফল্ট। Neppy ব্যাক-এন্ডের মাধ্যমে রুট করা হয়, বর্তমানে Exa দ্বারা চালিত: কোনো API key প্রয়োজন নেই।',
  'settings.search.localManagedUnavailable':
    'লোকাল ব্যবহারকারীদের জন্য Neppy Managed সার্চ উপলভ্য নয়। ওয়েব সার্চ চালু করতে আপনার নিজের Parallel, Brave, Querit বা Exa API key যোগ করুন।',
  ...
  'settings.embeddings.requiresSignIn': 'Neppy-এ সাইন-ইন প্রয়োজন',
  'settings.embeddings.managedLoginRequired':
    'ম্যানেজড এমবেডিংসের জন্য Neppy সাইন-ইন প্রয়োজন। Neppy ব্যাকএন্ড ব্যবহার করতে সাইন ইন করুন।',
  'settings.embeddings.managedBannerIntro':
    'ম্যানেজড এমবেডিংস Neppy ব্যাকএন্ডের মাধ্যমে চলে এবং একটি Neppy অ্যাকাউন্ট সেশন প্রয়োজন।',
  ...
  'settings.embeddings.managedBannerRemoteSession':
    'Neppy সেশন রিফ্রেশ করতে আবার সাইন ইন করুন, অথবা স্থানীয়/নিজস্ব-কী এমবেডিং প্রোভাইডারে যান।',
  ...
  'devices.betaText':
    'এই ফিচারটি এখন বেটায় আছে। iOS ফোনকে রিমোট ক্লায়েন্ট হিসেবে ব্যবহার করতে এই Neppy-এর সাথে পেয়ার করুন।',
  ...
  'devices.emptyState': 'এই Neppy সেশনে সংযোগ করতে আপনার iPhone এ একটি QR code স্ক্যান করুন।',
  ...
  'mcp.connectAuth.oauthHint':
    'এই সার্ভারটি OAuth ব্যবহার করে। Neppy-কে অনুমোদন দিতে আপনার ব্রাউজারের মাধ্যমে সাইন ইন করুন।',
  ...
  'autonomy.maxActionsHelp':
    'একজন এজেন্ট প্রতি ঘণ্টায় সর্বোচ্চ কতটি টুল অ্যাকশন চালাতে পারবে। নতুন মান আপনার পরবর্তী চ্যাটে প্রযোজ্য হবে। Cron জব এবং চ্যানেল লিসেনার Neppy পুনরায় চালু না করা পর্যন্ত বর্তমান সীমা বজায় রাখবে।',
  ...
  'settings.tools.chooseCapabilities':
    'Neppy আপনার হয়ে কোন ক্যাপাবিলিটিগুলো ব্যবহার করতে পারবে তা বেছে নিন।',
  ...
  'voice.providers.chip.cloud': 'Neppy (পরিচালিত)',
  'voice.providers.chip.cloudAria': 'Neppy পরিচালিত প্রোভাইডার সর্বদা সক্রিয়',
  ...
  'pttSettings.description':
    'অন্য একটি অ্যাপে থাকার সময় Neppy-এর সাথে কথা বলতে একটি কী চেপে ধরে রাখুন। কী ছেড়ে দিলে রেকর্ডিং পাঠানো হয়; «উত্তর পড়ে শোনাও» চালু থাকলে Neppy উত্তরটি জোরে পড়ে শোনায়।',
  ...
  'pttSettings.errorAccessibility':
    'এই শর্টকাটের জন্য macOS-এর অ্যাক্সেসিবিলিটি অনুমতি দরকার। System Settings → Privacy & Security → Accessibility খুলুন এবং Neppy চালু করুন।',
  ...
  'pttSettings.errorUnsupportedWayland':
    'Wayland সেশন এখনও Neppy-এ গ্লোবাল শর্টকাট সমর্থন করে না: একটি X11 সেশনে চলে যান অথবা অ্যাপের ভেতরের ডিকটেশন টগল ব্যবহার করুন।',
  ...
  'chat.attachment.videoNotSupported':
    'এই মডেল ভিডিও পড়তে পারে না। আপনার ভিডিও সংযুক্ত করতে আপনি Neppy যুক্তি স্তর ব্যবহার করতে পারেন।',
  ...
  'chat.attachment.imageNotSupported':
    'এই মডেলটি ছবি পড়তে পারে না। আপনার ছবি সংযুক্ত করতে আপনি Neppy যুক্তি স্তর ব্যবহার করতে পারেন।',
  ...
  'bootCheck.desktopDescription':
    'Neppy চিন্তা করতে একটি রানটাইম প্রয়োজন। এটি কোথায় থাকবে তা বেছে নিন।',
  'bootCheck.webDescription':
    'ওয়েবে, Neppy আপনার নিয়ন্ত্রণে একটি রানটাইমে সংযুক্ত হয়। নিচে এর URL ও অথ টোকেন দিন, অথবা সরাসরি আপনার মেশিনে চালাতে ডেস্কটপ অ্যাপ নিন।',
  ...
  'bootCheck.legacyDescription':
    'এই ডিভাইসে আলাদাভাবে ইনস্টল করা একটি Neppy ডেমন ইতিমধ্যে চলছে। বিল্ট-ইন রানটাইম নিয়ন্ত্রণ নেওয়ার আগে এটি সরাতে হবে।',
  ...
  'bootCheck.portConflictBody':
    'অন্য একটি প্রক্রিয়া Neppy-এর প্রয়োজনীয় নেটওয়ার্ক পোর্ট ব্যবহার করছে। আমরা স্বয়ংক্রিয়ভাবে এটি ঠিক করার চেষ্টা করব।',
  ...
  'bootCheck.portConflictOwner':
    '{name} (PID {pid}) Neppy-এর প্রয়োজনীয় নেটওয়ার্ক পোর্টটি ব্যবহার করছে।',
  ...
  'welcome.gatewaySessionErrorFallback':
    'এই মুহূর্তে সাইন-ইন সম্পূর্ণ করা যায়নি। সেশন স্টোর সময়মতো সাড়া দেয়নি (বারবার চেষ্টা করেও)। অনুগ্রহ করে Neppy পুনরায় চালু করুন এবং আবার চেষ্টা করুন।',
  ...
  'composio.expiredDescription':
    'পুনরায় সংযোগ করতে PH__0 টুল পুনরায় সংযুক্ত করুন। আপনি OAuth অ্যাক্সেস রিফ্রেশ না করা পর্যন্ত Neppy এই ইন্টিগ্রেশনটি অনুপলব্ধ রাখবে৷',
  ...
  'mic.voiceNotCompiled':
    'অ্যাপের এই সংস্করণে ভয়েস ট্রান্সক্রিপশন অন্তর্ভুক্ত নেই। এটি চালু করতে Neppy আপডেট করুন।',
  ...
  'app.connectionIndicator.connected': 'Neppy AI-এ সংযুক্ত 🚀',
  ...
  'app.neppyLink.accounts.continueWith': '{label} সাইন-ইন দিয়ে চালিয়ে যান',
  'app.neppyLink.accounts.done': 'সম্পন্ন',
  'app.neppyLink.accounts.intro': 'ভূমিকা',
  'app.neppyLink.accounts.webviewNote': 'Webview নোট',
  'app.neppyLink.billing.openDashboard': 'ড্যাশবোর্ড খুলুন',
  'app.neppyLink.billing.stayOnTrial': 'ট্রায়ালে থাকুন',
  'app.neppyLink.billing.trialCredit': 'সাইনআপ ক্রেডিট',
  'app.neppyLink.billing.trialDesc':
    'প্রোমোশন ও অ্যাকাউন্টের যোগ্যতার ওপর ক্রেডিট অফার ভিন্ন হতে পারে।',
  'app.neppyLink.defaultBody': 'পপআপে এখনো প্রস্তুত নয়। সম্পূর্ণ সেটিংস পেজ খুলুন যখন',
  'app.neppyLink.discord.intro': 'ভূমিকা',
  'app.neppyLink.discord.openInvite': 'আমন্ত্রণ খুলুন',
  'app.neppyLink.discord.perk1': 'সুবিধা ১',
  'app.neppyLink.discord.perk2': 'সুবিধা ২',
  'app.neppyLink.discord.perk3': 'সুবিধা ৩',
  'app.neppyLink.discord.perk4': 'সুবিধা ৪',
  ...
  'app.neppyLink.discordReport.openDiscord': 'Discord খুলুন',
  'app.neppyLink.done': 'সম্পন্ন',
  ...
  'app.neppyLink.notifications.permissionOff':
    'বিজ্ঞপ্তির অনুমতি বন্ধ আছে। সিস্টেম সেটিংস → বিজ্ঞপ্তি-তে Neppy সক্রিয় করুন, তারপর পুনরায় চেষ্টা করুন।',
  'app.neppyLink.notifications.triggerFailed':
    'Neppy একটি সিস্টেম বিজ্ঞপ্তি চালু করতে পারেনি। OS-এর বিজ্ঞপ্তি সেটিংস যাচাই করুন এবং পুনরায় চেষ্টা করুন।',
  'app.neppyLink.notifications.welcomeBody':
    'যখন কোনো কিছুতে আপনার মনোযোগ প্রয়োজন হবে, তখন আপনি এখানে পিং পাবেন।',
  'app.neppyLink.notifications.welcomeTitle': 'Neppy ব্যবহারের জন্য প্রস্তুত',
  'app.neppyLink.status.closed': 'বন্ধ',
  'app.neppyLink.status.connected': 'সংযুক্ত',
  'app.neppyLink.status.error': 'ত্রুটি',
  'app.neppyLink.status.loading': 'লোড হচ্ছে…',
  'app.neppyLink.status.needsSignIn': 'সাইন-ইন প্রয়োজন',
  'app.neppyLink.status.timedOut': 'সময় শেষ',
  'app.neppyLink.loadingChannelSetup': 'চ্যানেল সেটআপ লোড হচ্ছে',
  'app.neppyLink.maybeLater': 'হয়তো পরে',
  'app.neppyLink.notifications.asking': 'OS-এ জিজ্ঞেস করছে…',
  'app.neppyLink.notifications.blocked': 'ব্লক করা',
  'app.neppyLink.notifications.blockedStep1': 'ব্লক করা ধাপ ১',
  'app.neppyLink.notifications.blockedStep2': 'ব্লক করা ধাপ ২',
  'app.neppyLink.notifications.blockedStep3': 'ব্লক করা ধাপ ৩',
  'app.neppyLink.notifications.intro': 'ভূমিকা',
  'app.neppyLink.notifications.promptHint': 'প্রম্পট হিন্ট',
  'app.neppyLink.notifications.retry': 'পরীক্ষা বিজ্ঞপ্তি আবার চেষ্টা করুন',
  'app.neppyLink.notifications.send': 'পরীক্ষা বিজ্ঞপ্তি পাঠান',
  'app.neppyLink.notifications.sendFailed': 'পাঠানো যায়নি: {error}',
  'app.neppyLink.notifications.sent':
    'টেস্ট নোটিফিকেশন পাঠানো হয়েছে। যদি না পেয়ে থাকেন, System Settings → Notifications → Neppy-এ যান, Allow Notifications চালু করুন, এবং Banner Style-কে Persistent-এ সেট করুন।',
  'app.neppyLink.skipForNow': 'এখনের জন্য এড়িয়ে যান',
  'app.neppyLink.telegramUnavailable': 'Telegram পাওয়া যাচ্ছে না',
  'app.neppyLink.title.accounts': 'আপনার অ্যাপ সংযুক্ত করুন',
  'app.neppyLink.title.billing': 'বিলিং ও ক্রেডিট',
  'app.neppyLink.title.discord': 'কমিউনিটিতে যোগ দিন',
  'app.neppyLink.title.discordReport': 'এই ত্রুটি রিপোর্ট করুন',
  'app.neppyLink.title.messaging': 'একটি চ্যাট চ্যানেল সংযুক্ত করুন',
  'app.neppyLink.title.notifications': 'বিজ্ঞপ্তির অনুমতি দিন',
  ...
  'app.routeLoading.initializing': 'Neppy শুরু হচ্ছে...',
  'app.update.currentlyOn': '{version}',
  'app.update.downloadNow': 'ডাউনলোড',
  'app.update.downloadNote': 'আপনি না চাইলে কিছুই ডাউনলোড হবে না।',
  'app.update.errorFallback': 'আপডেটের সময় কিছু একটা ভুল হয়েছে।',
  'app.update.header.available': 'আপডেট পাওয়া যাচ্ছে',
  ...
  'app.update.newVersionAvailable': 'নতুন সংস্করণ পাওয়া যাচ্ছে।',
  ...
  'app.update.versionAvailable': '{newVersion} সংস্করণ পাওয়া যাচ্ছে।',
  ...
  'channels.authMode.managed_dm': 'Neppy দিয়ে লগইন করুন',
  ...
  'channels.discord.authMode.oauth.description':
    'OAuth এর মাধ্যমে আপনার Discord সার্ভারে Neppy বট ইনস্টল করুন।',
  'channels.discord.authMode.managed_dm.description':
    'আপনার ব্যক্তিগত Discord অ্যাকাউন্টটি Neppy বটের সাথে লিঙ্ক করুন।',
  ...
  'channels.telegram.authMode.managed_dm.description': 'সরাসরি Neppy Telegram বটকে মেসেজ করুন।',
  ...
  'channels.connectHelp.discord':
    'নিচে একটি পদ্ধতি বেছে নিন: Neppy-এর মাধ্যমে আপনার অ্যাকাউন্ট লিঙ্ক করুন, OAuth দিয়ে বট ইনস্টল করুন, অথবা Discord ডেভেলপার পোর্টাল থেকে আপনার নিজের বট টোকেন পেস্ট করুন।',
  'channels.connectHelp.telegram':
    'নিচে একটি পদ্ধতি বেছে নিন: লিঙ্ক করতে ম্যানেজড Neppy বটে বার্তা পাঠান, অথবা @BotFather থেকে আপনার নিজের বট টোকেন পেস্ট করুন।',
  ...
  'iosPair.error.invalidQr':
    'অবৈধ QR কোড। নিশ্চিত করুন আপনি একটি Neppy পেয়ারিং কোড স্ক্যান করছেন।',
  ...
  'iosPair.instructions':
    'আপনার ডেস্কটপে Neppy খুলুন, Settings > Devices-এ যান, এবং QR কোড দেখাতে "Pair phone" ট্যাপ করুন।',
  ...
  'iosPair.step.openDesktop': 'ডেস্কটপে Neppy খুলুন',
  ...
  'composio.connect.permissionsNoteSuffix':
    'Neppy-এর নিজস্ব এজেন্ট অনুমতি নিচে read, write, এবং admin টগল হিসেবে নিয়ন্ত্রিত।',
  ...
  'composio.triggers.sessionExpired':
    'আপনার Neppy সেশনের মেয়াদ শেষ হয়েছে। ট্রিগার লোড করতে আবার সাইন ইন করুন।',
  ...
  'daemon.serviceBlockingGate.title': 'Neppy কোর পাওয়া যাচ্ছে না',
  ...
  'intelligence.diagram.imageAlt': 'সর্বশেষ তৈরি Neppy আর্কিটেকচার ডায়াগ্রাম',
  ...
  'flows.nodeSummary.toolCall.pickNative': 'একটি Neppy টুল চালায় (একটি বেছে নিন)',
  ...
  'rewards.community.activityStreakHint': 'Neppy-এ পরপর সক্রিয় থাকার দিন।',
  ...
  'rewards.community.roleClaimDesc':
    'আপনি Discord রোল আনলক করেছেন কিন্তু এখনও Neppy সার্ভারে যোগ দেননি। যোগ দিন যাতে সেগুলি স্বয়ংক্রিয়ভাবে বরাদ্দ হয়।',
  ...
  'settings.ai.providers.managedDetail': 'Neppy প্রতিটি কাজের জন্য মডেল বেছে নেয়',
  ...
  'settings.ai.claudeCode.sandboxNoteMac':
    'macOS-এ, উভয় মোডেই ~/.neppy স্যান্ডবক্স দ্বারা সুরক্ষিত থাকে।',
  ...
  'settings.ai.neppyDefault': 'Neppy (ডিফল্ট)',
  ...
  'settings.ai.managedSourceLabel': 'Neppy দ্বারা পরিচালিত',
  ...
  'settings.composio.confirmWarning':
    'Neppy-এর মাধ্যমে লিঙ্ক করা আপনার বিদ্যমান ইন্টিগ্রেশনগুলি (Gmail, Slack, GitHub ইত্যাদি) দৃশ্যমান হবে না: সেগুলি Neppy-পরিচালিত Composio টেন্যান্টে থাকে।',
  ...
  'settings.composio.modeManaged': 'ম্যানেজড (Neppy আপনার হয়ে পরিচালনা করে)',
  'settings.composio.modeManagedDesc':
    'Neppy আমাদের ব্যাকএন্ডের মাধ্যমে টুল কল প্রক্সি করে (প্রস্তাবিত)। অথ ব্রোকার করা হয়; আপনি কখনও Composio API key পেস্ট করেন না। Webhooks সম্পূর্ণরূপে রুট করা।',
  ...
  'settings.developerMenu.tools.desc':
    'Neppy আপনার পক্ষ থেকে যে সক্ষমতাগুলি ব্যবহার করতে পারে সেগুলি চালু বা বন্ধ করুন',
  ...
  'settings.developerMenu.mcpServer.desc':
    'বাহ্যিক MCP ক্লায়েন্টগুলিকে Neppy-এ সংযুক্ত করতে কনফিগার করুন',
  ...
  'settings.agentAccess.tinyplaceAutopilot.desc':
    'Neppy-কে tiny.place-এ নিজে কাজ করতে দিন। এটি নির্ধারিত সময় অনুযায়ী মূল্যবান কাজ খোঁজে (প্রথমে খোলা বাউন্টি), নিজের দক্ষতার সাথে মানানসই কাজ করে এবং আপনার পরিচয় থেকে কাজ করে। এটি তত্ত্বাবধান ছাড়াই চলে এবং অর্থ ব্যয় করতে পারে, তাই পরীক্ষার সময় এটি devnet-এ রাখুন। ডিফল্টভাবে বন্ধ।',
  ...
  'settings.mascot.colorAria': 'Neppy রঙ',
  ...
  'settings.memoryWindow.description':
    'প্রতিটি নতুন এজেন্ট রানে Neppy কতটা মনে রাখা প্রসঙ্গ ইনজেক্ট করে। বড় উইন্ডো অতীত কথোপকথন সম্পর্কে বেশি সচেতন মনে হয় কিন্তু প্রতিটি রানে বেশি টোকেন ব্যবহার করে, এবং বেশি খরচ হয়।',
  ...
  'skills.create.scopeUserHint':
    '~/.neppy/skills/<slug>/SKILL.md-এ লেখা: সব ওয়ার্কস্পেসে পাওয়া যায়।',
  ...
  'skills.install.errors.writeFailedHint':
    'ওয়ার্কস্পেস দক্ষতা ডিরেক্টরি লেখার যোগ্য ছিল না। `<workspace>/.neppy/skills/`-এর জন্য ফাইল সিস্টেমের অনুমতি পরীক্ষা করুন।',
  ...
  'skills.meetingBots.busyTitle': 'Neppy ব্যস্ত',
  'skills.meetingBots.comingSoon': 'শীঘ্রই আসছে',
  'skills.meetingBots.couldNotLeaveTitle': 'মিটিং থেকে বেরোনো যায়নি',
  'skills.meetingBots.couldNotStartTitle': 'Neppy শুরু করা যায়নি',
  'skills.meetingBots.displayName': 'প্রদর্শন নাম',
  'skills.meetingBots.failedToStart': 'Neppy শুরু করতে ব্যর্থ।',
  'skills.meetingBots.joiningMessage': 'কয়েক সেকেন্ডের মধ্যে অংশগ্রহণকারী হিসেবে দেখা যাবে।',
  'skills.meetingBots.joiningTitle': 'Neppy মিটিংয়ে যোগ দিচ্ছে',
  'skills.meetingBots.meetingLink': 'মিটিং লিংক',
  'skills.meetingBots.modalAriaLabel': 'Neppy-কে একটি মিটিংয়ে পাঠান',
  'skills.meetingBots.modalDesc': 'মোডাল বিবরণ',
  'skills.meetingBots.modalTitle': 'Neppy-কে একটি মিটিংয়ে পাঠান',
  ...
  'skills.meetingBots.serverOverloaded':
    'Neppy এই মুহূর্তে অত্যধিক চাপের মধ্যে রয়েছে। অনুগ্রহ করে কয়েক মিনিট পরে আবার চেষ্টা করুন।',
  ...
  'skills.meetingBots.history.runWithNeppy': 'Neppy দিয়ে চালান',
  ...
  'skills.meetingBots.defaults.watchCalendarDesc':
    'Neppy-কে আপনার সংযুক্ত ক্যালেন্ডার দেখতে দিন যাতে এটি নীচের নীতিগুলির উপর ভিত্তি করে মিটিংয়ে স্বয়ংক্রিয়ভাবে যোগ দিতে বা অনুরোধ করতে পারে। এটি মিটিং অনুস্মারক বিজ্ঞপ্তি থেকে আলাদা।',
  ...
  'walkthrough.steps.brainTab.content':
    'Brain হলো মেমোরি গ্রাফ: Neppy কী জানে এবং ধারণাগুলো কীভাবে যুক্ত তা দেখার জায়গা।',
  ...
  'settings.mascot.noCharactersAvailable': 'কোনো Neppy ক্যারেক্টার এখনও উপলব্ধ নেই',
  ...
  'harnessInit.subtitle': 'প্রথম চালুর সময় Neppy প্রয়োজনীয় উপাদানগুলো প্রস্তুত করছে।',
  ...
  'harnessInit.failedMessage':
    'কিছু সেটআপ ধাপ সম্পন্ন হয়নি। আপনি পুনরায় চেষ্টা করতে পারেন, অথবা চালিয়ে যেতে পারেন: Neppy একটি অন্তর্নির্মিত ফলব্যাক ব্যবহার করবে।',
  ...
  'keyring.consent.description':
    'আপনার অপারেটিং সিস্টেমের কিচেন অ্যাক্সেসযোগ্য নয়। Neppy-এর পরিবর্তে স্থানীয় এনক্রিপ্টেড সঞ্চয়স্থান ব্যবহার করে গোপনীয়তা সংরক্ষণ করতে আপনার অনুমতি প্রয়োজন।',
  ...
  'memory.health.remediation.auth_missing':
    'কোনও এমবেডিং শংসাপত্র পাওয়া যায়নি। Neppy-এ লগ ইন করুন, অথবা সংযোগ → API কী → এমবেডিংস-এ স্থানীয় Ollama এমবেডিং সেট আপ করুন।',
  ...
  'memory.health.remediation.storage_unavailable':
    'Neppy তার মেমরি স্টোরেজে লিখতে পারছে না: ডিস্ক বা SD কার্ডটি ত্রুটিপূর্ণ, পূর্ণ বা শুধু-পঠনযোগ্য বলে মনে হচ্ছে। ড্রাইভটি পরীক্ষা করুন এবং কিছু জায়গা খালি করুন; স্টোরেজ আবার লেখার উপযোগী হলে মেমরি প্রক্রিয়াকরণ স্বয়ংক্রিয়ভাবে পুনরায় শুরু হবে।',
  ...
  'onboarding.custom.vault.defaultDesc':
    'Neppy-পরিচালিত মেমোরির ডিফল্ট ব্যবহার করুন। ভল্ট পাথ এবং সিঙ্ক স্বাস্থ্য পরে পর্যালোচনা করা যাবে।',
  ...
  'onboarding.custom.vault.localDisabledReason':
    'পরিচালিত সেটআপের জন্য Neppy সাইন-ইন প্রয়োজন এবং লোকাল মোডে উপলব্ধ নয়।',
  ...
  'vaultHealth.writableLabel': 'ভল্ট Neppy দ্বারা লিখনযোগ্য',
  'vaultHealth.writableRecovery':
    'Neppy এখনও এই ভল্টে লিখতে পারছে না। লেখার অনুমতি দিন এবং রিফ্রেশ করুন।',
  ...
  'memoryData.workspaceVaultDesc': 'Neppy তৈরি মেমোরি নোট memory_tree/content-এ লেখে।',
  ...
  'memoryData.internalFilesDesc':
    'ইন্ডেক্স, কিউ স্টেট এবং সারসংক্ষেপ Neppy দ্বারা পরিচালিত হয় যাতে রিকল ও সিঙ্ক সুস্থ থাকে।',
  ...
  'settings.gateway.description':
    'কোর একটি কনটেইনারে, SSH দিয়ে অন্য একটি মেশিনে, বা অন্য মেশিনের কনটেইনারে চলতে পারে। Neppy সেটি চালু করে, সংযোগ করে, এবং আপনি অন্য কোথাও গেলে বন্ধ করে দেয়।',
  ...
  'settings.ai.mlx': 'MLX',
  'mlx.description':
    'Neppy আপনার হয়ে MLX সার্ভার চালু করে ও তদারক করে। প্রতিটি সার্ভার আপনার কনফিগারেশন ফাইলের একটি [[mlx.server]] ব্লক, সেখানেই তার প্যারামিটারগুলো থাকে।',
  'mlx.disabledNotice':
  ...
  'mlx.noModelLoaded': 'কোনো মডেল লোড করা নেই',
  'mlx.start': 'চালু করুন',
  'mlx.stop': 'বন্ধ করুন',
  'mlx.restart': 'আবার চালু করুন',
  'mlx.unload': 'মেমরি খালি করুন',
  'mlx.showDetails': 'বিস্তারিত',
  'mlx.hideDetails': 'বিস্তারিত লুকান',
  'mlx.command': 'কমান্ড',
  'mlx.logs': 'সাম্প্রতিক আউটপুট',
  'mlx.noLogs': 'এখনও কোনো আউটপুট নেই।',
  'mlx.availableModels': 'উপলব্ধ মডেল ({count})',
  'mlx.state.stopped': 'বন্ধ',
  'mlx.state.starting': 'চালু হচ্ছে',
  ...
  'mlx.modelsLabel': 'মডেল',
  'mlx.modelsHint':
    'এই সার্ভার কোন কোন মডেল লোড করবে তা বেছে নিন। একটি সার্ভার একসঙ্গে কয়েকটি রাখতে পারে, প্রতি কাজে একটি।',
  'mlx.noCachedModels': 'এখনও কোনো মডেল ডাউনলোড করা হয়নি।',
  'mlx.slotLabel': 'কাজ',
  'mlx.slot.model': 'চ্যাট',
  'mlx.slot.embedding': 'এমবেডিং',
  'mlx.slot.stt': 'কথা থেকে লেখা',
  'mlx.slot.tts': 'লেখা থেকে কথা',
  'mlx.slot.reranker': 'পুনঃক্রম',
  'mlx.slot.image': 'ছবি',
  ...
  'mlx.params.reasoning': 'যুক্তি',
  'mlx.params.memory': 'মেমরি ও গতি',
  'mlx.params.speculative': 'অনুমাননির্ভর ডিকোডিং',
  'mlx.params.process': 'প্রসেস',
  'mlx.params.zeroIsDefault': '0 দিলে সার্ভারের নিজের মান বহাল থাকে।',
  'mlx.params.negativeIsDefault': 'ঋণাত্মক মান দিলে সার্ভারের নিজের মান বহাল থাকে।',
  'mlx.params.kvBits': 'KV ক্যাশের বিট। 0 হলে কোয়ান্টাইজ হয় না, 3.5 হলে TurboQuant বেছে নেয়।',
  'mlx.params.maxNumSeqs':
    'একসঙ্গে ডিকোড হওয়া অনুরোধ। বাকিগুলো অপেক্ষা করে, ফলে সর্বোচ্চ মেমরি সীমিত থাকে। 0 মানে সীমা নেই।',
  'mlx.params.draftModel': 'ছোট একটি মডেল, যা মূল মডেলের জন্য আগেভাগে টোকেন প্রস্তাব করে।',
  'mlx.params.draftKind': 'dflash, eagle3 বা mtp। নিজে থেকে শনাক্ত করতে ফাঁকা রাখুন।',
  'mlx.params.port': '0 দিলে চালুর সময় ফাঁকা পোর্ট বেছে নেয় এবং পরে এখানেই লিখে রাখে।',
  'mlx.params.allowLan': 'বন্ধ থাকলে সার্ভার কেবল এই কম্পিউটারেই সীমাবদ্ধ থাকে।',
  'mlx.params.trustRemoteCode': 'মডেলের সঙ্গে আসা কোড চালায়। উৎসে ভরসা থাকলেই কেবল চালু করুন।',
  'mlx.embeddingsLabel': 'এমবেডিং',
  'mlx.embeddingsOllama': 'Ollama (bge-m3)',
  'mlx.embeddingsMlx': 'MLX',
  'mlx.embeddingsHint':
    'Ollama স্মৃতিতে থাকা ভেক্টরগুলো ধরে রাখে। MLX এর জন্য ১০২৪ মাত্রার মডেল দরকার।',
};
