...
const messages: TranslationMap = {
  ...
  'share.defaultHeadline': 'Regardez ce que mon agent Neppy vient de faire',
  'share.defaultAgentName': 'Mon agent',
  'share.defaultCaption': 'Regardez ce que mon agent Neppy vient de faire.',
  'share.captionWithHeadline': '{headline}. Réalisé avec mon agent Neppy.',
  ...
  'feedback.welcome.body':
    'Dites-nous ce qui fonctionne, ce qui manque et ce qui rendrait Neppy meilleur. Proposez une idée, votez pour celles des autres et regardez les meilleures remonter en tête de notre feuille de route.',
  ...
  'rewards.welcome.body':
    'Gagnez des points à mesure que vous utilisez Neppy et invitez d’autres personnes, maintenez votre série en vie et échangez ce que vous avez gagné, le tout suivi au même endroit.',
  ...
  'settings.core.applyRestartNote': 'Enregistrer redémarre Neppy pour se reconnecter.',
  // Cross-host vault (#4278)
  'crossHostVault.title': "Le coffre se trouve sur l'hôte du cœur.",
  'crossHostVault.message':
    "Ce coffre de mémoire est stocké sur l'hôte neppy-core ({os}). Il ne peut être ouvert ou affiché que sur cette machine, pas depuis cet appareil.",
  ...
  'conversations.toolFailure.missingPermission.cause':
    "Neppy n'a pas encore l'autorisation de faire cela.",
  ...
  'conversations.toolFailure.serviceUnavailable.cause':
    'Un service dont Neppy a besoin est temporairement indisponible.',
  'conversations.toolFailure.serviceUnavailable.next':
    'Neppy réessaiera bientôt: aucune action nécessaire.',
  ...
  'conversations.toolFailure.modelConnection.cause': "Neppy n'a pas pu joindre le modèle d'IA.",
  'conversations.toolFailure.modelConnection.next':
    'Vérifiez votre connexion ou les paramètres du modèle ; Neppy réessaiera.',
  ...
  'conversations.toolFailure.timeout.next':
    "Neppy réessaiera, ou vous pouvez relancer l'action manuellement.",
  ...
  'conversations.toolFailure.approvalExpired.next':
    "Redemandez pour l'exécuter: Neppy ne réessaiera pas tout seul.",
  ...
  'orchPage.medulla.tagline': "Le modèle d'orchestration d'Neppy",
  'orchPage.medulla.body':
    "Medulla est le LLM développé sur mesure par Neppy, conçu pour orchestrer des milliers d'agents à la fois, avec une fenêtre de contexte de 10 millions de tokens et une orchestration à coût radicalement bas.",
  ...
  'orchPage.medulla.subscriberTitle': 'Abonnés Neppy',
  'orchPage.medulla.subscriberNote':
    'Au lancement de Medulla, il sera exclusivement réservé aux abonnés Neppy.',
  ...
  'orchPage.connections.initDesc':
    "Lancez un nouveau sous-agent pour travailler à vos côtés. Ouvrez le chat de l'agent et décrivez son rôle, son objectif et ses outils: Neppy provisionne une instance dédiée que vous pilotez d'ici.",
  ...
  'tinyplaceOrchestration.master.preview': 'Coordination directe entre vous et Neppy.',
  ...
  'tinyplaceOrchestration.composer.placeholder': 'Message à Neppy…',
  ...
  'welcome.title': 'Bienvenue sur Neppy',
  'welcome.subtitle':
  ...
  'welcome.resetErrorFallback':
    "Impossible d'effacer les données de l'appli. Quittez et rouvrez Neppy, puis réessayez.",
  ...
  'home.statusCoreUnreachable':
    "Le processus local Neppy ne répond pas. Il a peut-être planté ou n'a pas démarré correctement.",
  ...
  'skills.explorer.emptyDescription':
    'Installez un paquet SKILL.md ou placez des dossiers de style Hermes dans ~/.neppy/skills.',
  ...
  'rewards.localUnavailable':
    'La connexion locale ne permet pas de gagner des récompenses, des coupons ou du crédit de parrainage. Déconnecte-toi puis connecte-toi avec un compte Neppy si tu veux que les récompenses comptent.',
  ...
  'onboarding.welcome': 'Salut. Je suis Neppy.',
  ...
  'onboarding.finishDesc': 'Tout est prêt ! Commence à utiliser Neppy.',
  'onboarding.skip': 'Passer',
  'onboarding.getStarted': 'Démarrer',
  'onboarding.runtimeChoice.title': 'Comment veux-tu utiliser Neppy ?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Laisse Neppy tout gérer pour toi.',
  ...
  'onboarding.custom.defaultSubtitle': 'Laisse Neppy gérer ça pour toi.',
  ...
  'onboarding.custom.inference.defaultDesc':
    'Neppy dirige chaque charge de travail vers un modèle par défaut adapté. Aucune clé, aucune configuration.',
  ...
  'onboarding.custom.voice.defaultDesc':
    'Neppy inclut un STT/TTS géré qui fonctionne directement. Rien à configurer.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'Neppy gère un espace de travail Composio. Un clic pour connecter chaque service plus tard.',
  ...
  'onboarding.custom.search.subtitle':
    'Comment Neppy effectue des recherches sur le web en ton nom.',
  'onboarding.custom.search.defaultDesc':
    'Neppy utilise un backend de recherche géré. Aucune clé nécessaire.',
  ...
  'onboarding.custom.embeddings.subtitle':
    'Comment Neppy génère des embeddings vectoriels pour la recherche sémantique en mémoire.',
  'onboarding.custom.embeddings.defaultDesc':
    "Neppy utilise un service d'embedding géré. Aucune clé API requise.",
  ...
  'onboarding.custom.memory.subtitle':
    'Comment Neppy mémorise ton contexte, tes préférences et tes conversations passées.',
  'onboarding.custom.memory.defaultDesc':
    'Neppy gère automatiquement le stockage et la récupération en mémoire. Rien à configurer.',
  ...
  'misc.beta':
    "Neppy est en bêta anticipée. N'hésite pas à partager tes retours ou signaler des bugs: chaque rapport nous aide à avancer plus vite.",
  ...
  'privacy.shareAnonymizedDataDesc':
    "Aide à améliorer Neppy en partageant des rapports de plantage et des événements d'utilisation limités pour la confidentialité, incluant un ID de compte stable et les métadonnées de version de l'app. Les messages, clés de portefeuille, clés API et jetons de session ne sont jamais collectés.",
  ...
  'privacy.autoHandoffMeetDesc':
    "Quand un appel Google Meet se termine, l'orchestrateur d'Neppy peut lire la transcription et effectuer des actions comme rédiger des messages, planifier des suivis ou publier des résumés sur ton espace Slack connecté. Désactivé par défaut.",
  ...
  'settings.about.starCta.title': 'Neppy vous plaît ?',
  ...
  'settings.search.menuDesc':
    'Par défaut, utilisez la recherche gérée par Neppy ou connectez votre propre fournisseur avec une clé API.',
  'settings.search.description':
    "Choisissez le moteur de recherche utilisé par l'agent, ou désactivez entièrement les outils de recherche. Géré utilise le backend d'Neppy (sans configuration). Parallel, Brave, Querit et Exa s'exécutent directement depuis votre machine avec votre clé API.",
  ...
  'settings.search.engineManagedLabel': 'Neppy Géré',
  'settings.search.engineManagedDesc':
    'Par défaut. Acheminé via le backend Neppy, actuellement propulsé par Exa: aucune clé API requise.',
  'settings.search.localManagedUnavailable':
    'La recherche gérée par Neppy n’est pas disponible pour les utilisateurs locaux. Ajoutez votre propre clé API Parallel, Brave, Querit ou Exa pour activer la recherche web.',
  ...
  'settings.embeddings.requiresSignIn': 'Connexion Neppy requise',
  'settings.embeddings.managedLoginRequired':
    'Les embeddings gérés nécessitent une connexion Neppy. Connectez-vous pour utiliser le backend Neppy.',
  'settings.embeddings.managedBannerIntro':
    'Les embeddings gérés passent par le backend Neppy et nécessitent une session de compte Neppy.',
  ...
  'settings.embeddings.managedBannerRemoteSession':
    'Reconnectez-vous pour actualiser votre session Neppy, ou passez à un fournisseur local ou avec votre propre clé.',
  ...
  'devices.betaText':
    'Cette fonctionnalité est actuellement en bêta. Associez des iPhone à cet Neppy pour les utiliser comme client distant.',
  ...
  'devices.emptyState':
    'Scannez un code QR sur votre iPhone pour le connecter à cette session Neppy.',
  ...
  'devices.pairModal.instructions':
    'Ouvrez l’application Neppy sur votre iPhone et scannez ce code.',
  ...
  'mcp.connectAuth.oauthHint':
    'Ce serveur utilise OAuth. Connectez-vous via votre navigateur pour autoriser Neppy.',
  ...
  'autonomy.maxActionsHelp':
    "Nombre maximum d'actions d'outil qu'un agent peut exécuter par heure glissante. La nouvelle valeur s'applique à votre prochaine conversation. Les tâches planifiées et les écouteurs de canaux conservent leur limite actuelle jusqu'au redémarrage d'Neppy.",
  ...
  'settings.tools.chooseCapabilities':
    "Choisis les fonctionnalités qu'Neppy peut utiliser en ton nom.",
  ...
  'voice.providers.chip.cloud': 'Neppy (Géré)',
  'voice.providers.chip.cloudAria': 'Le fournisseur géré Neppy est toujours activé',
  ...
  'pttSettings.description':
    'Maintiens une touche pour parler à Neppy pendant que tu utilises une autre application. Relâcher envoie l’enregistrement ; si « Lire les réponses » est activé, Neppy lit la réponse à voix haute.',
  ...
  'pttSettings.errorAccessibility':
    'macOS exige l’autorisation Accessibilité pour ce raccourci. Ouvre Réglages système → Confidentialité et sécurité → Accessibilité et active Neppy.',
  ...
  'pttSettings.errorUnsupportedWayland':
    'Les sessions Wayland ne prennent pas encore en charge les raccourcis globaux dans Neppy: passe à une session X11 ou utilise la commande de dictée intégrée à l’application.',
  ...
  'chat.attachment.videoNotSupported':
    'Ce modèle ne peut pas lire les vidéos. Tu peux utiliser le niveau Raisonnement d’Neppy pour joindre ta vidéo.',
  ...
  'chat.attachment.imageNotSupported':
    'Ce modèle ne peut pas lire les images. Tu peux utiliser le niveau Raisonnement d’Neppy pour joindre ton image.',
  ...
  'bootCheck.desktopDescription':
    "Neppy a besoin d'un runtime pour fonctionner. Choisis où il doit être hébergé.",
  'bootCheck.webDescription':
    "Sur le web, Neppy se connecte à un runtime que tu contrôles. Renseigne son URL et son token d'authentification ci-dessous, ou télécharge l'app desktop pour en faire tourner un directement sur ta machine.",
  ...
  'bootCheck.legacyDescription':
    "Un daemon Neppy installé séparément est déjà en cours d'exécution sur cet appareil. On doit le supprimer avant que le runtime intégré puisse prendre le relais.",
  ...
  'bootCheck.portConflictBody':
    'Un autre processus utilise le port réseau dont Neppy a besoin. Nous allons tenter de corriger cela automatiquement.',
  ...
  'welcome.gatewaySessionErrorFallback':
    'La connexion n’a pas pu être terminée pour le moment. Le stockage de session n’a pas répondu à temps (même après plusieurs tentatives). Redémarrez Neppy et réessayez.',
  ...
  'composio.expiredDescription':
    "Reconnectez-vous pour réactiver les outils {name}. Neppy gardera cette intégration indisponible jusqu'à ce que vous actualisiez l'accès OAuth.",
  ...
  'mic.voiceNotCompiled':
    "La transcription vocale n'est pas incluse dans cette version de l'application. Mettez à jour Neppy pour l'activer.",
  ...
  'app.connectionIndicator.connected': 'Connecté à Neppy AI 🚀',
  ...
  'app.neppyLink.accounts.continueWith': 'Continuer avec la connexion {label}',
  'app.neppyLink.accounts.done': 'Terminé',
  'app.neppyLink.accounts.intro': 'Intro',
  'app.neppyLink.accounts.webviewNote': 'Note webview',
  'app.neppyLink.billing.openDashboard': 'Ouvrir le tableau de bord',
  'app.neppyLink.billing.stayOnTrial': "Rester en période d'essai",
  'app.neppyLink.billing.trialCredit': "Crédits d'inscription",
  ...
  'app.neppyLink.discord.intro': 'Intro',
  'app.neppyLink.discord.openInvite': "Ouvrir l'invitation",
  'app.neppyLink.discord.perk1': 'Avantage 1',
  'app.neppyLink.discord.perk2': 'Avantage 2',
  'app.neppyLink.discord.perk3': 'Avantage 3',
  'app.neppyLink.discord.perk4': 'Avantage 4',
  ...
  'app.neppyLink.discordReport.openDiscord': 'Ouvrir Discord',
  'app.neppyLink.done': 'Terminé',
  ...
  'app.neppyLink.notifications.permissionOff':
    "L'autorisation des notifications est désactivée. Activez Neppy dans Réglages système → Notifications, puis réessayez.",
  'app.neppyLink.notifications.triggerFailed':
    "Neppy n'a pas pu déclencher de notification système. Vérifiez les paramètres de notification du système d'exploitation et réessayez.",
  'app.neppyLink.notifications.welcomeBody':
    "Vous recevrez des alertes ici lorsqu'une chose nécessitera votre attention.",
  'app.neppyLink.notifications.welcomeTitle': 'Neppy est prêt',
  'app.neppyLink.status.closed': 'Fermé',
  'app.neppyLink.status.connected': 'Connecté',
  'app.neppyLink.status.error': 'Erreur',
  'app.neppyLink.status.loading': 'Chargement…',
  'app.neppyLink.status.needsSignIn': 'Connexion requise',
  'app.neppyLink.status.timedOut': 'Délai dépassé',
  'app.neppyLink.loadingChannelSetup': 'Chargement de la configuration du canal',
  'app.neppyLink.maybeLater': 'Peut-être plus tard',
  'app.neppyLink.notifications.asking': 'Demande à ton OS…',
  'app.neppyLink.notifications.blocked': 'Bloqué',
  'app.neppyLink.notifications.blockedStep1': 'Étape 1 bloquée',
  'app.neppyLink.notifications.blockedStep2': 'Étape 2 bloquée',
  'app.neppyLink.notifications.blockedStep3': 'Étape 3 bloquée',
  'app.neppyLink.notifications.intro': 'Intro',
  'app.neppyLink.notifications.promptHint': "Indice d'invite",
  'app.neppyLink.notifications.retry': 'Renvoyer une notification de test',
  'app.neppyLink.notifications.send': 'Envoyer une notification de test',
  'app.neppyLink.notifications.sendFailed': "Impossible d'envoyer : {error}",
  'app.neppyLink.notifications.sent':
    "Notification de test envoyée. Si vous ne l'avez pas reçue, allez dans Réglages Système → Notifications → Neppy, activez Autoriser les notifications, et définissez le style de bannière sur Persistant.",
  'app.neppyLink.skipForNow': "Passer pour l'instant",
  'app.neppyLink.telegramUnavailable': 'Telegram indisponible',
  'app.neppyLink.title.accounts': 'Connecte tes apps',
  'app.neppyLink.title.billing': 'Facturation & crédits',
  'app.neppyLink.title.discord': 'Rejoins la communauté',
  'app.neppyLink.title.discordReport': 'Signaler cette erreur',
  'app.neppyLink.title.messaging': 'Connecter un canal de chat',
  'app.neppyLink.title.notifications': 'Autoriser les notifications',
  ...
  'app.routeLoading.initializing': "Initialisation d'Neppy...",
  'app.update.currentlyOn': '{version}',
  'app.update.downloadNow': 'Télécharger',
  'app.update.downloadNote': "Rien n'est téléchargé avant que vous le décidiez.",
  'app.update.errorFallback': "Une erreur s'est produite lors de la mise à jour.",
  'app.update.header.available': 'Mise à jour disponible',
  ...
  'app.update.newVersionAvailable': 'Une nouvelle version est disponible.',
  ...
  'app.update.versionAvailable': 'La version {newVersion} est disponible.',
  ...
  'channels.authMode.managed_dm': 'Connectez-vous avec Neppy',
  ...
  'channels.discord.authMode.oauth.description':
    'Installez le bot Neppy sur votre serveur Discord via OAuth.',
  'channels.discord.authMode.managed_dm.description':
    'Liez votre compte personnel Discord au bot Neppy.',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'Envoyez un message directement au robot Neppy Telegram.',
  ...
  'channels.connectHelp.discord':
    'Choisissez une méthode ci-dessous : reliez votre compte via Neppy, installez le bot avec OAuth, ou collez votre propre jeton de bot depuis le portail développeur Discord.',
  'channels.connectHelp.telegram':
    'Choisissez une méthode ci-dessous : écrivez au bot Neppy géré pour le relier, ou collez votre propre jeton de bot depuis @BotFather.',
  ...
  'iosPair.error.invalidQr':
    "Code QR invalide. Assurez-vous de scanner un code d'association Neppy.",
  ...
  'iosPair.instructions':
    'Ouvrez Neppy sur votre bureau, allez dans Réglages > Appareils et appuyez sur « Associer un téléphone » pour afficher le code QR.',
  'iosPair.retryScan': 'Rescanner',
  'iosPair.scanQrCode': 'Numérisation QR code',
  'iosPair.scannerOpening': 'Ouverture du scanner...',
  'iosPair.step.openDesktop': 'Ouvrez Neppy sur le bureau',
  ...
  'composio.connect.permissionsNoteSuffix':
    "Les autorisations de l'agent Neppy sont contrôlées ci-dessous par des bascules lecture, écriture et admin.",
  ...
  'composio.triggers.sessionExpired':
    'Votre session Neppy a expiré. Reconnectez-vous pour charger les déclencheurs.',
  ...
  'daemon.serviceBlockingGate.title': 'Le core Neppy est indisponible',
  ...
  'intelligence.diagram.imageAlt': "Dernier diagramme d'architecture Neppy généré",
  ...
  'flows.nodeSummary.toolCall.pickNative': 'Exécute un outil Neppy (à choisir)',
  ...
  'rewards.community.activityStreakHint': 'Jours consécutifs d’activité sur Neppy.',
  ...
  'rewards.community.roleClaimDesc':
    "Vous avez débloqué des rôles Discord mais n'avez pas encore rejoint le serveur Neppy. Rejoignez-le pour qu'ils soient attribués automatiquement.",
  ...
  'settings.ai.providers.managedDetail': 'Neppy choisit un modèle pour chaque tâche',
  ...
  'settings.ai.claudeCode.sandboxNoteMac':
    'Sur macOS, ~/.neppy reste protégé par le bac à sable dans les deux modes.',
  ...
  'settings.ai.neppyDefault': 'Neppy (par défaut)',
  ...
  'settings.ai.managedSourceLabel': 'Géré par Neppy',
  ...
  'settings.ai.routing.managedDesc':
    'Neppy exécutera toutes les inférences dans le cloud, choisira le meilleur modèle pour la tâche, optimisera les coûts et conservera les paramètres de routage les plus sûrs par défaut.',
  'settings.ai.routing.managedMsg':
    'Neppy gérera toutes les inférences pour chaque charge de travail et choisira automatiquement la meilleure route en termes de coût, de qualité et de sécurité.',
  ...
  'settings.composio.confirmWarning':
    'Vos intégrations existantes (Gmail, Slack, GitHub, etc. liées via Neppy) ne seront pas visibles: elles vivent dans le tenant Composio géré par Neppy.',
  ...
  'settings.composio.modeManaged': "Géré (Neppy s'en occupe pour toi)",
  'settings.composio.modeManagedDesc':
    "Neppy relaie les appels d'outils via notre backend (recommandé). L'authentification est négociée ; vous ne collez jamais de clé API Composio. Les webhooks sont entièrement routés.",
  ...
  'settings.developerMenu.tools.desc':
    "Active ou désactive les capacités qu'Neppy peut utiliser en ton nom",
  ...
  'settings.developerMenu.mcpServer.desc':
    'Configurer les clients MCP externes pour se connecter à Neppy',
  ...
  'settings.mcpServer.toolsSectionDesc':
    "Outils exposés via le serveur stdio MCP lors de l'exécution d'neppy-core mcp",
  ...
  'settings.mcpServer.binaryPathNotFound':
    'Binaire Neppy introuvable. Si vous exécutez à partir des sources, compilez avec : cargo build --bin neppy-core',
  ...
  'settings.mascot.colorAria': 'Neppy couleur',
  ...
  'settings.mascot.libraryUnavailable': 'Neppy bibliothèque indisponible',
  'settings.mascot.title': 'Neppy',
  'settings.mascot.loadingLibrary': 'Chargement de la bibliothèque Neppy…',
  ...
  'settings.mascot.localDefault': 'Neppy local (par défaut)',
  ...
  'settings.mascot.noCharacters': "Aucun personnage Neppy n'est encore disponible",
  ...
  'settings.memoryWindow.description':
    "Quelle quantité de contexte mémorisé Neppy injecte dans chaque nouvelle exécution d'agent. Des fenêtres plus larges semblent plus conscientes des conversations passées mais consomment plus de jetons (et coûtent plus cher) à chaque exécution.",
  ...
  'skills.create.scopeUserHint':
    'Écrit dans ~/.neppy/skills/<slug>/SKILL.md: disponible dans tous les espaces de travail.',
  ...
  'skills.install.errors.writeFailedHint':
    "Le répertoire des compétences de l'espace de travail n'était pas accessible en écriture. Vérifiez les autorisations du système de fichiers pour `<workspace>/.neppy/skills/`.",
  ...
  'skills.meetingBots.serverOverloaded':
    'Neppy est actuellement très sollicité. Veuillez réessayer dans quelques minutes.',
  ...
  'skills.meetingBots.history.runWithNeppy': 'Exécuter avec Neppy',
  ...
  'skills.meetingBots.defaults.watchCalendarDesc':
    "Laissez Neppy surveiller votre agenda connecté pour qu'il puisse rejoindre automatiquement ou vous inviter à des réunions selon les politiques ci-dessous. Cela est indépendant des notifications de rappel de réunion.",
  ...
  'walkthrough.steps.brainTab.content':
    'Brain est le graphe de mémoire : l’endroit où vérifier ce qu’Neppy sait et comment les idées se relient.',
  ...
  'settings.mascot.noCharactersAvailable': "Aucun personnage Neppy n'est encore disponible",
  ...
  'devOptions.menuToolsDesc':
    'Activer ou désactiver les fonctionnalités que Neppy peut utiliser en votre nom',
  ...
  'harnessInit.subtitle':
    'Neppy prépare les composants dont il a besoin lors du premier lancement.',
  ...
  'harnessInit.failedMessage':
    'Certaines étapes de configuration ne se sont pas terminées. Vous pouvez réessayer ou continuer: Neppy utilisera une solution de secours intégrée.',
  ...
  'harnessInit.backgroundHint':
    'Vous pouvez continuer à utiliser Neppy pendant que cela se termine.',

  'keyring.consent.title': 'Stockage sécurisé indisponible',
  'keyring.consent.description':
    "Le trousseau de votre système d'exploitation n'est pas accessible. Neppy a besoin de votre autorisation pour stocker les secrets en utilisant un stockage local chiffré.",
  ...
  'memory.health.remediation.auth_missing':
    "Aucune information d'identification d'embeddings trouvée. Connectez-vous à Neppy ou configurez des embeddings Ollama locaux dans Connexions → Clés API → Intégrations.",
  ...
  'memory.health.remediation.storage_unavailable':
    "Neppy ne peut pas écrire dans son stockage de mémoire: le disque ou la carte SD semble défaillant, plein ou en lecture seule. Vérifiez le lecteur et libérez de l'espace ; le traitement de la mémoire reprendra automatiquement une fois le stockage de nouveau accessible en écriture.",
  ...
  'onboarding.custom.vault.defaultDesc':
    "Utiliser les paramètres de mémoire gérés par Neppy. Le chemin du coffre et l'état de synchronisation peuvent encore être consultés ultérieurement.",
  ...
  'onboarding.custom.vault.localDisabledReason':
    "La configuration gérée nécessite une connexion à Neppy et n'est pas disponible en mode local.",
  ...
  'vaultHealth.writableLabel': 'Le coffre est accessible en écriture par Neppy',
  'vaultHealth.writableRecovery':
    "Neppy ne peut pas encore écrire dans ce coffre. Accordez les autorisations d'écriture et actualisez.",
  ...
  'memoryData.workspaceVaultDesc':
    'Neppy écrit les notes de mémoire générées dans memory_tree/content.',
  ...
  'memoryData.internalFilesDesc':
    "Les index, l'état de la file d'attente et les résumés sont gérés par Neppy pour maintenir la mémoire et la synchronisation en bon état.",
  ...
  'settings.gateway.description':
    'Le cœur peut s’exécuter dans un conteneur, sur une autre machine via SSH, ou dans un conteneur sur une autre machine. Neppy le démarre, s’y connecte et l’arrête quand vous changez d’emplacement.',
  ...
  'settings.gateway.binaryLabel': 'Chemin vers neppy-core',
  ...
  'settings.gateway.binaryRequired': 'Indiquez le chemin vers neppy-core sur cette machine.',
  ...
  'settings.ai.mlx': 'MLX',
  'mlx.description':
    'Neppy lance et surveille les serveurs MLX à ta place. Chaque serveur correspond à un bloc [[mlx.server]] de ton fichier de configuration, où se trouvent ses paramètres.',
  'mlx.disabledNotice':
  ...
  'mlx.noModelLoaded': 'Aucun modèle chargé',
  'mlx.start': 'Démarrer',
  'mlx.stop': 'Arrêter',
  'mlx.restart': 'Redémarrer',
  'mlx.unload': 'Libérer la mémoire',
  'mlx.showDetails': 'Détails',
  'mlx.hideDetails': 'Masquer les détails',
  'mlx.command': 'Commande',
  'mlx.logs': 'Sortie récente',
  'mlx.noLogs': 'Pas encore de sortie.',
  'mlx.availableModels': 'Modèles disponibles ({count})',
  'mlx.state.stopped': 'Arrêté',
  'mlx.state.starting': 'Démarrage',
