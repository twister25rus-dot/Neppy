...
| 5   | Single active user per process     | `~/.neppy/active_user.toml` (`src/openhuman/config/schema/load_user_state.rs:21`), resolution chain in `dirs.rs:299`                                                                        | One workspace resolved once; all global stores bound to it                                                                                                                                                                                                              |
