...
//! which are `pub` and re-exported at `neppy_core::neppy::memory`.
//!
...
use neppy_core::neppy::config::{Config, MemoryConfig};
use neppy_core::neppy::inference::embeddings::{
