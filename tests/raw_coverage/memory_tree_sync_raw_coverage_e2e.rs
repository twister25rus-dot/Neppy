...
use neppy_core::neppy::memory::tree::score::extract::{EntityKind, ExtractedEntities};
use neppy_core::neppy::memory::tree::score::resolver::canonicalise;
use neppy_core::neppy::memory::tree::tree::bucket_seal::append_leaf;
use neppy_core::neppy::memory::tree::tree::{
...
async fn default_composio_provider_hooks_cover_defaults_and_sync_preconditions() {
    ...
    let extracted = ExtractedEntities {
        entities: vec![
            neppy_core::neppy::memory::tree::score::extract::ExtractedEntity {
