...
use neppy_core::neppy::integrations::composio::{init_composio_trigger_history, ComposioActionTool};
use neppy_core::neppy::config::Config;
use neppy_core::neppy::security::credentials::{
    AuthService, APP_SESSION_PROVIDER, DEFAULT_AUTH_PROFILE_NAME,
};
use neppy_core::neppy::tools::{ComposioExecuteTool, Tool};
...
async fn composio_controller_registry_validates_params_without_backend_network() {
    ...
    let unknown = neppy_core::neppy::integrations::composio::schemas::schemas("missing");
