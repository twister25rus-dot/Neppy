...
use neppy_core::neppy::threads::{migrate_welcome_agent_artifacts, ops as thread_ops};
...
async fn round19_memory_sources_registry_readers_sync_and_reconcile_edges() {
    ...
    let reader = neppy_core::neppy::memory::sources::readers::folder::FolderReader;
    let listed = reader
    ...
    let github_reader = neppy_core::neppy::memory::sources::readers::github::GithubReader;
...
<item><title>First &amp; only</title><guid>guid-1</guid><description><![CDATA[<p>Hello</p>]]></description><pubDate>Fri, 29 May 2026 00:00:00 GMT</pubDate></item>
    ...
    let rss_reader = neppy_core::neppy::memory::sources::readers::rss::RssReader::new();
