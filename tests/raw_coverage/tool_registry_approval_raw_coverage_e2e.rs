...
use neppy_core::openhuman::security::approval::store as approval_store;
use neppy_core::openhuman::security::approval::{
...
use neppy_core::openhuman::mcp::registry::connections;
use neppy_core::openhuman::mcp::registry::types::{CommandKind, InstalledServer, Transport};
use neppy_core::openhuman::security::{live_policy, SecurityPolicy};
...
fn tool_registry_diagnostics_for_config_reports_audit_success_and_policy_shape() {
    ...
    let diagnostics =
        neppy_core::openhuman::tools::registry::ops::diagnostics_for_config(&config)
            .into_cli_compatible_json()
...
async fn tool_registry_diagnostics_reports_config_and_audit_store_failures() {
    ...
    let err = neppy_core::openhuman::tools::registry::ops::diagnostics()
        .await
    ...
    let diagnostics =
        neppy_core::openhuman::tools::registry::ops::diagnostics_for_config(&broken_audit_config);
...
async fn approval_schema_handlers_validate_params_and_surface_empty_gate_state() {
    ...
    let unknown = neppy_core::openhuman::security::approval::schemas::schemas("missing");
...
async fn approval_rpc_decision_paths_persist_always_allow_and_recent_audit() {
    ...
    assert!(matches!(
        outcome,
        neppy_core::openhuman::security::approval::GateOutcome::Allow
    ));
    ...
    let no_chat = gate
        ...
        .await;
    match &no_chat.0 {
        neppy_core::openhuman::security::approval::GateOutcome::Deny { reason } => {
            assert!(
