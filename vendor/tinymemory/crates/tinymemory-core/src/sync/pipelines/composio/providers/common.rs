...
use crate::sync::pipelines::traits::SkillDocument;
...
///
/// [`normalize::helpers`]: tinymemory_sync::helpers
/// [`normalize::helpers::pick_str`]: tinymemory_sync::helpers::pick_str
...
pub async fn checked_execute(
    ...
    arguments: Value,
    connection_id: &str,
    state: &mut crate::sync::composio::providers::sync_state::SyncState,
