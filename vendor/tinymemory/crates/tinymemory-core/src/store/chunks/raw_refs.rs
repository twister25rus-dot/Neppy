...
//! [`crate::engine::backend::chunks`] (ported from this exact module — identical SQL
...
pub use crate::engine::backend::chunks::RawRef;
...
pub fn set_chunk_raw_refs(config: &Config, chunk_id: &str, refs: &[RawRef]) -> Result<()> {
    crate::engine::backend::chunks::set_chunk_raw_refs(&engine_config(config), chunk_id, refs)
}
...
pub fn set_chunk_raw_refs_tx(tx: &Transaction<'_>, chunk_id: &str, refs: &[RawRef]) -> Result<()> {
    crate::engine::backend::chunks::set_chunk_raw_refs_tx(tx, chunk_id, refs)
}
...
pub fn get_chunk_raw_refs(config: &Config, chunk_id: &str) -> Result<Option<Vec<RawRef>>> {
    crate::engine::backend::chunks::get_chunk_raw_refs(&engine_config(config), chunk_id)
}
...
pub fn get_chunk_content_pointers(
    ...
    crate::engine::backend::chunks::get_chunk_content_pointers(&engine_config(config), chunk_id)
}
...
pub fn get_chunk_content_path(config: &Config, chunk_id: &str) -> Result<Option<String>> {
    crate::engine::backend::chunks::get_chunk_content_path(&engine_config(config), chunk_id)
}
...
pub fn get_summary_content_pointers(
    ...
    crate::engine::backend::chunks::get_summary_content_pointers(&engine_config(config), summary_id)
}
...
pub fn list_summaries_with_content_path(config: &Config) -> Result<Vec<(String, String, String)>> {
    crate::engine::backend::chunks::list_summaries_with_content_path(&engine_config(config))
}
